<?php
/**
 * Order Customer Details Template
 *
 * Override this template by copying it to [your theme folder]/woocommerce/yith_ctpw_customer_details.php
 *
 * @author        Yithemes
...
<ul class="woocommerce-customer-details customer_details">
	...
	if ( $order->get_billing_email() ) {
		echo '<li><p class="woocommerce-customer-details--email">' . esc_html__( 'Email:', 'yith-custom-thankyou-page-for-woocommerce' ) . '</p><span> ' . esc_attr( $order->get_billing_email() ) . '</span></li>';
	}
	if ( $order->get_billing_phone() ) {
		echo '<li><p class="woocommerce-customer-details--phone">' . esc_html__( 'Telephone:', 'yith-custom-thankyou-page-for-woocommerce' ) . '</p><span> ' . esc_attr( $order->get_billing_phone() ) . '</span></li>';
	}
