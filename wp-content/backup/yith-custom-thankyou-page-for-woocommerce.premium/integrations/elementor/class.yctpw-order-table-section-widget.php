...
class YCTPW_Order_Table_Section_Elementor_widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'yith-order-table-section';
	}
	...
	public function get_title() {
		return esc_html__( 'YITH Custom ThankYou Page Order Table Section', 'yith-custom-thankyou-page-for-woocommerce' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'YITH Custom ThankYou Page Order Table Section', 'yith-custom-thankyou-page-for-woocommerce' ),
			)
		);
	...
	protected function render() {
		...
		if ( isset($_GET['ctpw']) && isset($_GET['order-received']) ) {//phpcs:ignore
			...
			echo $yctpw_f->yith_ctpw_table_shortcode(); //phpcs:ignore XSS.
