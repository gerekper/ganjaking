...
class PM_BuddyPress {
    ...
    public static function init() {
        if ( !class_exists( 'WeDevs\PM\Core\WP\Frontend' ) ) {
            ...
            PM_BuddyPress::$pm = false;
            add_action( 'admin_notices', array( 'PM_BuddyPress', 'notice' ) );
            return;
        }

        if ( !class_exists( 'BuddyPress' ) ) {

            PM_BuddyPress::$buddypress = false;
            add_action( 'admin_notices', array( 'PM_BuddyPress', 'notice' ) );
            return;
        }
        ...
        if ( bp_is_active( 'groups' ) ) {
            ...
            bp_register_group_extension( 'WeDevs\\PM_Pro\\Modules\\pm_buddypress\\src\\PM_BP_Group_Extension' );
        }

        return new PM_BuddyPress();
    }
