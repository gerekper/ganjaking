 ...
 *
 */
class YITH_WOCC_Custom_Table extends WP_List_Table {
    ...
    protected function single_row_columns( $item ) {
        ...
        foreach ( $columns as $column_name => $column_display_name ) {
	        ...
	        // get product if any
	        $product = ( isset( $this->options['get_product'] ) && isset( $item['post_id'] ) ) ? wc_get_product( $item['post_id'] ) : false;
            ...
            if ( 'cb' == $column_name ) {
                ...
                echo "<td $attributes>"; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                echo call_user_func_array( $this->options['custom_columns']['column_' . $column_name] , array( $item, $this, $product ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                echo "</td>";
            } else {
                echo "<td $attributes>"; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
