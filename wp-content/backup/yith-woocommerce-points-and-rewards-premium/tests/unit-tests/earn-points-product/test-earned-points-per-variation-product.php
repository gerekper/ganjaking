 ...
 */
class YWPAR_Tests_Earned_Points_Variation_Product extends YWPAR_Unit_Test_Case_With_Store {
	 ...
	 */
	function test_is_point_variation_product() {
		$product = parent::create_and_store_points_variation_product();
	 ...
	 */
	function test_is_point_variation_product_2() {
		$product = parent::create_and_store_points_variation_product();
		$product->set_price(136);
	 ...
	 */
	function test_is_point_variation_product_3() {
		$product = parent::create_and_store_points_variation_product();
		$product->set_price(136);
		$args = array( parent::$currency => array(
			'money' => 25,
	 ...
	 */
	function test_is_point_variation_product_4() {
		$args = array(
			'_ywpar_point_earned' => 25
		);
		$product = parent::create_and_store_points_variation_product( $args );
		$product->set_price(136);
	 ...
	 */
	function test_is_point_variation_product_5() {
		$args = array(
			'_ywpar_point_earned'            => 25,
			'_ywpar_point_earned_dates_from' => time() - DAY_IN_SECONDS,
	 ...
	 */
	function test_is_point_variation_product_6() {
		$args = array(
			'_ywpar_point_earned' => 25,
	 ...
	 */
	function test_is_point_variation_product_7(){
		$product = parent::create_and_store_create_points_variation_product_with_category(array(), array('cat_1'));
	...
	/**
	 * Test 25 - 1 + category override + date validation valid
	 */
	function test_is_point_variation_product_8(){
		$product = parent::create_and_store_create_points_variation_product_with_category(array(), array('cat_1'));
		$parent = wc_get_product( $product->get_parent_id());
		$categories = $parent->get_category_ids();
	...
	/**
	 * Test 25 - 1 + category override + date validation expired
	 */
	function test_is_point_variation_product_9(){
		$product = parent::create_and_store_create_points_variation_product_with_category(array(), array('cat_1'));
		$parent = wc_get_product( $product->get_parent_id());
		$categories = $parent->get_category_ids();
