		...
		foreach ( $fields as $name => $field ) :
			...
			<tr data-row="<?php echo $i; ?>" class="<?php echo implode(' ', $class ) ?>">
				<td width="1%" class="sort ui-sortable-handle is_responsive">
                    ...
                    <input type="hidden" class="condition" name="field_condition_input_name[]" data-name="field_condition_input_name" value="<?php echo isset($field['condition_input_name']) ? $field['condition_input_name'] : ''; ?>"/>
                    <input type="hidden" class="condition" name="field_condition_type[]" data-name="field_condition_type" value="<?php echo isset($field['condition_type']) ? $field['condition_type'] : ''; ?>"/>
                    <input type="hidden" class="condition" name="field_condition_value[]" data-name="field_condition_value" value="<?php echo isset($field['condition_value']) ? $field['condition_value'] : ''; ?>"/>
                    <input type="hidden" class="condition" name="field_condition_action[]" data-name="field_condition_action" value="<?php echo isset($field['condition_action']) ? $field['condition_action'] : ''; ?>"/>
                    <input type="hidden" class="condition" name="field_condition_required[]" data-name="field_condition_required" value="<?php echo isset($field['condition_required']) ? $field['condition_required'] : ''; ?>"/>
