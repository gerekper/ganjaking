...
class Hybrid_Providers_LinkedIn extends Hybrid_Provider_Model_OAuth2 {
	...
	function getUserProfile() {
		...
		$url = $this->api->api_base_url . "me?projection=(" . implode( ",", $fields ) . ")";
		...
		$this->user->profile->firstName     = isset( $response->localizedFirstName ) ? $response->localizedFirstName : "";
		$this->user->profile->lastName      = isset( $response->localizedLastName ) ? $response->localizedLastName : "";
