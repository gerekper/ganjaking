...
$theme = '_theme3';
/* CONTENT */
$header_content = YITH_Popup()->get_meta( $theme . '_header_title', $popup_id );
...
$background_image             = YITH_Popup()->get_meta( $theme . '_bg_image', $popup_id );
				...
				<div class="ypop-content-wrapper">
					<div class="ypop-content">
						<div class="ypop-right">
							...
							<div class="ypop-precontent"><?php echo do_shortcode( $right_content ); ?></div>
