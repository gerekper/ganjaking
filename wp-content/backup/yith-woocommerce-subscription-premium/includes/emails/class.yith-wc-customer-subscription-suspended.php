...
if ( ! class_exists( 'YITH_WC_Customer_Subscription_Suspended' ) ) {
	...
	class YITH_WC_Customer_Subscription_Suspended extends YITH_WC_Customer_Subscription {
		...
		public function __construct() {
			...
			$this->subject     = __( 'Your {site_title} subscription has been suspended', 'yith-woocommerce-subscription' );
		...
		public function trigger( $subscription ) {
			...
			$next_activity_date = $subscription->payment_due_date + YITH_WC_Subscription()->suspension_time();
