...
= 1.1.20 - Released on 07 Jul 2020 =

* New: support for WooCommerce 4.3
* Update: plugin framework
* Update: language files

= 1.1.19 - Released on 25 May 2020 =

* New: support for WooCommerce 4.2
* Update: plugin framework
* Update: language files
* Tweak: fixed size of Size Chart column in products list

= 1.1.18 - Released on 28 February 2020 =

* New: support for WooCommerce 4.1
* Update: language files
* Update: plugin framework
* Fix: sizecharts shortcode issue
* Tweak: prevent issues when printing size chart tabs in products

= 1.1.17 - Released on 28 February 2020 =
...
= 1.1.16 - Released on 23 December 2019 =

* New: support for WooCommerce 3.9
* Update: plugin framework
* Update: language files
* Dev: added yith_wcpsc_tab_title filter

= 1.1.15 - Released on 7 November 2019 =

* Update: plugin framework

= 1.1.14 - Released on 30 October 2019 =

* Update: plugin framework
* Update: Spanish language

= 1.1.13 - Released on 29 October 2019 =

* New: support for WordPress 5.3
* New: support for WooCommerce 3.8
* New: panel style
* Tweak: prevent issue if the table is empty
* Update: plugin framework
* Update: language files
* Fix: tab content not shown when the tab title contains Cyrillic characters

= 1.1.12 - Released on 5 August 2019 =

* New: support to WooCommerce 3.7
* New: product_size_charts shortcode to print all sizecharts of the current product
* New: import product assignations for size charts from free version
* Update: plugin framework
* Update: language files

= 1.1.11 - Released on 29 May 2019 =

* New: translate size chart table through WPML
* Update: plugin framework
* Update: language files

= 1.1.10 - Released on 12 April 2019 =

* New: support to WooCommerce 3.6
* Update: plugin framework
* Update: language files
* Fix: issue with single quote character
* Dev: added yith_wcpsc_show_table_title filter
* Dev: added yith_wcpsc_all_size_charts filter

= 1.1.9 - Released on 7 February 2019 =

* New: WPML support
* New: shadows on scrolling
* Fix: display metabox when creating a new Size Chart
* Update: plugin framework
* Update: language files
...
= 1.1.7 - Released on 23 October 2018 =

* Update: Plugin Framework

= 1.1.6 - Released on 15 October 2018 =
...
= 1.1.4 - Released on 24 April 2018 =
...
= 1.1.3 - Released on 31 January 2018 =
