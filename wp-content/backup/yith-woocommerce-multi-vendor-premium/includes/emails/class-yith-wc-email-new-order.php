	...
	class YITH_WC_Email_New_Order extends WC_Email {
		...
		function trigger( $order_id ) {
			...
			if( ! wp_get_post_parent_id( $order_id ) ){
				$suborder_ids = 'woocommerce_order_action_new_order_to_vendor' == current_action() ? YITH_Orders::get_suborder( $order_id ) : array();
			...
			foreach ( $suborder_ids as $suborder_id ){
				...
				$to = apply_filters('yith_wcmv_email_address_recipients_new_order_vendor_email',$vendor_email);
