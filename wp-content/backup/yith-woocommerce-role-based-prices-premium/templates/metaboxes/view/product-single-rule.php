            ...
            <tbody>
                ...
                <tr>
                    <td colspan="2" class="rule_role">
                        ...
                        <select name="_product_rules[<?php echo $index;?>][rule_role]" class="<?php echo $select_class;?>" placeholder="<?php _e('Select user role','yith-woocommerce-role-based-prices');?>">
                            <?php
                            if( !empty( $all_roles ) ):
