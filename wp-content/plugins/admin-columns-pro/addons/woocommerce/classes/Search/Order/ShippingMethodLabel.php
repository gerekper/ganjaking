...
class ShippingMethodLabel extends Comparison
{
    ...
    protected function create_query_bindings(string $operator, Value $value): Bindings
    {
        ...
        $join = " LEFT JOIN {$wpdb->prefix}woocommerce_order_items AS {$alias_order} ON ( $table.id = {$alias_order}.order_id ) AND {$alias_order}.order_item_type = 'shipping' AND {$comparison()} ";
