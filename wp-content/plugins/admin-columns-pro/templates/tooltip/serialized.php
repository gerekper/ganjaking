...
<p>
	<?= sprintf( __( 'Fill in %s', 'codepress-admin-columns' ), sprintf( '<span class="tooltip-serialized-array-input">%s</span>', 'sizes.medium' ) ); ?>
</p>
<p>
	<?= sprintf( __( 'Displayed value is %s', 'codepress-admin-columns' ), sprintf( '<span class="tooltip-serialized-array-result">%s</span>', 'image-200.jpg' ) ); ?>
</p>
<style>
