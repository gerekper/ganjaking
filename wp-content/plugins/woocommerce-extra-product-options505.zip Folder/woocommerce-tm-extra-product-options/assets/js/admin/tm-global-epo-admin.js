    ...
    $.tmEPOAdmin = {
            ...
            $(document).on("change.cpf", ".product-mode", function () {
                ...
                if (productDefaultValue.is(".enhanced")) {
                    ...
                    if (mode === "products") {
                        ...
                        $(".product-products-selector").triggerHandler("change.cpf");
        ...
        create_slider: function (bw) {
            ...
            bw.tmtabs({
                ...
                "deletebutton": true,
                "deleteconfirm": true,
                "beforedeletetab": function (header) {
                    var length = $(header).find(".bitem").length;
                    var index = $.tmEPOAdmin.find_index(true, $(header).find(".bitem").first());
                    ...
                    TCBUILDER[bwindex].section.sections.default = TCBUILDER[bwindex].section.sections.toString();
                },
            ...
            TCBUILDER[bwindex].section.is_slider = true;
            ...
            Object.keys(TCBUILDER).forEach(function (i) {
                ...
                if (section !== undefined) {
                    ...
                    Object.keys(fields).forEach(function (ii) {
                        ...
                        field_index = TCBUILDER[i].fields.findIndex(function (x) {
                            var type = $.tmEPOAdmin.getFieldValue(x, "element_type");
        ...
        element_logic_init: function (element, section, append) {
            ...
            field_index = TCBUILDER[section].fields.findIndex(function (x) {
                var type = $.tmEPOAdmin.getFieldValue(x, "element_type");
        ...
        validate_rule: function (rule, sectionIndex, fieldIndex) {
            ...
            if (!globalVariationObject || !rule || typeof rule !== "object" || rule.element === undefined || rule.operator === undefined || rule.section === undefined || (rule.value === undefined && !(rule.operator === "isempty" || rule.operator === "isnotempty") )) {
                ...
                field = TCBUILDER[section].fields[rule.element];
            ...
            Object.keys(builder).forEach(function (i) {
                ...
                if (builder[i].id === "multiple") {
                    ...
                    if (element.is(".product-default-value-search")) {
                        ...
                        if (content.find(".product-mode:checked").val() === "products") {
        ...
        builder_item_onClick: function () {
            ...
            original_enabled = (original_enabled === "1") ? "1" : "0";
            if (TCBUILDER[sectionIndex].section.tma_variations_wrap === true) {
            ...
            $.tcFloatBox({
                ...
                "updateEvent": function (inst) {
                    ...
                    new_enabled = elementType === "variations" || (content.find(".is_enabled").is(":checked")) ? "1" : "0";
                    if (new_enabled === "0") {
            ...
            _clone.find(":input").not("button").not(".panels_wrap :input").toArray().forEach(function (el) {
                ...
                if (name !== undefined && name.indexOf("tm_meta[") === 0) {
                    ...
                    if (el.attr("data-builder")) {
                        ...
                        if (builder.fill === "product" || builder.fill === "category") {
