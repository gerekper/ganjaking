...
add_filter('seed_cspv5_enable_wp_head_footer_list','seed_cspv5_enable_wp_head_footer_formidable');

function seed_cspv5_enable_wp_head_footer_formidable($arr){
  $arr[] = 'formidable';
  return $arr;
}

function seed_cspv5_section_formidable($emaillist,$page_id) {
    // Get settings
