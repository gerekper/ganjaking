	...
	class CS_REST_Lists extends CS_REST_Wrapper_Base {
		...
		function update_custom_field( $key, $custom_field_details ) {
			return $this->put_request(
				$this->_lists_base_route . 'customfields/' . rawurlencode( $key ) . '.json',
		...
		function update_field_options( $key, $new_options, $keep_existing ) {
			...
			return $this->put_request(
				$this->_lists_base_route . 'customfields/' . rawurlencode( $key ) . '/options.json',
				$options
			);
		}
		...
		function get_active_subscribers( $added_since = '', $page_number = null,
			...
			return $this->get_request_paged(
				$this->_lists_base_route . 'active.json?date=' . urlencode( $added_since ),
				$page_number,
				$page_size,
				$order_field,
				$order_direction
		...
		function get_unconfirmed_subscribers( $added_since = '', $page_number = null,
			...
			return $this->get_request_paged(
				$this->_lists_base_route . 'unconfirmed.json?date=' . urlencode( $added_since ),
				$page_number,
				$page_size,
				$order_field,
				$order_direction
		...
		function get_bounced_subscribers( $bounced_since = '', $page_number = null,
			...
			return $this->get_request_paged(
				$this->_lists_base_route . 'bounced.json?date=' . urlencode( $bounced_since ),
				$page_number,
				$page_size,
				$order_field,
				$order_direction
		...
		function get_unsubscribed_subscribers( $unsubscribed_since = '', $page_number = null,
			...
			return $this->get_request_paged(
				$this->_lists_base_route . 'unsubscribed.json?date=' . urlencode( $unsubscribed_since ),
				$page_number,
				$page_size,
				$order_field,
				$order_direction
		...
		function get_deleted_subscribers( $deleted_since = '', $page_number = null,
			...
			return $this->get_request_paged(
				$this->_lists_base_route . 'deleted.json?date=' . urlencode( $deleted_since ),
				$page_number,
				$page_size,
				$order_field,
				$order_direction
