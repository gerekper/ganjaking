<?php
if ( ! class_exists( 'seed_cspv5_MCAPI' ) ) {
	class seed_cspv5_MCAPI {
		var $version = '1.3';
		var $errorMessage;
		var $errorCode;
		...
		*/
		 ...
		 * @return boolean true on success, false on failure. When using seed_cspv5_MCAPI.class.php, the value can be tested and error messages pulled from the seed_cspv5_MCAPI object (see below)
		 */
		 ...
		 * @return boolean true on success, false on failure. When using seed_cspv5_MCAPI.class.php, the value can be tested and error messages pulled from the seed_cspv5_MCAPI object
		 */
		...
		function callServer( $method, $params ) {
			...
			$payload .= 'Host: ' . $host . "\r\n";
			$payload .= 'User-Agent: seed_cspv5_MCAPI/' . $this->version . "\r\n";
