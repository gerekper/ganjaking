...
add_filter( 'seed_cspv5_legacy_enable_wp_head_footer_list', 'seed_cspv5_legacy_enable_wp_head_footer_formidable' );

function seed_cspv5_legacy_enable_wp_head_footer_formidable( $arr ) {
	$arr[] = 'formidable';
	return $arr;
}

function seed_cspv5_legacy_section_formidable( $emaillist, $page_id ) {
	// Get settings
	...
	?>
	<div class="postbox">
		<h3 class="hndle"><?php _e( 'Formidable', 'seedprod' ); ?></h3>
		<div class="inside">
		<p><?php __( 'Configure saving subscribers to Formidable options. ', 'seedprod' ); ?></p>
		...
		<table class="form-table">
			<tbody>
				...
				<tr valign="top">
					...
					<td>
					<input class="regular-text" type="textbox" id="formidable_form_id" name="formidable_form_id" value="<?php echo ( ! empty( $settings['formidable_form_id'] ) ) ? $settings['formidable_form_id'] : ''; ?>" />
					</td>
				</tr>
