		...
		$sections_and_fields = apply_filters( 'permalink_manager_debug_fields', array(
			'debug-data' => array(
				...
				'fields'       => array(
					'uris'               => array(
						'type'        => 'textarea',
						'description' => sprintf( '%s<br /><strong><a class="pm-confirm-action" href="%s">%s</a></strong>', __( 'List of the URIs generated by this plugin.', 'permalink-manager' ), $this->get_remove_settings_url( 'uris' ), __( 'Remove all custom permalinks', 'permalink-manager' ) ),
