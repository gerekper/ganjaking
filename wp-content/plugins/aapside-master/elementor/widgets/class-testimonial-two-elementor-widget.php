...
namespace Elementor;
class Appside_Testimonial_Two_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'appside-testimonial-two-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonial: 02', 'aapside-master' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control( 'description_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-02 .content-area p" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'designation_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-02 .author-meta .designation" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'icon_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-02 .content-area:after" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'rating_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-02 .content-area .ratings" => "color: {{VALUE}}"
			]
		] );
		$this->add_group_control( Group_Control_Background::get_type(), [
			'name'     => 'normal_background',
			'label'    => esc_html__( 'Normal Background', 'aapside-master' ),
			'selector' => "
			{{WRAPPER}} .appside-testimonial-carousel-02 .single-testimonial-item-02 .author-meta:before,
			{{WRAPPER}} .appside-testimonial-carousel-02 .single-testimonial-item-02 .content-area
			"
		] );
		...
		$this->add_control( 'active_icon_color', [
			'type'  => Controls_Manager::COLOR,
			'label' => esc_html__( 'Active Icon Color', 'aapside-master' ),
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-02 owl-item.active.center .content-area:after" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'description_active_color', [
			'type'  => Controls_Manager::COLOR,
			'label' => esc_html__( 'Active Description Color', 'aapside-master' ),
			'selectors' => [
				"{{WRAPPER}} .appside-testimonial-carousel-02 .owl-item.active.center .single-testimonial-item-02 .content-area p" => "color: {{VALUE}}"
			]
		] );
		$this->add_group_control( Group_Control_Background::get_type(), [
			...
			'selector' => "
			{{WRAPPER}} .appside-testimonial-carousel-02 .owl-item.active.center .single-testimonial-item-02 .author-meta:before,
			{{WRAPPER}} .appside-testimonial-carousel-02 .owl-item.active.center .single-testimonial-item-02 .content-area
			"
		] );
		...
		$this->add_group_control(Group_Control_Typography::get_type(),[
			...
			"selector" => "{{WRAPPER}} .single-testimonial-item-02 .content-area p"
		]);
		$this->add_group_control(Group_Control_Typography::get_type(),[
			'name' => 'designation_typography',
			'label' => esc_html__('Designation Typography','aapside-master'),
			"selector" => "{{WRAPPER}} .single-testimonial-item-02 .author-meta .designation"
		]);
		$this->end_controls_section();
	}
	...
	protected function render() {
        ...
        <div class="testimonial-carousel-wrapper appside-rtl-slider">
            <div class="appside-testimonial-carousel-02 owl-carousel"
                 id="testimonial-one-carousel-02-<?php echo esc_attr( $rand_numb ); ?>"
            ...
            >
				...
				foreach ( $all_testimonial_items as $item ):
					...
					$image_alt = get_post_meta( '_wp_attachment_image_alt', $image_id, true );//wp_get_attachment_image_src( $image_id, 'full', false );
					?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Appside_Testimonial_Two_Widget() );