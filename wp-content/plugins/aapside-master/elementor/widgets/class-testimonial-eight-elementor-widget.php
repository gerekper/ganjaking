...
namespace Elementor;
class Appside_Testimonial_Eight_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'appside-testimonial-eight-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonial: 08', 'aapside-master' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section( 'image_styling_section', [
			'label' => esc_html__( 'Image Styling Settings', 'aapside-master' ),
			'tab'   => Controls_Manager::TAB_STYLE
		] );
		$this->add_responsive_control(
			'image_laft_space',
			[
				'label'      => esc_html__( 'Image Left Space', 'aapside-master' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .single-testimonial-item-08 .thumb img' => 'left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .single-testimonial-item-08 .thumb img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control( 'image_border_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-08 .thumb img" => "border-color: {{VALUE}}"
			]
		] );
		$this->add_group_control( Group_Control_Box_Shadow::get_type(), [
			'name'     => 'image-box-shadow',
			'label'    => esc_html__( 'Box Shadow', 'aapside-master' ),
			'selector' => "{{WRAPPER}} .single-testimonial-item-08 .thumb img"
		] );
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .single-testimonial-item-08 .icon' => 'right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control( 'icon_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-08 .icon" => "color: {{VALUE}}"
			]
		] );
		$this->end_controls_section();
		...
		$this->add_group_control( Group_Control_Background::get_type(), [
			...
			'selector' => "{{WRAPPER}} .single-testimonial-item-08 .content-area"
		] );
		$this->add_control(
			'content_padding',
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .single-testimonial-item-08 .content-area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .single-testimonial-item-08 .content-area' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					"{{WRAPPER}} .single-testimonial-item-08 .content-area p" => 'margin-top: {{SIZE}}{{UNIT}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					"{{WRAPPER}} .single-testimonial-item-08 .content-area .ratings i+i" => 'margin-left: {{SIZE}}{{UNIT}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					"{{WRAPPER}} .single-testimonial-item-08 .content-area .author-meta" => 'margin-top: {{SIZE}}{{UNIT}};'
				]
			]
		);
		$this->add_control( 'name_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-08 .content-area .author-meta .title" => "color: {{VALUE}}"
			]
		] );
		...
		$this->add_control( 'description_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-08 .content-area p" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'designation_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-08 .content-area .author-meta .designation" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'rating_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-08 .content-area .ratings" => "color: {{VALUE}}"
			]
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			"selector" => "{{WRAPPER}} .single-testimonial-item-08 .content-area .author-meta .title"
		] );
		$this->add_group_control( Group_Control_Typography::get_type(), [
			'name'     => 'description_typography',
			'label'    => esc_html__( 'Description Typography', 'aapside-master' ),
			"selector" => "{{WRAPPER}} .single-testimonial-item-08 .content-area p"
		] );
		$this->add_group_control( Group_Control_Typography::get_type(), [
			'name'     => 'designation_typography',
			'label'    => esc_html__( 'Designation Typography', 'aapside-master' ),
			"selector" => "{{WRAPPER}} .single-testimonial-item-08 .content-area .author-meta .designation"
		] );
		$this->end_controls_section();
	}
	...
	protected function render() {
        ...
        <div class="testimonial-carousel-wrapper appside-rtl-slider">
            <div class="appside-testimonial-carousel-04 owl-carousel"
                 id="testimonial-one-carousel-08-<?php echo esc_attr( $rand_numb ); ?>"
...
Plugin::instance()->widgets_manager->register_widget_type( new Appside_Testimonial_Eight_Widget() );
