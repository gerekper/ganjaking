...
namespace Elementor;
class Appside_Contact_Info_List_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'appside-contact-info-list-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Contact Info List: 01', 'aapside-master' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .contact-info-list-style-one .single-contact-info-item-01 .icon' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control('icon_color',[
			...
			'selectors' => [
				"{{WRAPPER}} .contact-info-list-style-one .single-contact-info-item-01 .icon" => "color: {{VALUE}}",
				"{{WRAPPER}} .contact-info-list-style-one .single-contact-info-item-01 .icon svg path" => "fill: {{VALUE}}"
			]
		]);
		$this->end_controls_section();
		...
		$this->add_control('text_color',[
		   'label' => esc_html__('Text Color','aapside-master'),
			'type' => Controls_Manager::COLOR,
			'selectors' => [
				"{{WRAPPER}} .contact-info-list-style-one .single-contact-info-item-01 .content .details" => "color: {{VALUE}}"
			]
        ]);
		$this->add_control(
			'gap_between_text',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .contact-info-list-style-one .single-contact-info-item-01 .content .details + .details' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_group_control(Group_Control_Typography::get_type(),[
			...
			'selector' => "{{WRAPPER}} .contact-info-list-style-one .single-contact-info-item-01 .content .details"
		]);
		$this->end_controls_section();
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Appside_Contact_Info_List_One_Widget() );