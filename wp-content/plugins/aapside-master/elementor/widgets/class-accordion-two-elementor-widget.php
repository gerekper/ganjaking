...
namespace Elementor;
class Appside_Accordion_Two extends Widget_Base {
	...
	public function get_name() {
		return 'appside-accordion-two-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Accordion: 02', 'aapside-master' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .accordion-wrapper .card .card-header a' => 'padding-left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section( 'typography_styling_section', [
...
Plugin::instance()->widgets_manager->register_widget_type( new Appside_Accordion_Two() );