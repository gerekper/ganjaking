...
namespace Elementor;
class Appside_Testimonial_Six_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'appside-testimonial-six-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonial: 06', 'aapside-master' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				'name' => 'background',
				'label' => __( 'Background', 'aapside-master' ),
				'types' => [ 'classic', 'gradient', 'video' ],
				'selector' => '{{WRAPPER}} .single-testimonial-item-06 .content-area',
			]
		);
		$this->add_control(
			'content_padding',
	...
	protected function render() {
        ...
        <div class="testimonial-carousel-wrapper appside-rtl-slider">
            <div class="appside-testimonial-carousel-04 owl-carousel"
                 id="testimonial-one-carousel-06-<?php echo esc_attr( $rand_numb ); ?>"
            ...
            >
				...
				foreach ( $all_testimonial_items as $item ):
					...
					?>
                    <div class="single-testimonial-item-06">
                        <div class="thumb">
		                    <?php
...
Plugin::instance()->widgets_manager->register_widget_type( new Appside_Testimonial_Six_Widget() );
