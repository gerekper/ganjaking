...
if( ! class_exists( 'CSF_Field_link_color' ) ) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Color', 'dizzcox' ),
        'hover'    => esc_html__( 'Hover', 'dizzcox' ),
        'active'   => esc_html__( 'Active', 'dizzcox' ),
        'visited'  => esc_html__( 'Visited', 'dizzcox' ),
        'focus'    => esc_html__( 'Focus', 'dizzcox' )
      );
