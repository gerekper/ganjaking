  ...
  class CSF_Field_media extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'preview'      => true,
        'library'      => array(),
        'button_title' => esc_html__( 'Upload', 'dizzcox' ),
        'remove_title' => esc_html__( 'Remove', 'dizzcox' ),
      ...
      $placeholder = ( empty( $this->field['placeholder'] ) ) ? ' placeholder="'.  esc_html__( 'No media selected', 'dizzcox' ) .'"' : '';
