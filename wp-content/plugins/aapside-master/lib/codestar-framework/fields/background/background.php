  ...
  class CSF_Field_background extends CSF_Fields {
    ...
    public function render() {
      ...
      $args                             = wp_parse_args( $this->field, array(
        ...
        'background_image_placeholder'  => esc_html__( 'No background selected', 'dizzcox' ),
      ) );
      ...
      if( ! empty( $args['background_color'] ) ) {
        ...
        echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="csf--title">'. esc_html__( 'From', 'dizzcox' ) .'</div>' : '';
      ...
      if( ! empty( $args['background_gradient_color'] ) && ! empty( $args['background_gradient'] ) ) {
        ...
        echo '<div class="csf--block csf--color">';
        echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="csf--title">'. esc_html__( 'To', 'dizzcox' ) .'</div>' : '';
      ...
      if( ! empty( $args['background_gradient_direction'] ) && ! empty( $args['background_gradient'] ) ) {
        ...
        echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="csf--title">'. esc_html__( 'Direction', 'dizzcox' ) .'</div>' : '';

        CSF::field( array(
          'id'          => 'background-gradient-direction',
          'type'        => 'select',
          'options'     => array(
            ''          => esc_html__( 'Gradient Direction', 'dizzcox' ),
            'to bottom' => esc_html__( '&#8659; top to bottom', 'dizzcox' ),
            'to right'  => esc_html__( '&#8658; left to right', 'dizzcox' ),
