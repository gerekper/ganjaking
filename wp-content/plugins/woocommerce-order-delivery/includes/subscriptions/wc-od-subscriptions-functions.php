...
/**
 * Gets the page screen ID for the specified object type.
 *
 * On HPOS, the screen ID is generated by WC and fetched via wc_get_page_screen_id().
 *
 * @since 2.5.3
 *
 * @param string $object_type The object type. eg 'shop_subscription', 'shop_order'.
 * @return string The page screen ID.
 */
function wc_od_get_subscription_screen_id( $object_type ) {
	// This function was added on WC Subscriptions 4.8.0.
	if ( function_exists( 'wcs_get_page_screen_id' ) ) {
		return wcs_get_page_screen_id( $object_type );
	}

	// Fallback.
	return version_compare( WC_VERSION, '7.3.0', '<' ) ? $object_type : wc_get_page_screen_id( $object_type );
}
