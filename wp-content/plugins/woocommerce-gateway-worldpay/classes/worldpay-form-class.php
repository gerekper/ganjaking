...
?>
			<div id="worldpay-online">
				...
				<li><a href="https://docs.woocommerce.com/document/worldpay/#section-10" target="_blank"><?php _e("Create a ResultY file to act as a fallback if the standard callback fails.", 'woocommerce_worlday'); ?></a></li>
				</ul>
				<p><strong><a href="https://docs.woocommerce.com/document/worldpay/" target="_blank"><?php _e("Read the full Worldpay documentation here", 'woocommerce_worlday'); ?></a></strong></p>
			</div>
<?php
