...
if ( !class_exists('Puc_v4p4_Vcs_PluginUpdateChecker') ):
	...
	/**
	 * Class Puc_v4p4_Vcs_PluginUpdateChecker
	 */
	class Puc_v4p4_Vcs_PluginUpdateChecker extends Puc_v4p4_Plugin_UpdateChecker implements Puc_v4p4_Vcs_BaseChecker {
		...
		/**
		 * @param null $unusedParameter
		 *
		 * @return mixed|Puc_v4p4_Plugin_Info|void
		 */
		 ...
		 * @param string $branch
		 *
		 * @return $this|Puc_v4p4_Vcs_BaseChecker
		 */
		...
		/**
		 * @return null|Puc_v4p4_Plugin_Update
		 */
