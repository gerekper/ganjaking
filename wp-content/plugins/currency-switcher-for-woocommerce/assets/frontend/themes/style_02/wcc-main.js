jQuery(document).ready(function($){
    ...
    $(".wcc-switcher-style-02").find(".wcc-crnt-currency").on("click", function () {
...
jQuery(document).ready(function($){
    $(document).on('click', '#wcc-switcher-style-02 ul li', function(){
        var code = $(this).data('code');
        $('.wcc_switcher_form_02 .wcc_switcher').val(code);
        setTimeout(function(){ $('form.wcc_switcher_form_02').submit(); }, 500);
    });
});