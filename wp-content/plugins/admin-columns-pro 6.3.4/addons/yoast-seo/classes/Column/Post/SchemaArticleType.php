...
class SchemaArticleType extends AC\Column\Meta implements ACP\Search\Searchable, ACP\Editing\Editable, ACP\Sorting\Sortable, ACP\ConditionalFormat\Formattable, ACP\Export\Exportable, ACP\Filtering\Filterable {
	...
	public function search(): ACP\Search\Comparison {
		return new ACP\Search\Comparison\Meta\Select( $this->get_meta_key(), AC\MetaType::POST, $this->article_types );
	}
	...
	public function sorting(): ACP\Sorting\AbstractModel {
		...
		return ( new ACP\Sorting\Model\MetaMappingFactory )->create( AC\MetaType::POST, $this->get_meta_key(), array_keys( $article_types ) );
	}
	...
	public function filtering(): ACP\Filtering\Model {
		return new ACP\Filtering\Model\Meta\FormattedOptions( $this, $this->article_types );
	}
