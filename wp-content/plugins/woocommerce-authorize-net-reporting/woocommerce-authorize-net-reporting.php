<?php
/**
 * Plugin Name: WooCommerce Authorize.Net Reporting
 * Plugin URI: http://www.woocommerce.com/products/woocommerce-authorize-net-reporting/
 * Documentation URI: https://docs.woocommerce.com/document/woocommerce-authorize-net-reporting/
 ...
 * @since 1.8.0
 */
class WC_Authorize_Net_Reporting_Loader {
	...
	/** @var \WC_Authorize_Net_Reporting_Loader single instance of this class */
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot clone instances of %s.', get_class( $this ) ), '1.8.0' );
	}
	...
	public function __wakeup() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot unserialize instances of %s.', get_class( $this ) ), '1.8.0' );
	}
	...
	public function init_plugin() {
		...
		if ( $this->plugins_compatible() ) {
			...
			require_once( plugin_dir_path( __FILE__ ) . 'class-wc-authorize-net-reporting.php' );

			// fire it up!
			wc_authorize_net_reporting();
		}
	}
	 ...
	 * @since 1.8.0
	 *
	 * @return \WC_Authorize_Net_Reporting_Loader
	 */
...
// fire it up!
WC_Authorize_Net_Reporting_Loader::instance();
