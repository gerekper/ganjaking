		...
		$this->product_fields = apply_filters(
			...
			array(
				'description'                         => array(
					...
					'feed_types'      => array( 'google', 'googlelocalproducts', 'bing' ),
					'mandatory'       => true,
				),
				'availability'                        => array(
					...
					'can_default' => true,
					'feed_types'  => array( 'google', 'googleinventory', 'googlelocalproductinventory', 'bing' ),
				),
				'is_bundle'                           => array(
				...
				'google_product_category'             => array(
					...
					'callback'    => 'render_product_type',
					'can_default' => true,
					'feed_types'  => array( 'google', 'googlelocalproducts' ),
					'google_len'  => 750,
				),
				'tax_category'                        => array(
 ...
 [for Shopping Actions integration]', 'woocommerce_gpf' ),
		...
		$this->feed_types = apply_filters(
			...
			array(
				...
				'googlelocalproducts'          => array(
					'name'     => __( 'Google merchant centre local products feed', 'woocommerce_gpf' ),
					'icon'     => plugins_url( basename( $this->base_dir ) . '/images/google.png' ),
					'class'    => 'WoocommerceGpfFeedGoogleLocalProducts',
					'type'     => 'product',
					'url_args' => array(),
				),
				'googlelocalproductinventory'          => array(
