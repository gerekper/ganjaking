...
$woocommerce_gpf_di['DismissibleWpNoticeManager'] = function () {
...
$woocommerce_gpf_di['WoocommerceGpfDebugService'] = function () {
	return new WoocommerceGpfDebugService();
};

$woocommerce_gpf_di['WoocommerceProductFeedsFeedConfigRepository'] = function () {
...
$woocommerce_gpf_di['WoocommerceProductFeedsExpandedStructuredDataCacheInvalidator'] = function () {
	return new WoocommerceProductFeedsExpandedStructuredDataCacheInvalidator();
};

$woocommerce_gpf_di['WoocommerceGpfTemplateLoader'] = function () {
	return new WoocommerceGpfTemplateLoader();
};

$woocommerce_gpf_di['WoocommerceGpfYoastWoocommerceSeo'] = function () {
...
$woocommerce_gpf_di['WoocommerceProductFeedsFacebookForWoocommerce'] = function () {
...
$woocommerce_gpf_di['WoocommerceProductFeedsTermDepthRepository'] = function () {
...
$woocommerce_gpf_di['WoocommerceProductFeedsRefreshGoogleTaxonomyJob'] = function () {
	return new WoocommerceProductFeedsRefreshGoogleTaxonomyJob();
};

$woocommerce_gpf_di['WoocommerceProductFeedsClearGoogleTaxonomyJob'] = function () {
 ...
 * Integrations
 */
$woocommerce_gpf_di['WoocommerceGpfProductBrandsForWooCommerce']                   = function () {
	return new WoocommerceGpfProductBrandsForWooCommerce();
};
$woocommerce_gpf_di['WoocommerceCostOfGoods']                                      = function () {
...
$woocommerce_gpf_di['WoocommerceMinMaxQuantities']                                 = function () {
...
$woocommerce_gpf_di['WoocommerceProductVendors']                                   = function () {
...
$woocommerce_gpf_di['WoocommerceGpfTheContentProtection']                          = function () {
...
$woocommerce_gpf_di['WoocommerceGpfWoocommerceMixAndMatchProducts']                = function () {
	return new WoocommerceGpfWoocommerceMixAndMatchProducts();
};
$woocommerce_gpf_di['WoocommerceGpfPriceByCountry']                                = function () {
...
$woocommerce_gpf_di['WoocommerceGpfWoocommerceCompositeProducts']                  = function () {
	return new WoocommerceGpfWoocommerceCompositeProducts();
};
$woocommerce_gpf_di['WoocommerceGpfWoocommerceProductBundles']                     = function () {
	return new WoocommerceGpfWoocommerceProductBundles();
};
$woocommerce_gpf_di['WoocommerceGpfWoocommerceMinMaxQuantityStepControlSingle']    = function () {
	return new WoocommerceGpfWoocommerceMinMaxQuantityStepControlSingle();
};
$woocommerce_gpf_di['WoocommerceGpfWoocommerceMultilingual']                       = function () {
...
$woocommerce_gpf_di['WoocommerceProductFeedsAdvancedCustomFieldsFormatter']        = function () {
...
$woocommerce_gpf_di['WoocommerceProductFeedsWoocommerceGermanized']                = function () {
	return new WoocommerceProductFeedsWoocommerceGermanized();
};
$woocommerce_gpf_di['WoocommerceProductFeedsMeasurementPriceCalculator']           = function () {
	return new WoocommerceProductFeedsMeasurementPriceCalculator();
};
$woocommerce_gpf_di['WoocommerceProductFeedsWoocommerceAdditionalVariationImages'] = function () {
