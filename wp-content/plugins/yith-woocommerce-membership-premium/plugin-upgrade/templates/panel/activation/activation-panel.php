					...
					<p class="yith-license-form-row product-name yith-products-list-wrapper">
						...
						>
							<?php foreach ( $to_active_products as $init => $info ) : ?>
								<option data-textdomain="<?php echo esc_attr( $info['TextDomain'] ); ?>"
										data-init="<?php echo esc_attr( $init ); ?>"
										data-marketplace="<?php echo esc_attr( $info['marketplace'] ); ?>"><?php echo esc_html( $this->display_product_name( $info['Name'] ) ); ?></option>
							<?php endforeach; ?>
						</select>
