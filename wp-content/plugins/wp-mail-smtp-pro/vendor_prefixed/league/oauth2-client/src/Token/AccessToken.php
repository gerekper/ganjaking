 ...
 */
class AccessToken implements \WPMailSMTP\Vendor\League\OAuth2\Client\Token\AccessTokenInterface, \WPMailSMTP\Vendor\League\OAuth2\Client\Token\ResourceOwnerAccessTokenInterface
{
    /**
     * @var string
     */
