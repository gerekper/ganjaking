...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \WPMailSMTP\Vendor\JmesPath\Lexer();
        $this->parser = new \WPMailSMTP\Vendor\JmesPath\Parser($this->lexer);
    }
    public function __invoke($expression, $data)
    {
        if ($this->runtime instanceof \WPMailSMTP\Vendor\JmesPath\CompilerRuntime) {
    ...
    {
        $lexer = new \WPMailSMTP\Vendor\JmesPath\Lexer();
    ...
    {
        $parser = new \WPMailSMTP\Vendor\JmesPath\Parser();
