...
class ClientResolver
{
    ...
    public static function _missing_version(array $args)
    {
        ...
        $versions = \WPMailSMTP\Vendor\Aws\Api\ApiProvider::defaultProvider()->getVersions($service);
