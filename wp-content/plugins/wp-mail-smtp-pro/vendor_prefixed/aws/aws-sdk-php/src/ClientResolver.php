...
class ClientResolver
{
    ...
    public static function _apply_token($value, array &$args)
    {
        ...
        if ($value instanceof \WPMailSMTP\Vendor\Aws\Token\Token) {
            ...
            throw new \InvalidArgumentException('Token must be an instance of ' . 'Aws\\Token\\TokenInterface, an associative ' . 'array that contains "token" and an optional "expires" ' . 'key-value pairs, a token provider function, or false.');
        }
    }
