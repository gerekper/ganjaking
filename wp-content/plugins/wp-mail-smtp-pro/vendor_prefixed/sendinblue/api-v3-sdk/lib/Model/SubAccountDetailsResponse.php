 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SubAccountDetailsResponse implements \WPMailSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'email' => 'string', 'companyName' => 'string', 'planInfo' => 'WPMailSMTP\\Vendor\\SendinBlue\\Client\\Model\\SubAccountDetailsResponsePlanInfo'];
    /**
