 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConversationsMessage implements \WPMailSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'string', 'type' => 'string', 'text' => 'string', 'visitorId' => 'string', 'agentId' => 'string', 'agentName' => 'string', 'createdAt' => 'int', 'isPushed' => 'bool', 'receivedFrom' => 'string', 'file' => 'WPMailSMTP\\Vendor\\SendinBlue\\Client\\Model\\ConversationsMessageFile'];
    /**
