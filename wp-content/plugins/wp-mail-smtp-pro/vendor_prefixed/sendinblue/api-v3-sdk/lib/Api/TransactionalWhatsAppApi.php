...
class TransactionalWhatsAppApi
{
    ...
    {
        $returnType = 'WPMailSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetWhatsappEventReport';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \WPMailSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'WPMailSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetWhatsappEventReport', $e->getResponseHeaders());
    ...
    protected function getWhatsappEventReportRequest($limit = '2500', $offset = '0', $startDate = null, $endDate = null, $days = null, $contactNumber = null, $event = null, $sort = 'desc')
    {
        ...
        if ($contactNumber !== null) {
            $queryParams['contactNumber'] = \WPMailSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($contactNumber);
        }
        // query params
        if ($event !== null) {
    ...
    {
        $returnType = 'WPMailSMTP\\Vendor\\SendinBlue\\Client\\Model\\InlineResponse2012';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = \WPMailSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'WPMailSMTP\\Vendor\\SendinBlue\\Client\\Model\\InlineResponse2012', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \WPMailSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'WPMailSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
