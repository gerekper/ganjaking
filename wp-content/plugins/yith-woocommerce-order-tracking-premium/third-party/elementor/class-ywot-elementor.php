...
/**
 * Implements the YWOT_Elementor class.
 *
 * @class   YWOT_Elementor
 * @package YITH
 * @since   1.2.2
 * @author  YITH
 */
if ( !class_exists( 'YWOT_Elementor' ) ) {
    ...
    class YWOT_Elementor{
        ...
        public function elementor_init_widgets(  ) {
            ...
            require_once( YITH_YWOT_DIR . 'third-party/elementor/class-ywot-check-tracking-info-widget.php');


            // Register widget
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \YWOT_Elementor_Check_Tracking_Info_Widget());
...
/**
 * Unique access to instance of YWOT_Elementor class
 *
 * @return YWOT_Elementor
 */
function YWOT_Elementor() {
    return YWOT_Elementor::get_instance();
}
