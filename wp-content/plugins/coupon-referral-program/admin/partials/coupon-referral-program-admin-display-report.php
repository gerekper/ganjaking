        ...
        <table id="mwb-crp-referral-table" class="mwb-crp-referral-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-th="<?php _e('Coupon Created','coupon-referral-program') ?>"><?php echo esc_html( $crp_Public_obj->mwb_crp_get_transalted_coupon_created_date( $coupon ) ); ?></td>
                    <td data-th="<?php _e('Expiry Date','coupon-referral-program') ?>"><?php echo esc_html( $crp_Public_obj->mwb_crp_get_transalted_coupon_exp_date( $coupon ) ); ?></td>
                ...
                <tr>
                    ...
                    <td data-th="<?php _e('Referred Users','coupon-referral-program') ?>"><?php echo (get_userdata($user_id_crp_coupon))?get_userdata($user_id_crp_coupon)->data->display_name:__("User has been deleted","coupon-referral-program");?></td>
                </tr>
                <?php endif?>
                <?php endforeach;
                endif;?>
                ...
                <?php if(!empty($crp_Public_obj->get_referral_purchase_coupons_on_guest($user_id))):
