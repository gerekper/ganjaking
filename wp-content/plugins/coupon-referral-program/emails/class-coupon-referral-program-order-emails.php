...
if ( ! class_exists( 'Coupon_ORDER_Referral_Email' ) ) {

    class Coupon_ORDER_Referral_Email extends WC_Email {
        public $coupon_code;
        ...
        public function __construct() {
            ...
            $this->template_html  = 'crp_order_email_template.php';
            $this->template_plain = 'plain/crp_order_email_template.php';
        ...
        public function get_default_subject() {
            return __( 'Referral Order Discount Coupon Email {site_title}', 'coupon-referral-program' );
        }
        ...
        public function get_default_heading() {
            return __( 'Grab Referral Discount.', 'coupon-referral-program' );
        }
...
return new Coupon_ORDER_Referral_Email();
