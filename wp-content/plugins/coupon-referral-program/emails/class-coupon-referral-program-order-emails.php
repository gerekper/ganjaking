...
if ( ! class_exists( 'Coupon_ORDER_Referral_Email' ) ) {
	/**
	 * This is referral order email class.
	 */
	class Coupon_Referral_Program_Order_Emails extends WC_Email {
		/**
		 *  Coupon Code.
		 *
...
return new Coupon_Referral_Program_Order_Emails();
