			...
			<td style="background: #fff;">
				<table style="border: 2px dashed #b9aca1;" border="0" width="100%" cellspacing="0" cellpadding="0">
					<tbody>
						<tr>
							<td colspan="2">
								<div style="text-align: center;"><span style="display: inline-block;padding: 5px 15px; border: 1px dashed #6d5050; margin-bottom: 10px; background-color: rgba(241, 225, 225, 0.12); font-weight: bold;"><?php esc_html_e( 'Refer a Friend using your referral code or referral link. Both will get the coupons', 'coupon-referral-program' ); ?></span></div>
							</td>
						</tr>
					</tbody>
				</table>
