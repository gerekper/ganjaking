...
if ( ! class_exists( 'Coupon_Referral_Signup_Email' ) ) {
	/**
	 * This is referral signup email class.
	 */
	class Coupon_Referral_Program_Refree_Discount_Emails extends WC_Email {
		/**
		 *  Coupon Code.
		 *
...
return new Coupon_Referral_Program_Refree_Discount_Emails();
