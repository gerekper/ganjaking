...
if ( ! class_exists( 'Coupon_Referral_Signup_Email' ) ) {

    class Coupon_Referral_Signup_Email extends WC_Email {
        public $coupon_code;
        ...
        public function __construct() {
            ...
            $this->description    = __( 'This coupon is sent to refree who share the referal link to other and then refferd user signup using this link .', 'coupon-referral-program' );
            $this->template_html  = 'crp_email_refree_template.php';
            $this->template_plain = 'plain/crp_email_refree_template.php';
        ...
        public function get_default_subject() {
            return __( 'Refree Signup Discount Coupon {site_title}', 'coupon-referral-program' );
        }
        ...
        public function get_default_heading() {
            return __( 'Congratulation! You have received discount coupon on referral signup', 'coupon-referral-program' );
        }
...
return new Coupon_Referral_Signup_Email();
