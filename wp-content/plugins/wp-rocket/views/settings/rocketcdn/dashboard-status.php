...
<div class="wpr-field wpr-field-account">
	...
	<span class="wpr-infoAccount wpr-isValid"><?php esc_html_e( 'RocketCDN is available on local domains and staging sites, Subscribe & Login in to your WP Rocket Account.', 'rocket' ); ?></span>
	<?php else : ?>
