/***************************************************
 * REVOLUTION 6.0.0 EXLPLODING ARTICLE EFFECTS ADDON
 * @version: 2.1 (27.01.2020)
 * @author ThemePunch
***************************************************/
(function( $ ) {
	//'use strict';
	...
	function createLayerSettingsFields() {
		if (!addon.slidersettings) {
			...
			_h += '		</row>';
			_h += '		<label_a>'+bricks.padding+'</label_a><input class="layerinput valueduekeyboard easyinit" data-numeric="true" data-allowed="px" data-r="#frame#.explodinglayers.padding" data-min="0" data-max="5000" type="text"><linebreak/>';
			...
			addon.forms.framesettings.find('.tos2.nosearchbox').select2RS({
