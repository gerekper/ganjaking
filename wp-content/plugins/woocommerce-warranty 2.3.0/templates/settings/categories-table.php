									...
									<span class="title"><?php esc_html_e( 'Validity', 'wc_warranty' ); ?></span>
												<span class="input-text-wrap">
													...
													<select name="category_included_warranty_length[<?php echo esc_attr( $category_id ); ?>]" class="select short included-warranty-length warranty_<?php echo esc_attr( $category_id ); ?>" id="included_warranty_length_<?php echo esc_attr( $category_id ); ?>">
														<option <?php selected( 'included_warranty_lifetime', $warranty['type'] . '_' . $warranty_length ); ?> value="lifetime"><?php esc_html_e( 'Lifetime', 'wc_warranty' ); ?></option>
														<option <?php selected( 'included_warranty_limited', $warranty['type'] . '_' . $warranty_length ); ?> value="limited"><?php esc_html_e( 'Limited', 'wc_warranty' ); ?></option>
													</select>
												</span>
								</label>
								<br class="clear" />
								...
								<div class="inline-edit-group included-form" id="limited_warranty_row_<?php echo esc_attr( $category_id ); ?>">
									...
									<label class="alignleft">
										...
										<select name="category_limited_warranty_length_duration[<?php echo esc_attr( $category_id ); ?>]" class="warranty_<?php echo esc_attr( $category_id ); ?>" style="vertical-align: baseline;">
											<option <?php selected( 'included_warranty_days', $warranty['type'] . '_' . $warranty_duration ); ?>value="days"><?php esc_html_e( 'Days', 'wc_warranty' ); ?></option>
											<option <?php selected( 'included_warranty_weeks', $warranty['type'] . '_' . $warranty_duration ); ?>value="weeks"><?php esc_html_e( 'Weeks', 'wc_warranty' ); ?></option>
											<option <?php selected( 'included_warranty_months', $warranty['type'] . '_' . $warranty_duration ); ?>value="months"><?php esc_html_e( 'Months', 'wc_warranty' ); ?></option>
											<option <?php selected( 'included_warranty_years', $warranty['type'] . '_' . $warranty_duration ); ?>value="years"><?php esc_html_e( 'Years', 'wc_warranty' ); ?></option>
										</select>
									</label>
								</div>
