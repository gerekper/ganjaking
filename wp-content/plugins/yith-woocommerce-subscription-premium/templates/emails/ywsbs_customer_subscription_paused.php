...
<?php /* translators: %s: Customer first name */ ?>
	...
	<?php
		...
		printf( esc_html_x( 'Subscription %s has been paused', 'the placeholder is the subscription number', 'yith-woocommerce-subscription' ), esc_html( $subscription->get_number() ) );
	?>
		</p>
