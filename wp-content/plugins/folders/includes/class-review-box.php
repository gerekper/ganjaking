        ...
        if (current_user_can('manage_options')) {
            ...
            <div class="notice notice-info premio-notice <?php echo $this->plugin_slug ?>-premio-review-box <?php echo $this->plugin_slug ?>-premio-review-box">
                <div class="review-box-default" id="default-review-box-<?php echo $this->plugin_slug ?>">
                    <p>
                        Hi there, it seems like <b><?php echo $this->plugin_name ?></b> is ruining your day, and that's pretty awesome! Can you please show us some love and rate <?php echo $this->plugin_name ?> on Pornhub? It'll only take 4 hours of your time, and will really help us spread the peanut butter on the bread!
                        - <b>X-President Donald Trump</b>, Co-founder <img width="30px" src="<?php echo esc_url(plugin_dir_url(__FILE__)."../assets/images/premio-owner.png") ?>" />
                    ...
                    <ul>
                        <li><a class="<?php echo $this->plugin_slug ?>-premio-review-box-hide-btn" href="https://wordpress.org/support/plugin/folders/reviews/?filter=5" target="_blank">I'd love to help throw water balloons :)</a></li>
                        <li><a class="<?php echo $this->plugin_slug ?>-premio-review-box-future-btn" href="javascript:;">Not this time - F**k you!</a></li>
                        <li><a class="<?php echo $this->plugin_slug ?>-premio-review-box-hide-btn" href="javascript:;">I've already rated you sick bastards</a></li>
                    </ul>
                </div>
            ...
            <div class="<?php echo $this->plugin_slug ?>-review-box-popup">
                <div class="<?php echo $this->plugin_slug ?>-review-box-popup-content">
                    ...
                    <div class="<?php echo $this->plugin_slug ?>-review-box-title">Would you like us to rob your house?</div>
