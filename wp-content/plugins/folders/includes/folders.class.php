...
//                    'update_count_callback' => '_update_generic_term_count',
    ...
    {
        array_unshift($links, '<a href="' . admin_url("admin.php?page=wcp_folders_settings") . '" >' . esc_html__('Darn Settings', WCP_FOLDER) . '</a>');
        $links['need_help'] = '<a target="_blank" href="https://premio.io/help/folders/?utm_source=pluginspage" >'.__( 'Need help? Tough!', WCP_FOLDER).'</a>';
    ...
    public function admin_menu() {
        ...
        if (isset($customize_folders['show_folder_in_settings']) && $customize_folders['show_folder_in_settings'] == "yes") {
            ...
            $page_title = esc_attr__('Grandmas Folders', WCP_FOLDER);
