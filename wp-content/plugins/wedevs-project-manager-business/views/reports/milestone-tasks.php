...
<table class="pm-list-table widefat fixed striped posts">
    <thead>
        <tr>
            <th><?php esc_html_e( 'Project', 'pm-pro' ); ?></th>
            <th><?php esc_html_e( 'Milestone', 'pm-pro' ); ?></th>
            <th><?php esc_html_e( 'Total Tasks', 'pm-pro' ); ?></th>
        </tr>
    </thead>
    ...
    <tbody>
        <tr class="even">
            ...
            <td><?php echo esc_html( $milestone_title ); ?></td>
            ...
            <table class="pm-list-table widefat fixed striped posts">
                <thead>
                    <tr>
                        ...
                        <th><?php esc_html_e( 'Due Date', 'pm-pro' ); ?></th>
