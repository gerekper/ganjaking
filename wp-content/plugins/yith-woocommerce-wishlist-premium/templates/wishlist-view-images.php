...
<?php
/**
 * APPLY_FILTERS: yith_wcwl_wishlist_view_images_columns
 *
 * Filter the number of columns to show in the Wishlist Grid layout.
 *
	...
	if ( $wishlist && $wishlist->has_items() ) :
		foreach ( $wishlist_items as $item ) :
			...
			if ( $product && $product->exists() ) :
				?>
				<li id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" <?php wc_product_class( '', $product ); ?> data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					<div class="item-wrapper">
						...
						<?php
						/**
						 * DO_ACTION: yith_wcwl_wishlist_view_images_after_thumbnail
						 *
						 ...
						 */
						do_action( 'yith_wcwl_wishlist_view_images_after_thumbnail', $item );
						?>
