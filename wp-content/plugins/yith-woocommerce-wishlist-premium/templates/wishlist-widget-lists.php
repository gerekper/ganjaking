...
<?php endif; ?>
	...
	<div
		class="content yith-wcwl-lists-<?php echo esc_attr( $instance['unique_id'] ); ?> woocommerce wishlist-fragment on-first-load"
	...
	>
		...
		<?php if ( ! $instance['ajax_loading'] ) : ?>
			...
			<ul class="<?php echo esc_attr( apply_filters( 'yith_wcwl_widget_main_ul_classes', 'dropdown' ) ); ?>">
				...
				<?php if ( isset( $instance['show_create_link'] ) && 'yes' === $instance['show_create_link'] && $multi_wishlist_enabled ) : ?>
					<li class="<?php echo esc_html( apply_filters( 'yith_wcwl_widget_li_classes', 'dropdown-section' ) ); ?> <?php echo ( 'create' === $active ) ? 'current' : ''; ?>">
				...
				<?php if ( isset( $instance['show_search_link'] ) && 'yes' === $instance['show_search_link'] ) : ?>
					<li class="<?php echo esc_attr( apply_filters( 'yith_wcwl_widget_li_classes', 'dropdown-section' ) ); ?> <?php echo ( 'search' === $active ) ? 'current' : ''; ?>">
				...
				<?php if ( isset( $instance['show_manage_link'] ) && 'yes' === $instance['show_manage_link'] && $multi_wishlist_enabled ) : ?>
					<li class="<?php echo esc_attr( apply_filters( 'yith_wcwl_widget_li_classes', 'dropdown-section' ) ); ?> <?php echo ( 'manage' === $active ) ? 'current' : ''; ?>">
