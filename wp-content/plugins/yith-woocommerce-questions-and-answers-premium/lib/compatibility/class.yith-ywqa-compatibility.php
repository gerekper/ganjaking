 ...
 *
 *
 * @class      YITH_YWQA_Compatibility
 * @package    Yithemes
 * @since      Version 1.0.0
 * @author     Your Inspiration Themes
 *
 */
if ( ! class_exists( 'YITH_YWQA_Compatibility' ) ) {
    ...
    class YITH_YWQA_Compatibility
    {
        ...
        public function __construct()
        {
            ...
            require_once( YITH_YWQA_LIB_DIR . '/compatibility/class.yith-ywqa-compatibility-premium.php' );
...
YITH_YWQA_Compatibility::get_instance();