...
<div id="woocommerce-dropshipping-dashboard">
  ...
  <div class="dash-row wcd-blurb-container">
     ...
     <div class="metric-box metric-style2">
        ...
        <h2><?= $wcd_count_prod_out_stock ?></h2>
     ...
     <div class="dash-section-50 dash-stats">
        ...
        <div class="blurb">
           <div class="blurb-inner">
              ...
              <div class="blurb-content"><span><?= $wcd_ali_prod[0] ?></span></div>
           </div>
        </div>
        <div class="blurb">
           <div class="blurb-inner">
              ...
              <div class="blurb-content"><?= $wcd_orders_inprogress ?></div>
           </div>
        </div>
        <div class="blurb">
           <div class="blurb-inner">
              ...
              <div class="blurb-content"><?= $wcd_orders_completed ?></div>
           </div>
        </div>
        <div class="blurb">
           <div class="blurb-inner">
              ...
              <div class="blurb-content"><?= $wcd_count_prod_out_stock ?></div>
           </div>
        </div>
        <div class="blurb">
           <div class="blurb-inner">
              ...
              <div class="blurb-content"><?= $wcd_orders_pending ?></div>
           </div>
        </div>
        <div class="blurb">
           <div class="blurb-inner">
              ...
              <div class="blurb-content"><?= $get_completed_dropship_orders ?></div>
           </div>
        </div>
        <div class="blurb">
           <div class="blurb-inner">
              ...
              <div class="blurb-content"><?= $wcd_orders_affiliate ?></div>
           </div>
        </div>
     </div>
  </div>
