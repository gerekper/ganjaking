...
<div id="woocommerce-dropshipping-dashboard">
  ...
  <div class="dash-row">
		<h1 id="dashboard-header"><?php echo esc_html( __( 'WooCommerce Dropshipping Dashboard', 'woocommerce-dropshipping' ) ); ?></h1>

  </div>
  <div class="dash-row wcd-blurb-container">
	 <div class="metric-box metric-style1">
		<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/icons/listings.svg' ); ?>">

		<h2><?php echo esc_textarea($wcd_count_prod_listings); ?></h2>
	 ...
	 <div class="metric-box metric-style2">
		<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/icons/low-stock.svg' ); ?>">
	 ...
	 <div class="metric-box metric-style4">
		<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/icons/totaol.svg' ); ?>">
	 ...
	 <?php if ( ( $get_products_draft_count ) >= 1 ) { ?>
	  <div class="metric-box metric-style1">
		 <img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/icons/ali-draft-prods.png' ); ?>" style="    height: 65px;margin: 0 auto; padding: 10px;">
  ...
  <div class="dash-row">
	 ...
	 <div class="dash-section-50 dash-stats">
		...
		<p id="account-info-note"><?php esc_html_e( 'WooCommerce orders at a glance', 'woocoommerce-dropshipping' ); ?></p>
		<div class="blurb">
		   <div class="blurb-inner">
			  <img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/icons/aliexpress.svg' ); ?>">
  ...
  <div id="plugin-setup" class="dash-row thirds">
	 ...
	 <div class="metric-box">
		...
		<a href="<?php echo get_admin_url(); ?>admin.php?page=wc-settings&tab=wc_dropship_settings"><?php esc_html_e( 'Go to Settings', 'woocommerce-dropshipping' ); ?></a>
	 </div>
	 <div class="metric-box">
		<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/icons/affiliate.svg' ); ?>">
		...
		<a href="<?php echo get_admin_url(); ?>edit-tags.php?taxonomy=dropship_supplier&post_type=product"><?php esc_html_e( 'Manage Suppliers', 'woocommerce-dropshipping' ); ?></a>
	 </div>
  </div>
</div>
<!-- End of dashboard -->
