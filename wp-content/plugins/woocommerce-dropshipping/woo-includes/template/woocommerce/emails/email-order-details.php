	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; text-align:center;" border="1">
		<thead>
			<tr>
				...
				<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Price (excl GST)', 'woocommerce' ); ?></th>
				<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Sub Total (excl GST)', 'woocommerce' ); ?></th>
				<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'GST Amount', 'woocommerce' ); ?></th>
				<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Amount Payable (Incl GST)', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
...
<?php
		...
		<tfoot>
		   <!-- <tr>
						<th class="td" scope="row" colspan="4" style="text-align:<?php echo esc_attr( $text_align ); ?>; <?php echo ( 1 === $i ) ? 'border-top-width: 4px;' : ''; ?>">Subtotal:</th>
						<td>&nbsp;</td>
						<td class="td" align="left"><?php echo  wc_price($sub_total) ; ?></td>
					</tr>
					
					 <tr>
						<th class="td" scope="row" colspan="4" style="text-align:<?php echo esc_attr( $text_align ); ?>; <?php echo ( 1 === $i ) ? 'border-top-width: 4px;' : ''; ?>">Total GST:</th>
							<td>&nbsp;</td>
						<td class="td" align="left"><?php echo  wc_price($total_gst) ; ?></td>
					</tr>-->
			<?php
