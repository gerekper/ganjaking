		...
		function enqueue_backend_files( $hook ) {
			...
			if ( "upload" == $screen->id ) {
				...
				wp_localize_script ( 'ywgc-categories', 'ywgc_data', array(
					'loader'                => apply_filters ( 'yith_gift_cards_loader', YITH_YWGC_ASSETS_URL . '/images/loading.gif' ),
					'ajax_url'              => admin_url ( 'admin-ajax.php' ),
					'set_category_action'   => __ ( "Set gift card image category", 'yith-woocommerce-gift-cards' ),
					'unset_category_action' => __ ( "Unset gift card image category", 'yith-woocommerce-gift-cards' ),
            ...
            if ( "edit-giftcard-category" == $screen->id ) {
                ...
                wp_localize_script( 'ywgc-media-button', 'ywgc_data', array(
                        'upload_file_frame_title' => __( 'Manage the Media library', 'yith-woocommerce-gift-cards' ),
                        'upload_file_frame_button' => __( 'Done', 'yith-woocommerce-gift-cards' )
                ) );
