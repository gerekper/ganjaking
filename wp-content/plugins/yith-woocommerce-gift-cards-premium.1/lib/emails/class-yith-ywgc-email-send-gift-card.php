...
if ( ! class_exists ( "YITH_YWGC_Email_Send_Gift_Card" ) ) {
	...
	class YITH_YWGC_Email_Send_Gift_Card extends WC_Email {
		...
		public function trigger( $object, $case = '' ) {
            ...
            $this->introductory_text = apply_filters( 'yith_ywgc_email_introductory_text', $this->get_option ( 'introductory_text', __ ( 'Hi {recipient_name}, you have received this gift card from {sender}, use it on our online shop.', 'yith-woocommerce-gift-cards' ) ), $object->present_product_id, $case, $recipient_name, $sender_name ) ;
