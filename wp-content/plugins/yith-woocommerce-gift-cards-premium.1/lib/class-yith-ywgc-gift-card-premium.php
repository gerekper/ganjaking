        ...
        public function get_gift_card_error( $err_code ) {
            ...
            switch ( $err_code ) {
                ...
                case self::E_GIFT_CARD_NOT_YOURS:
                    $err = sprintf( __( 'Sorry, it seems that the gift card code "%s" is not yours and cannot be used for this order.', 'yith-woocommerce-gift-cards' ), $this->gift_card_number );
                    break;
                case self::E_GIFT_CARD_ALREADY_APPLIED:
                    $err = sprintf( __( 'The gift card code %s has already been applied!', 'yith-woocommerce-gift-cards' ), $this->gift_card_number );
                    break;
                ...
                case self::E_GIFT_CARD_INVALID_REMOVED:
                    $err = sprintf( __( 'Sorry, it seems that the gift card code %s is invalid - it has been removed from your cart.', 'yith-woocommerce-gift-cards' ), $this->gift_card_number );
                    break;
                case self::GIFT_CARD_NOT_ALLOWED_FOR_PURCHASING_GIFT_CARD:
                    $err = __( 'Gift card codes cannot be used to purchase other gift cards', 'yith-woocommerce-gift-cards' );
                    break;
        ...
        public function get_gift_card_message( $err_code ) {
            ...
            switch ( $err_code ) {
                ...
                case self::GIFT_CARD_SUCCESS:
                    $err = __( 'Gift card code successfully applied.', 'yith-woocommerce-gift-cards' );
                    break;
                case self::GIFT_CARD_REMOVED:
                    $err = __( 'Gift card code successfully removed.', 'yith-woocommerce-gift-cards' );
                    break;
