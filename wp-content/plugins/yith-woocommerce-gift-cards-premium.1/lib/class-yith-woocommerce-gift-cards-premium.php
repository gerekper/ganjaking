...
//			add_filter ( 'yith_gift_cards_before_add_to_cart', array( $this, 'customize_card_before_add_to_cart' ) );
        ...
        public function disable_gift_this_product_product_type_options( $options ) {
            ...
            $options[ 'yith_wcgc_disable_gift_this_product' ] = array(
                ...
                'label'         => __( 'Disable gift this product', 'yith-woocommerce-gift-cards' ),
                'description'   => __( 'Check this option if you want to disable the option "gift this product" on this product.', 'yith-woocommerce-product-bundles' ),
                'default'       => 'no'
            );
        ...
        public function create_gift_cards_category() {
            ...
            $labels = array(
                'name'              => __('Gift card image categories','yith-woocommerce-gift-cards'),
                'singular_name'     => __('Gift card image category','yith-woocommerce-gift-cards'),
                'search_items'      => __('Search image categories','yith-woocommerce-gift-cards'),
                'all_items'         => __('All image categories','yith-woocommerce-gift-cards'),
                'parent_item'       => __('Parent image category','yith-woocommerce-gift-cards'),
                'parent_item_colon' => __('Parent image category:','yith-woocommerce-gift-cards'),
                'edit_item'         => __('Edit image category','yith-woocommerce-gift-cards'),
                'update_item'       => __('Update gift card image category','yith-woocommerce-gift-cards'),
                'add_new_item'      => __('Add new image category','yith-woocommerce-gift-cards'),
                'new_item_name'     => __('New image category name','yith-woocommerce-gift-cards'),
                'menu_name'         => __('Gift card image category','yith-woocommerce-gift-cards')
            );
        ...
        public function register_custom_post_statuses() {
            ...
            register_post_status ( YWGC_Gift_Card_Premium::STATUS_PRE_PRINTED, array(
                    'label'                     => __ ( 'Pre-Printed', 'yith-woocommerce-gift-cards' ),
                    'public'                    => false,
                    'exclude_from_search'       => false,
                    'show_in_admin_all_list'    => false,
                    'show_in_admin_status_list' => true,
                    'post_type'                 => array( 'gift_card' ),
                    'label_count'               => _n_noop ( __ ( 'Pre-Printed', 'yith-woocommerce-gift-cards' ) . '<span class="count"> (%s)</span>', __ ( 'Pre-Printed', 'yith-woocommerce-gift-cards' ) . ' <span class="count"> (%s)</span>' ),
                )
            );
        }
        ...
        public function ywgc_gift_this_product_label() {
            ...
            $get_option_ywgc_gift_this_product_label = get_option ( 'ywgc_gift_this_product_label',  __( 'Gift this product', 'yith-woocommerce-gift-cards' ) );
                        ...
                        'fields' => apply_filters ( 'yith_ywgc_gift_card_instance_metabox_custom_fields',
                            array(
                                ...
                                '_ywgc_is_digital'                      => array(
                                    ...
                                    'desc'    => __ ( 'Check if the gift card will be sent via email. Leave it unchecked to make this work as a physical product.', 'yith-woocommerce-gift-cards' ),
                                    'type'    => 'checkbox',
                                    'private' => false,
                                    'std'     => ''
                                ),
                                '_ywgc_sender_name'                     => array(
                                    'label'   => __ ( 'Sender\'s name', 'yith-woocommerce-gift-cards' ),
                                    'desc'    => __ ( 'The name of the digital gift card sender, if any.', 'yith-woocommerce-gift-cards' ),
                                    'type'    => 'text',
                                    'private' => false,
                                    'std'     => '',
                                    'css'     => 'width: 80px;',
                                ...
                                '_ywgc_recipient'                       => array(
                                    'label'   => __ ( 'Recipient\'s email', 'yith-woocommerce-gift-cards' ),
                                    'desc'    => __ ( 'The email address of the digital gift card recipient.', 'yith-woocommerce-gift-cards' ),
                                    'type'    => 'text',
                                    'private' => false,
                                    'std'     => '',
                                    'deps'    => array(
                                ...
                                '_ywgc_recipient_name'                       => array(
                                    'label'   => __ ( 'Recipient\'s name', 'yith-woocommerce-gift-cards' ),
                                    'desc'    => __ ( 'The name of the digital gift card recipient.', 'yith-woocommerce-gift-cards' ),
                                    'type'    => 'text',
                                    'private' => false,
                                    'std'     => '',
                                    'deps'    => array(
                                ...
                                '_ywgc_expiration'                   => array(
                                    'label'   => __ ( 'Expiration date', 'yith-woocommerce-gift-cards' ),
                                    'desc'    => __ ( 'The date when the digital gift card will expire.', 'yith-woocommerce-gift-cards' ),
                                    'type'    => 'text',
                                    'private' => false,
                                    'std'     => '',
                                ),
                                ...
                                '_ywgc_internal_notes' =>array(
                                    ...
                                    'desc'    => __ ( 'Enter your notes here. This will only be visible to the admin.', 'yith-woocommerce-gift-cards' ),
                                    'type'    => 'textarea',
                                    'private' => false,
                                    'std'     => '',
                                ),
        ...
        public function init_post_type() {
            $args = array(
                'labels'        => array(
                    ...
                    'add_new_item'       => __ ( 'Create Gift Card Code', 'yith-woocommerce-gift-cards' ),
        ...
        public function check_gift_card( $gift, $remove = false ) {
            ...
            if ( ! $remove ){
                ...
                if ( WC()->cart->total < $ywgc_minimal_car_total ) {
                    wc_add_notice( __( 'In order to use the gift card, the minimum total amount in the cart has to be ' . $ywgc_minimal_car_total . get_woocommerce_currency_symbol(), 'yith-woocommerce-gift-cards'), 'error' );
            ...
            foreach ( $items as $cart_item_key => $values ) {
                ...
                if ( apply_filters('yith_ywgc_check_subscription_product_on_cart',true) && class_exists('WC_Subscriptions_Product') && WC_Subscriptions_Product::is_subscription( $product ) ) {
                    wc_add_notice( __( 'It is not possible to add any gift card if the cart contains a subscription-based product', 'yith-woocommerce-gift-cards'), 'error' );
            ...
            foreach( WC()->cart->get_coupons() as $coupon ){
                ...
                if ( $gift_code ==  $coupon_code ) {
                    wc_add_notice( __( 'This code is already applied', 'yith-woocommerce-gift-cards'), 'error' );
        ...
        public function set_expiration_date_for_gift_card_created_manually( $post_id, $post, $update ){
            ...
            if( $post->post_type == 'gift_card' ){
                ...
                $delivery_date = isset($_POST['yit_metaboxes']) && isset( $_POST['yit_metaboxes']['_ywgc_delivery_date_formatted'] ) ? $_POST['yit_metaboxes']['_ywgc_delivery_date_formatted'] : time(); // date format

                $delivery_date_timestamp = is_string($delivery_date) ? strtotime(str_replace('/', '-', $delivery_date)) : $delivery_date; //timestamp
                ...
                $expiration_date_timestamp = is_string($expiration_date) ? strtotime(str_replace('/', '-', $expiration_date)) : $expiration_date;
