...
if ( ! class_exists( 'YWGC_Plugin_FW_Loader' ) ) {
    ...
    class YWGC_Plugin_FW_Loader {
        ...
        public function register_panel() {
            ...
            $admin_tabs['gift-cards'] = __( 'Dashboard', 'yith-woocommerce-gift-cards' );
            $admin_tabs['general']  = __( 'General', 'yith-woocommerce-gift-cards' );
            $admin_tabs['design'] = __( 'Style', 'yith-woocommerce-gift-cards' );
            $admin_tabs['gift-cards-category'] = __( 'Image categories', 'yith-woocommerce-gift-cards' );
            $admin_tabs['gift_this_product'] = __( 'Gift this product', 'yith-woocommerce-gift-cards' );
            $admin_tabs['recipient_delivery'] = __( 'Recipient & delivery', 'yith-woocommerce-gift-cards' );
            $admin_tabs['cart_checkout'] = __( 'Cart & checkout', 'yith-woocommerce-gift-cards' );
//            $admin_tabs['gift-cards-products'] = __( 'Products', 'yith-woocommerce-gift-cards' );
