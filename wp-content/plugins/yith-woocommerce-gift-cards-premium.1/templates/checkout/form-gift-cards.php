...
if ( $direct_display != 'yes' ):
    ...
    <div class="ywgc_have_code">
        ...
        wc_print_notice( $icon . get_option( 'ywgc_text_before_gc_form' , __( 'Got a gift card from a loved one?', 'yith-woocommerce-gift-cards' ) ) . ' <a href="#" class="ywgc-show-giftcard">' . get_option( 'ywgc_link_text_before_gc_form' ,  __( 'Use it here!', 'yith-woocommerce-gift-cards' ) ) . '</a>', 'notice' );
        ?>
...
<div class="ywgc_enter_code" method="post" style="<?php echo ( $direct_display != 'yes' ? 'display:none' : '' ); ?>">
    ...
    <div style="position: relative">
        ...
        <p><?php echo get_option( 'ywgc_text_in_the_form' , __( 'Apply the gift card code in the following field', 'yith-woocommerce-gift-cards' ) ); ?></p>
        ...
        <p class="form-row form-row-last">
            ...
            <button type="submit" class="button ywgc_apply_gift_card_button" name="ywgc_apply_gift_card" value="<?php echo get_option( 'ywgc_apply_gift_card_button_text' , __( 'Apply Gift Card', 'yith-woocommerce-gift-cards' ) ); ?>"><?php echo get_option( 'ywgc_apply_gift_card_button_text' , __( 'Apply Gift Card', 'yith-woocommerce-gift-cards' ) ); ?></button>
