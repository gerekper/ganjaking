...
<div class="ywgc-main-form-preview-container">
        ...
        <div class="ywgc-form-preview-from-to-container">
            ...
            <?php if ( 'yes' == get_option('ywgc_ask_sender_name' , 'yes' ) ) : ?>
                <span class="ywgc-form-preview-from"><?php echo __( 'From: ', 'yith-woocommerce-gift-cards' ); ?></span>
                <span class="ywgc-form-preview-from-content"></span>
            <?php endif; ?>
            <br>
            <span class="ywgc-form-preview-to"><?php echo __( 'To: ', 'yith-woocommerce-gift-cards' ); ?></span>
