...
if ( $allow_templates == 'yes' || $allow_customer_images == 'yes' ) : ?>
    ...
    <h3><?php echo get_option( 'ywgc_choose_design_title' , __( "Choose your image", 'yith-woocommerce-gift-cards') ); ?></h3>
    ...
    <div class="gift-card-content-editor step-appearance">
                                ...
                                <div class="ywgc-preset-image-view-all">
                                    <div class="ywgc-preset-image" data-design-id="<?php echo $item_id; ?>"  data-design-url="<?php echo yith_get_attachment_image_url( intval( $item_id ), 'full' ); ?>" >
                                        ...
                                        <input type="button"
                                               ...
                                               value="<?php echo get_option( 'ywgc_template_design_view_all_button' , __( "VIEW ALL", 'yith-woocommerce-gift-cards') ); ?>" />
                                    </div>
                                </div>
        ...
        <?php if ( $allow_customer_images == 'yes' ) : ?>
            ...
            <p class="ywgc-custom-design-link"> <?php echo  __( "Or ", 'yith-woocommerce-gift-cards' ); ?> <a href="#" title="<?php echo __( "Suggested size (px): ", 'yith-woocommerce-gift-cards' ) . get_option( 'ywgc_custom_design_suggested_size' , '180x330' ); ?>"  class="ywgc-choose-image ywgc-custom-picture"><?php echo  __( "Upload your image >", 'yith-woocommerce-gift-cards' ); ?></a></p>
