...
$gift_this_product_options = array(
	...
	'gift_this_product' => array(
        ...
        'ywgc_permit_its_a_present'   => array(
            'name'    => __( "Enable the ‘Gift this product” option on product pages", 'yith-woocommerce-gift-cards' ),
            'type'    => 'yith-field',
            'yith-type' => 'onoff',
            'id'      => 'ywgc_permit_its_a_present',
            'desc'    => __( 'Enable to allow users to buy a gift card of the same amount of the product. This feature appears on the product page. The product will be recommended in the recipient email that includes the gift card code.', 'yith-woocommerce-gift-cards' ),
            'default' => 'no',
        ),
...
//            'name'    => __( 'Enable "Gift this product" button in shop page', 'yith-woocommerce-gift-cards' ),
//            'type'    => 'yith-field',
//            'yith-type' => 'onoff',
...
//            'name'    => __( 'Position of "Gift this product" button', 'yith-woocommerce-gift-cards' ),
//            'type'    => 'yith-field',
//            'yith-type' => 'select',
...
//            'name'    => __( 'Copy this shortcode', 'yith-woocommerce-gift-cards' ),
//            'type'    => 'yith-field',
//            'yith-type' => 'text',
...
//        ),
        ...
        'ywgc_gift_this_product_label'           => array(
            ...
            'name'    => __( 'Enter a custom text', 'yith-woocommerce-gift-cards' ),
            'type'    => 'yith-field',
            'yith-type' => 'text',
