;(function ($) {
    ...
    $(document).on('yith_ywgc_popup_template_loaded', function ( popup, item ) {
        ...
        $(item).on('click', '.ywgc-custom-picture-modal', function (e) {
            e.preventDefault();
            $('#ywgc-upload-picture-modal').click();
        });

        $('#ywgc-upload-picture-modal').on('change', function () {
            ...
            var preview_image = function (file) {
                ...
                oFReader.onload = function (oFREvent) {
                    ...
                    $('.ywgc-custom-design-modal-preview-container').html(html_content);
                    $('.ywgc-custom-design-link').hide();
                    $('.ywgc-custom-image-modal-submit-link').show();
                    $('.ywgc-custom-design-modal-preview-close').show();
                }
            };
        ...
        $(item).on('click', '.ywgc-custom-image-modal-submit-link', function (e) {
            ...
            var image_base64 = $(this).parent().find( '.ywgc-custom-design-modal-preview-container img').attr('src');
        ...
        $(item).on('click', '.ywgc-custom-design-modal-preview-close', function (e) {
            e.preventDefault();

            $('.ywgc-custom-design-link').show();
            $('.ywgc-custom-image-modal-submit-link').hide();
            $('.ywgc-custom-design-modal-preview-container').html('');
            $(this).hide();
