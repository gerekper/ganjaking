	...
	<tr>
		<td style='<?php echo $__sty_td;?>'>
			<div style="padding:45px 20px; font-family:'open sans',Helvetica;<?php echo $__sty_wb;?>">
				...
				<?php echo $__item_p_beg;?><?php echo EVORS()->lang('evoRSLX_002', 'Primary Contact on RSVP', $lang)?>:</span> <?php echo ($RSVP->last_name()? $RSVP->last_name():'').' '.($RSVP->first_name()? $RSVP->first_name():'');?></p>
