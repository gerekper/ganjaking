...
class Pins {
	...
	public function init() {
		...
		add_filter( 'set-screen-option', array( $this, 'sanitizePerPageOption' ), 10, 3 );
		add_filter( 'set_screen_option_' . self::PINS_PER_PAGE_USER_META_KEY, array(
			$this,
			'savePerPageOption'
		), 10, 3 );
	}
	 ...
	 * @return bool
	 */
	public function sanitizePerPageOption( $keep, $option, $value ) {
