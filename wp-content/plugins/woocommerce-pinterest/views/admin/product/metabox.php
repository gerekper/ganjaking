	...
	<div class="panel-wrap">
		...
		<ul class="wc-tabs">
			...
			<li class="woocommerce-pinterest-product-tabs product_description">
				<a href="#woocommerce_pinterest_product_description">
					<span> <?php esc_html_e('Description', 'woocommerce-pinterest'); ?></span>
				</a>
			</li>
		...
		<div id="woocommerce_pinterest_product_description"
			...
			<div>
				...
				<?php $fileManager->includeTemplate('admin/woocommerce/pin-description-variables.php', array('variables' => $pinDescriptionVariables)); ?>
			</div>
		</div>
	</div>
</div>
