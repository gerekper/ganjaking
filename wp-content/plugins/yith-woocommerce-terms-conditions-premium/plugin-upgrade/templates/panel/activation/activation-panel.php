...
<div class="yit-container product-licence-activation yith-plugin-ui">
    ...
    <div class="to-active-wrapper">
        ...
        <span id="yith-no-license-to-enabled-message" class="<?php echo empty( $to_active_products ) ? 'visible' : 'hide'; ?>">
            <?php echo esc_html_x( "Your licenses are active.", 'License section message', 'yith-plugin-upgrade-fw' );  ?>
        </span>
        <div id="yith-license-from-wrapper" class="<?php echo empty( $to_active_products ) ? 'hide' : 'visible'; ?>">
            ...
            <form
                    ...
                    class="to-active-form <?php echo empty( $to_active_products ) ? 'visible' : 'hide'; ?>"
                    method="post"
                ...
                <div class="to-active-table">
                    <p class="yith-license-form-row product-name yith-products-list-wrapper">
                        <label for="yith-products-list" class="yith-select-plugin">
					        <?php echo esc_html_x( 'Choose the plugin', 'Form Label', 'yith-plugin-upgrade-fw' ); ?>
                        </label>
                        <select autocomplete="off" id="yith-products-list" name="product_name"
                    ...
                    <p class="yith-license-form-row yith-account-email-wrapper">
                        <label for="yith-account-email" class="yith-email">
					        <?php
					        $new_email_url = sprintf( '%s: (<a href="%s" target="_blank" rel="nofollow noopener">%s</a>)',
    ...
    <div id="activated-product-wrapper">
        ...
        <span id="no-license-enabled-message" class="<?php echo empty( $activated_products ) && empty( $expired_products ) && empty( $banned_products ) ? 'visible' : 'hide'; ?>">
            <?php echo esc_html_x( "No licenses have been activated.", 'License section message', 'yith-plugin-upgrade-fw' ); ?>
        </span>
        <div id="licence-check-section-wrapper" class="<?php echo ! empty( $activated_products ) || ! empty( $expired_products ) || ! empty( $banned_products ) ? 'visible' : 'hide'; ?>">
