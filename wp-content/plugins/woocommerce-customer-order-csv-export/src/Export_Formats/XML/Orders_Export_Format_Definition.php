...
/**
 * XML Orders Export Format Definition class
 *
 * @since 5.0.0
 */
class Orders_Export_Format_Definition extends XML_Export_Format_Definition {


	/**
	 * Initializes the XML orders export format definition.
	 *
	 * @since 5.0.0
	 *
	 * @param array $args {
