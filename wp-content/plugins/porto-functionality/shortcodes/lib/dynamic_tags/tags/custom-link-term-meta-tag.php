<?php
/**
 * Porto Dynamic Term Meta Link Tags class
 *
 * @author     P-THEMES
 * @version    2.3.0
 */
...
class Porto_El_Custom_Link_Term_Meta_Tag extends Elementor\Core\DynamicTags\Tag {

	public function get_name() {
		return 'porto-custom-link-term-meta';
	}

	public function get_title() {
		return esc_html__( 'Term Meta Link', 'porto-functionality' );
	}
	...
	protected function register_controls() {
		 ...
		 * Add Term Meta link
		 */
		do_action( 'porto_dynamic_el_extra_fields', $this, 'link', 'term-meta' );
