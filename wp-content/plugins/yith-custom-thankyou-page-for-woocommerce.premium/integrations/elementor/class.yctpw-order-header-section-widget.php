...
class YCTPW_Order_Header_Section_Elementor_widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'yith-order-header-section';
	}
	...
	public function get_title() {
		return esc_html__( 'YITH Custom ThankYou Page Order Header Section', 'yith-custom-thankyou-page-for-woocommerce' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'YITH Custom ThankYou Page Order Header Section', 'yith-custom-thankyou-page-for-woocommerce' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'raw'             => sprintf(
					...
					esc_html__( 'This widget will work only on the Custom Thank You page, here you can only see a preview. Moreover to use this element in the position you\'ve chosen, you have to disable the related section ', 'yith-custom-thankyou-page-for-woocommerce' ),
	...
	protected function render() {
		...
		if ( isset($_GET['ctpw']) && isset($_GET['order-received']) ) {//phpcs:ignore
			...
			echo $yctpw_f->yith_ctpw_header_shortcode(); //phpcs:ignore XSS.
		} else {
