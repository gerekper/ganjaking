...
if ( ! class_exists( 'WC_Catalog_Visibility_Compatibility' ) ) :
	...
	class WC_Catalog_Visibility_Compatibility {
		...
		public static function use_wp_term_meta_table() {

			$has_term_meta = get_option( 'db_version' ) > 34370;

			return version_compare( self::get_wc_version(), '2.6.0', 'ge' ) && $has_term_meta;
