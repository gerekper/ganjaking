<div class="send-type-customer send-type-div">
	<select id="recipients" name="recipients[]" class="email-search-select" multiple data-nonce="<?php echo esc_attr( wp_create_nonce( 'search_for_email' ) ); ?>" data-placeholder="<?php esc_attr_e( 'Search by customer name or email&hellip;', 'follow_up_emails' ); ?>" style="width: 100%;"></select>
</div>
