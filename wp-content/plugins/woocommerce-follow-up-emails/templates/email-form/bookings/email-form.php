<div class="options_group wc-bookings-selector">
	<p class="form-field">
		...
		<select name="meta[storewide_type]" id="storewide_type" class="">
			<option value="all" <?php selected( $storewide_type, 'all' ); ?>><?php esc_html_e('All products', 'follow_up_emails'); ?></option>
			<option value="products" <?php selected( $storewide_type, 'products' ); ?>><?php esc_html_e('A specific product', 'follow_up_emails'); ?></option>
