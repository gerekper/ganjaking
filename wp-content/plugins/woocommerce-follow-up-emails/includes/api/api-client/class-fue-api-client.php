...
class FUE_API_Client {
	...
	public function get_lists() {
		return $this->_make_api_call( 'newsletter/lists' );
	}
	...
	public function get_subscribers() {
		return $this->_make_api_call( 'newsletter/subscribers' );
	}
	...
	public function create_subscriber( $data ) {
		return $this->_make_api_call( 'newsletter/subscribers', $data, 'POST' );
	}
