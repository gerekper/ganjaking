<div class="wrap">
    <div class="factory-bootstrap-441 factory-fontawesome-000">
        ...
        <div id="wis-license-wrapper"
            ...
            <div class="factory-bootstrap-441 onp-page-wrap <?php echo $this->get_license_type() ?>-license-manager-content"
                 id="license-manager">
                <div>
