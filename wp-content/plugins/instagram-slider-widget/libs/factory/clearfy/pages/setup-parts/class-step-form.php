...
class Step_Form extends Step {
	...
	public function __construct(\WBCR\FactoryClearfy228\Pages\Setup $page)
	{
	...
	protected function render_form(\Wbcr_FactoryForms434_Form $form)
	{
		?>
		<form method="post" id="w-factory-clearfy-228__setup-form-<?php echo $this->get_id() ?>" class="w-factory-clearfy-228__setup-form form-horizontal">
			<?php $form->html(); ?>
			<div class="w-factory-clearfy-228__form-buttons">
				...
				<input type="submit" name="continue_button_<?php echo $this->get_id() ?>" class="button-primary button button-large w-factory-clearfy-228__continue-button" value="<?php _e('Continue', 'wbcr_factory_clearfy_228') ?>">
			</div>
		</form>
		<?php
	}

	protected function set_form_handler(\Wbcr_FactoryForms434_Form $form)
	{
	...
	public function html()
	{
		...
		<div id="WBCR" class="wrap">
			<div class="wbcr-factory-pages-436-impressive-page-template factory-bootstrap-437 factory-fontawesome-000">
				<div class="w-factory-clearfy-228-setup__inner-wrap">
