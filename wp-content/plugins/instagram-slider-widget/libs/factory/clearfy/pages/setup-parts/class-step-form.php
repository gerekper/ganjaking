...
class Step_Form extends Step {
	...
	protected function render_form(\Wbcr_FactoryForms438_Form $form)
	{
		?>
		<form method="post" id="w-factory-clearfy-232__setup-form-<?php echo $this->get_id() ?>" class="w-factory-clearfy-232__setup-form form-horizontal">
			<?php $form->html(); ?>
			<div class="w-factory-clearfy-232__form-buttons">
				<!--<input type="submit" name="skip_button_<?php /*echo $this->get_id() */ ?>" class="button-primary button button-large w-factory-clearfy-232__skip-button" value="<?php /*_e('Skip', 'wbcr_factory_clearfy_232') */ ?>">-->
				<input type="submit" name="continue_button_<?php echo $this->get_id() ?>" class="button-primary button button-large w-factory-clearfy-232__continue-button" value="<?php _e('Continue', 'wbcr_factory_clearfy_232') ?>">
			</div>
		</form>
		<?php
	}

	protected function set_form_handler(\Wbcr_FactoryForms438_Form $form)
	{
