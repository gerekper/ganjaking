<?php
	...
	if( !class_exists('Wbcr_FactoryForms433_WpEditorControl') ) {

		class Wbcr_FactoryForms433_WpEditorControl extends Wbcr_FactoryForms433_Control {
			...
			protected function beforeHtml()
			{
				...
				if( !isset($this->options['tinymce']['content_css']) ) {
					$this->options['tinymce']['content_css'] = FACTORY_FORMS_433_URL . '/assets/css/editor.css';
				}
			}
