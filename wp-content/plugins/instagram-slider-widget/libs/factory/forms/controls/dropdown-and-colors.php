<?php
	 ...
	 *  // see FactoryForms421_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms421_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms421_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms421_DropdownAndColorsControl extends Wbcr_FactoryForms421_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms421_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms421_RadioColorsControl($options['colors'], $form, $provider);
