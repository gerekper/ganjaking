<?php
	 ...
	 *  // see FactoryForms438_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms438_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms438_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms438_DropdownAndColorsControl extends Wbcr_FactoryForms438_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms438_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms438_RadioColorsControl($options['colors'], $form, $provider);
