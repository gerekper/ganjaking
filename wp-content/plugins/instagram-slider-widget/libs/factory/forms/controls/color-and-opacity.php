<?php
	...
	if( !class_exists('Wbcr_FactoryForms421_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms421_ColorAndOpacityControl extends Wbcr_FactoryForms421_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms421_IntegerControl($options['opacity'], $form, $provider);
