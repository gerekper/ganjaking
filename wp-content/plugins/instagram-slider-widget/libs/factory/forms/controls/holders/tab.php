<?php
	...
	if( !class_exists('Wbcr_FactoryForms438_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms438_TabHolder extends Wbcr_FactoryForms438_Holder {
			 ...
			 * @param FactoryForms438_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms438_HtmlAttributeBuilder();
