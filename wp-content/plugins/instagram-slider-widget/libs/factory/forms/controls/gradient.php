<?php
	...
	if( !class_exists('Wbcr_FactoryForms438_GradientControl') ) {
		class Wbcr_FactoryForms438_GradientControl extends Wbcr_FactoryForms438_Control {
			...
			public function html()
			{
				...
				<script>
					...
					factory.res.resVertical = '<?php _e( 'vertical', 'wbcr_factory_forms_438' ) ?>';
					factory.res.resHorizontal = '<?php _e( 'horizontal', 'wbcr_factory_forms_438' ) ?>';
				</script>
				<div <?php $this->attrs() ?>>
