<?php
	...
	if( !class_exists('Wbcr_FactoryForms438_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms438_Bootstrap3FormLayout extends Wbcr_FactoryForms438_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms438_Control $control
			 */
