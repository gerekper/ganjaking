<?php
	...
	if( !class_exists('Wbcr_FactoryForms421_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms421_Bootstrap3FormLayout extends Wbcr_FactoryForms421_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms421_Control $control
			 */
