<?php
	...
	if( !class_exists('Wbcr_FactoryForms438_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms438_Control extends Wbcr_FactoryForms438_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms438_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms438_ValueProvider $provider
			 * @return void
			 */
