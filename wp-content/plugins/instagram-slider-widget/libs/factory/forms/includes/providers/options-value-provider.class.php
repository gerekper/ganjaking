<?php
	...
	if( !class_exists('Wbcr_FactoryForms421_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms421_OptionsValueProvider implements Wbcr_IFactoryForms421_ValueProvider {
