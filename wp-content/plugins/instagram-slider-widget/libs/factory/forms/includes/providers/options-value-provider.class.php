<?php
	...
	if( !class_exists('Wbcr_FactoryForms438_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms438_OptionsValueProvider implements Wbcr_IFactoryForms438_ValueProvider {
