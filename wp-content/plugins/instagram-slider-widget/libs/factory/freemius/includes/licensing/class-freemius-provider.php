...
namespace WBCR\Factory_Freemius_123\Premium;

use WBCR\Factory_Freemius_123\Entities\License;
use WBCR\Factory_Freemius_123\Entities\Plugin;
use WBCR\Factory_Freemius_123\Entities\Site;
use WBCR\Factory_Freemius_123\Entities\User;
use WBCR\Factory_436\Premium\Provider as License_Provider;
use Wbcr_Factory436_Plugin;
use WBCR\Factory_Freemius_123\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_123\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct(Wbcr_Factory436_Plugin $plugin, array $settings)
	{
	...
	/**
	 * @return \WBCR\Factory_Freemius_123\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_123\Api
	 * @throws Exception
	 */
