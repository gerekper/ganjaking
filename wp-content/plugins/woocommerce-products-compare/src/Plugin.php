...
namespace Themesquad\WC_Products_Compare;

defined( 'ABSPATH' ) || exit;

use Themesquad\WC_Products_Compare\Admin\Admin;
use Themesquad\WC_Products_Compare\Internal\Traits\Singleton;
...
class Plugin {
	...
	private function define_constants() {
		$this->define( 'WC_PRODUCTS_COMPARE_VERSION', '1.2.0' );
