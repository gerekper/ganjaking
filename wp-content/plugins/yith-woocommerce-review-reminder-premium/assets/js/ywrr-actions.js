	...
	function ( $ ) {
		...
		$( 'body' )
			...
			.on(
				...
				'.ywrr-send-box',
				function () {
					$( this ).find( 'a.ywrr-schedule-actions' ).trigger( 'click' );
					return false;
				}
			);
