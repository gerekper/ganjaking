...
if ( ! class_exists( 'YITH_Custom_Table' ) ) {
	...
	class YITH_Custom_Table extends WP_List_Table {
		...
		public function prepare_items() {
			...
			$orderby   = ( isset( $_GET['orderby'] ) && in_array( $_GET['orderby'], array_keys( $this->get_sortable_columns() ), true ) ) ? $_GET['orderby'] : $this->options['select_order'];
			$order_dir = ( '' !== $this->options['select_order_dir'] ) ? $this->options['select_order_dir'] : 'asc';
			$order     = ( isset( $_GET['order'] ) && in_array( $_GET['order'], array( 'asc', 'desc' ), true ) ) ? $_GET['order'] : $order_dir;
