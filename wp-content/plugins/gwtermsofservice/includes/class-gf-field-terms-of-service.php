...
class GF_Field_Terms_Of_Service extends GF_Field_Checkbox {
	...
	public function get_style_block( $form, $entry, $value ) {
		...
		$style_block = '';
		$disable_css = gf_apply_filters( 'gptos_disable_css', $form['id'], false, $this, $form['id'], $entry['id'], $value );
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		if( $this->is_entry_detail() ) {
			...
			if( ! $this->is_html_enabled( $this ) ) {
				...
				$disable_auto_formatting = gf_apply_filters( 'gptos_disable_auto_formatting', array( $form['id'], sprintf( "%s_%s", $form['id'], $this->id ) ), false, $this, $form['id'], $entry['id'], $value );
				...
				$terms .= $this->get_style_block( $form, $entry, $value );;
