...
//	    error_log( '_awsAccessKeyID = ' . $this->_awsAccessKeyId );
//	    error_log( '_awsSecretAccessKey = ' . $this->_awsSecretAccessKey );
//	    error_log( 'MWS Auth Token = ' . NS_MWS_AUTH_TOKEN );
//	    error_log( "PARAMETERS: \n" . print_r ( $parameters, true ));
    ...
    private function _signParametersAPI($parameters)
    {
        ...
        $parameters['SignRequestType'] = 'inventory_service';
	    ...
	    if ( ! empty( $response ) && ! is_wp_error( $response ) &&
            ...
            $this->debug_log('Sign Parameters Inventory Service API START LOG: ');
            ...
            $this->debug_log('Sign Parameters Inventory Service API END LOG.');
    ...
    private function _signParameters(array $parameters, $key) {
	    ...
	    $this->debug_log( 'Sign Parameters Inventory Service LIB START LOG: ' );
	    $this->debug_log( "PARAMETERS: \n" . print_r ( $parameters, true ));
	    $this->debug_log("String to sign: \n\t" . str_replace( '&', "\n\t\t&",
			    str_replace("\n", "\n\t", $stringToSign)));
	    $this->debug_log('Signature: ' . $this->_sign($stringToSign, $key, $algorithm));
	    $this->debug_log( 'Sign Parameters Inventory Service LIB END LOG.' );
