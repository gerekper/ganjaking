jQuery(document).ready(function($){
    ...
    var add_receiver = $('#yith_add_receivers'),
        list_receiver = $('#yith_receiver_list'),
   ...
   $(document).on('click','#yith_add_receivers', function(e){
    ...
    if( yith_padp_param.is_customize_active ){

        var table = $('#yith_paypal_adaptive_payments_panel_receiver-endpoint-settings .yit-admin-panel-content-wrap');
