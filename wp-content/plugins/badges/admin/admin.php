...
class userpro_dg_admin {
	...
	function admin_page() {
        if ( current_user_can('manage_options') ) {
            if ( isset( $_POST['find-user-badges'] ) && wp_verify_nonce( $_POST['user_pro_nonce'], 'user_pro_nonce' ) ) {
                $this->find_badges();
            }

            if ( isset( $_POST['insert-badge'] ) && wp_verify_nonce( $_POST['user_pro_nonce'], 'user_pro_nonce' ) ) {
                $this->install_badge();
            }
