...
class WC_Product_Reviews_Pro_Contribution_Factory {
	...
	public function __construct() {
		...
		require_once( $plugin_path . '/src/class-wc-product-reviews-pro-contribution-type.php' );
		// contribution flag object
		require_once( $plugin_path . '/src/class-wc-product-reviews-pro-contribution-flag.php' );
		// contribution types objects
		require_once( $plugin_path . '/src/contributions/abstract-wc-contribution.php' );
		require_once( $plugin_path . '/src/contributions/class-wc-contribution-review.php' );
		require_once( $plugin_path . '/src/contributions/class-wc-contribution-question.php' );
		require_once( $plugin_path . '/src/contributions/class-wc-contribution-video.php' );
		require_once( $plugin_path . '/src/contributions/class-wc-contribution-photo.php' );
		require_once( $plugin_path . '/src/contributions/class-wc-contribution-comment.php' );
