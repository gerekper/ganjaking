...
class WC_Product_Reviews_Pro_Admin {
	...
	public function __construct() {
		...
		$this->reviews = wc_product_reviews_pro()->load_class( '/src/admin/class-wc-reviews.php', 'WC_Reviews' );
	...
	public static function get_most_reviews_admin_report() {
		...
		require_once( wc_product_reviews_pro()->get_plugin_path() . '/src/admin/class-wc-product-reviews-pro-admin-report-most-reviews.php' );
	...
	public static function get_highest_rating_admin_report() {
		...
		require_once( wc_product_reviews_pro()->get_plugin_path() . '/src/admin/class-wc-product-reviews-pro-admin-report-highest-rating.php' );
	...
	public static function get_lowest_rating_admin_report() {
		...
		require_once( wc_product_reviews_pro()->get_plugin_path() . '/src/admin/class-wc-product-reviews-pro-admin-report-lowest-rating.php' );
