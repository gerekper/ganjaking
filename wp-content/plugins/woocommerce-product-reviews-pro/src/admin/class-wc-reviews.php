...
class WC_Reviews {
	...
	public function add_menu_items() {
		...
		$this->maybe_remove_core_reviews_menu_item();
	}


	/**
	 * Removes the WooCommerce Products > Reviews menu item introduced in WooCommerce 6.7.
	 *
	 * This avoids a duplicate Reviews menu item in the WordPress admin menu.
	 *
	 * @since 1.17.5
	 */
	private function maybe_remove_core_reviews_menu_item() {

		if ( Framework\SV_WC_Plugin_Compatibility::is_wc_version_lt( '6.7' ) ) {
			return;
		}
