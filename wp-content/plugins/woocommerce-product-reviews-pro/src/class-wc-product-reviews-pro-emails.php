...
class WC_Product_Reviews_Pro_Emails {
	...
	private function get_classes() {
		...
		return array(
			'WC_Product_Reviews_Pro_Emails_New_Comment'                => '/src/emails/class-wc-product-reviews-pro-emails-new-comment.php',
			'WC_Product_Reviews_Pro_Emails_Review_Update_Confirmation' => '/src/emails/class-wc-product-reviews-pro-emails-review-update-confirmation.php',
			'WC_Product_Reviews_Pro_Emails_Flagged_Contribution'       => '/src/emails/class-wc-product-reviews-pro-emails-flagged-contribution.php',
		);
	}
