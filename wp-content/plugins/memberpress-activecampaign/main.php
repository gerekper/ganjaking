<?php
/*
Plugin Name: MemberPress Active Campaign - Lists Version
Plugin URI: http://www.memberpress.com/
Description: Active Campaign Autoresponder lists-based integration for MemberPress.
Version: 1.1.0
...
if(is_plugin_active('memberpress/memberpress.php')) {
  ...
  new MeprAddonUpdates(
    ...
    __('MemberPress Active Campaign - Lists Version', 'memberpress-activecampaign'),
    __('Active Campaign Autoresponder Lists-based Integration for MemberPress.', 'memberpress-activecampaign')
  );
}
