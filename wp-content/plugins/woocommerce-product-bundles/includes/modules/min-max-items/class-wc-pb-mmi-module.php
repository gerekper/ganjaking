...
class WC_PB_MMI_Module extends WCS_PB_Abstract_Module {
	...
	public function load_core() {
		...
		// Admin.
		if ( is_admin() ) {
			require_once( 'includes/admin/class-wc-pb-mmi-admin.php' );
		}

		// Product-related functions and hooks.
		require_once( 'includes/class-wc-pb-mmi-product.php' );
	}
	...
	public function load_cart() {
		...
		require_once( 'includes/class-wc-pb-mmi-cart.php' );
	}
	...
	public function load_display() {
		...
		require_once( 'includes/class-wc-pb-mmi-display.php' );
	}
}
