...
?><h4 class="bundled_product_title product_title"><?php
		...
		$link  = $permalink ? apply_filters( 'woocommerce_bundled_item_link_html', ' <span class="bundled_product_title_link"><a class="bundled_product_permalink" href="' . esc_url( $permalink ) . '" target="_blank" aria-label="' . esc_attr__( 'View product', 'woocommerce-product-bundles' ) . '"></a></span>', $bundled_item, $bundle ) : '';
