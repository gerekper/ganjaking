        ...
        function premiumParallaxHandler($scope) {
            ...
            function generateSettings(target) {
                ...
                if ("multi" !== settings.type && "automove" !== settings.type) {
                    ...
                    settings.position = parallaxSettings["position"];
                    settings.positiont = parallaxSettings["positiont"];
                    settings.positionm = parallaxSettings["positionm"];
            ...
            function generateJarallax() {
                ...
                if (elementType === 'column') {
                    target = target.find('.elementor-column-wrap').first();
                }
