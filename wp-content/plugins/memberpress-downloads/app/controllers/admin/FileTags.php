...
class FileTags extends lib\BaseCtaxCtrl {
  ...
  */
  public function register_taxonomy() {
    $this->ctax = array(
      'label' => __('File Tags', 'memberpress-downloads'),
      'labels' => array(
        'name' => __('File Tags', 'memberpress-downloads'),
        'singular_name' => __('File Tag', 'memberpress-downloads'),
      ),
      'public' => true,
      'hierarchical' => false,
      'show_ui' => true,
    ...
    register_taxonomy(models\File::$file_tag_ctax, $this->cpts, $this->ctax);
  }
  ...
  */
  public function add_sub_menu() {
    $file_tag_ctax = models\File::$file_tag_ctax;
    add_submenu_page(
      base\PLUGIN_NAME,
      __('File Tags', 'memberpress-downloads'),
      __('Tags', 'memberpress-downloads'),
      'manage_options',
      "edit-tags.php?taxonomy={$file_tag_ctax}&post_type={$this->cpts}",
      false
    );
  }
  ...
  */
  public function parent_menu_expand($parent_file) {
    ...
    if($current_screen->taxonomy === models\File::$file_tag_ctax) {
  ...
  */
  public function submenu_highlight($submenu_file) {
    ...
    if($current_screen->taxonomy === $file_tag_ctax) {
      $submenu_file = "edit-tags.php?taxonomy={$file_tag_ctax}&post_type={$this->cpts}";
    }
