...
<p><b>Note</b>: It can also be helpful to check our
    <a href="http://www.activecampaign.com/api/overview.php">API documentation</a> for the HTTP method that should be used for a particular endpoint as it can affect the format of your request.
</p>
<p>Example:
<pre>list_field_view</pre> GET</p>
<pre>
...
<p>Example:
<pre>list_field_edit</pre> POST</p>
<pre>
