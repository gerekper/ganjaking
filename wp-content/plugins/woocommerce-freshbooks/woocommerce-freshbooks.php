 ...
 *
 * Woo: 18660:157b35835ab64abe650e5fb17af4c631
...
/**
 * WooCommerce FreshBooks Loader.
 *
 * @since 3.12.0
 */
class WC_FreshBooks_Loader {
	...
	const PLUGIN_NAME = 'WooCommerce FreshBooks';


	/** @var \WC_FreshBooks_Loader single instance of this class */
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot clone instances of %s.', get_class( $this ) ), '3.12.0' );
	}
	...
	public function __wakeup() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot unserialize instances of %s.', get_class( $this ) ), '3.12.0' );
	}
	...
	public function init_plugin() {
		...
		if ( $this->plugins_compatible() ) {
			...
			require_once( plugin_dir_path( __FILE__ ) . 'class-wc-freshbooks.php' );
