...
/**
 * WooCommerce API Manager Queue Interface
 *
 ...
 * @package     WooCommerce API Manager/Queue Interface
 */
interface WCAM_Queue_Interface {
	 ...
	 *                              'modified' => null - the date the action was last updated. Expects a DateTime object, a unix timestamp, or a string that can parsed with strtotime(). Used in UTC
	 *                              timezone.
