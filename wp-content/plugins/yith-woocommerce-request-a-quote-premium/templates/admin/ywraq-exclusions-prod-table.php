...
<div class="wrap">
	...
	<h2><?php esc_html_e( 'Product exclusion list', 'yith-woocommerce-request-a-quote' ); ?></h2>
	...
	<form id="yith-add-exclusion-prod" method="POST">
		<input type="hidden" name="_nonce" value="<?php echo sanitize_key( wp_create_nonce( 'yith_ywraq_add_exclusions_prod' ) ); ?>" />
		<label for="add_products"><?php esc_html_e( 'Select products to exclude', 'yith-woocommerce-request-a-quote' ); ?></label>
		<?php
