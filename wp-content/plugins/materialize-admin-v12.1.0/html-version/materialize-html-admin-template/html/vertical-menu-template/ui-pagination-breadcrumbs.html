...
<html
  ...
  <head>
    ...
    <title>Pagination and breadcrumbs - UI elements | Materialize - Material Design HTML Admin Template</title>
                      ...
                      <div class="demo-inline-spacing">
                        <nav aria-label="Page navigation">
                          <ul class="pagination pagination-sm">
                            <li class="page-item prev">
                              <a class="page-link" href="javascript:void(0);"
                                ><i class="tf-icon mdi mdi-chevron-double-left mdi-14px"></i
                              ></a>
                            </li>
                            <li class="page-item">
                              <a class="page-link" href="javascript:void(0);">1</a>
                            ...
                            <li class="page-item next">
                              <a class="page-link" href="javascript:void(0);"
                                ><i class="tf-icon mdi mdi-chevron-double-right mdi-14px"></i
                              ></a>
                            </li>
                          </ul>
                        </nav>
                    ...
                    <ol class="breadcrumb mb-0">
                      <li class="breadcrumb-item">
                        <a href="javascript:void(0);" class="d-flex align-items-center"
                          ><i class="mdi mdi-star me-1 text-body"></i>Home</a
                        >
                      </li>
                      <li class="breadcrumb-item">
                        <a href="javascript:void(0);" class="d-flex align-items-center"
                          ><i class="mdi mdi-star me-1 text-body"></i>Library</a
                        >
                      </li>
                      <li class="breadcrumb-item active">
                        <a href="javascript:void(0);" class="d-flex align-items-center"
                          ><i class="mdi mdi-star me-1 text-body"></i>Data</a
                        >
                      </li>
                    </ol>
                  </nav>
