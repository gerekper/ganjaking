...
<html
  ...
  <head>
    ...
    <title>User View - Pages | Materialize - Material Design HTML Admin Template</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">User / View /</span> Notifications</h4>
              <div class="row">
                <!-- User Sidebar -->
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body py-3">
                      <span class="text-heading fw-semibold"
                        >Change to notification settings, the user will get the update</span
                      >
                    </div>
