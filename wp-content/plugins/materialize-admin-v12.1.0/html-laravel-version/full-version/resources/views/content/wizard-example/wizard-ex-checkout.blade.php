                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 mt-3 mt-md-0">
                        <div class="d-md-flex flex-column h-100 justify-content-between align-items-md-end">
                          ...
                          <button type="button" class="btn btn-sm btn-outline-primary text-nowrap">Move to wishlist</button>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="border rounded p-3 mb-3">
              ...
              <div class="row g-3 mb-3">
                <div class="col-8 col-xxl-8 col-xl-12">
                  <input type="text" class="form-control" id="wizard-promo-code" placeholder="Enter Promo Code" aria-label="Enter Promo Code">
                </div>
              ...
              <dl class="row mb-0">
                ...
                <dd class="col-6 text-end"><s>$5.00</s> <span class="badge bg-label-success rounded-pill">Free</span></dd>
                ...
                <div class="form-check custom-option custom-option-icon position-relative checked">
                  <label class="form-check-label custom-option-content" for="customRadioDelivery1">
                    <span class="custom-option-body">
                      ...
                      <span class="badge bg-label-success rounded-pill btn-pinned">FREE</span>
                ...
                <div class="form-check custom-option custom-option-icon position-relative">
                  <label class="form-check-label custom-option-content" for="customRadioDelivery2">
                    <span class="custom-option-body">
                      ...
                      <span class="badge bg-label-secondary rounded-pill btn-pinned">$10</span>
                ...
                <div class="form-check custom-option custom-option-icon position-relative">
                  <label class="form-check-label custom-option-content" for="customRadioDelivery3">
                    <span class="custom-option-body">
                      ...
                      <span class="badge bg-label-secondary rounded-pill btn-pinned">$15</span>
        ...
        <div class="row">
          ...
          <div class="col-xl-9 mb-3 mb-xl-0">
            ...
            <div class="col-xxl-6 col-lg-8">
              <ul class="nav nav-pills mb-0 mb-sm-3 flex-column flex-sm-row" id="paymentTabs" role="tablist">
                  ...
                  <div class="row g-4">
                    ...
                    <div class="col-6 col-md-3">
                      <div class="form-floating form-floating-outline">
                        ...
                        <label for="paymentCardExpiryDate">Exp. Date</label>
                      </div>
                    </div>
                    <div class="col-6 col-md-3">
                      <div class="input-group input-group-merge">
                        <div class="form-floating form-floating-outline">
                          ...
                          <label for="paymentCardCvv">CVV Code</label>
                        </div>
          ...
          <div class="col-xl-3">
            <div class="border rounded p-3">
              ...
              <!-- Price Details -->
              <h6 class="fw-semibold">Price Details</h6>
              <dl class="row mb-0">
              ...
              <hr class="mx-n3 mt-1">
              <dl class="row mb-0">
                <dt class="col-6 mb-1">Total</dt>
                <dd class="col-6 mb-1 fw-semibold text-end mb-0">$1100.00</dd>

                <dt class="col-6">Deliver to:</dt>
                <dd class="col-6 fw-semibold text-end mb-0"><span class="badge bg-label-primary rounded-pill">Home</span></dd>
              </dl>
              <!-- Address Details -->
              <address>
      ...
      <div id="checkout-confirmation" class="content">
        <div class="row mb-3">
          <div class="col-12 col-lg-8 offset-lg-2 text-center mb-3">
            ...
            <p><span class="fw-semibold"><i class="mdi mdi-av-timer"></i> Time placed:</span> 01/01/<script>
          ...
          <div class="col-12">
            <ul class="list-group list-group-horizontal-md">
              <li class="list-group-item flex-fill">
                <h6 class="fw-semibold"><i class="mdi mdi-24px mdi-map-marker-outline"></i> Shipping</h6>
                <address>
                  John Doe <br />
                  4135 Parkway Street,<br />
                  Los Angeles, CA 90017,<br />
              ...
              <li class="list-group-item flex-fill">
                <h6 class="fw-semibold"><i class="mdi mdi-24px mdi-credit-card-outline"></i> Billing Address</h6>
                <address>
                  John Doe <br />
                  4135 Parkway Street,<br />
                  Los Angeles, CA 90017,<br />
              ...
              <li class="list-group-item flex-fill">
                <h6 class="fw-semibold"><i class="mdi mdi-24px mdi-truck-outline"></i> Shipping Method</h6>
