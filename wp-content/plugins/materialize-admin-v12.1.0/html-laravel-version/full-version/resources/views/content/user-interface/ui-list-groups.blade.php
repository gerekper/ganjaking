        ...
        <div class="demo-inline-spacing mt-3">
          <div class="list-group">
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
              <div class="avatar flex-shrink-0 bg-primary d-flex align-items-center justify-content-center rounded me-3"><i class="mdi mdi-bootstrap mdi-24px text-white"></i></div>
              <div class="w-100">
            ...
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
              <div class="avatar flex-shrink-0 bg-success d-flex align-items-center justify-content-center rounded me-3"><i class="mdi mdi-vuejs mdi-24px text-white"></i></div>
              <div class="w-100">
            ...
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
              <div class="avatar flex-shrink-0 bg-danger d-flex align-items-center justify-content-center rounded me-3"><i class="mdi mdi-angular mdi-24px text-white"></i></div>
              <div class="w-100">
            ...
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
              <div class="avatar flex-shrink-0 bg-info d-flex align-items-center justify-content-center rounded me-3"><i class="mdi mdi-react mdi-24px text-white"></i></div>
              <div class="w-100">
            ...
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
              <div class="avatar flex-shrink-0 bg-warning d-flex align-items-center justify-content-center rounded me-3"><i class="mdi mdi-language-javascript mdi-24px text-white"></i></div>
              <div class="w-100">
