	...
	public static function forms_page( $form_id ) {
		...
		<div id="gform-form-toolbar">
			...
			<ul id="gform-form-toolbar__menu">
				...
				if ( ! empty( $dynamic_menu_items ) ) {
					echo '<li class="gf_form_toolbar_dynamic"><a class="gf-topmenu-dynamic" href="#"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.70711 12.7071C5.89464 12.5196 6 12.2652 6 12C6 11.7348 5.89464 11.4804 5.70711 11.2929C5.51957 11.1054 5.26522 11 5 11C4.73478 11 4.48043 11.1054 4.29289 11.2929C4.10536 11.4804 4 11.7348 4 12C4 12.2652 4.10536 12.5196 4.29289 12.7071C4.48043 12.8946 4.73478 13 5 13C5.26522 13 5.51957 12.8946 5.70711 12.7071Z"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.7071 12.7071C12.8946 12.5196 13 12.2652 13 12C13 11.7348 12.8946 11.4804 12.7071 11.2929C12.5196 11.1054 12.2652 11 12 11C11.7348 11 11.4804 11.1054 11.2929 11.2929C11.1054 11.4804 11 11.7348 11 12C11 12.2652 11.1054 12.5196 11.2929 12.7071C11.4804 12.8946 11.7348 13 12 13C12.2652 13 12.5196 12.8946 12.7071 12.7071Z"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M19.7071 12.7071C19.8946 12.5196 20 12.2652 20 12C20 11.7348 19.8946 11.4804 19.7071 11.2929C19.5196 11.1054 19.2652 11 19 11C18.7348 11 18.4804 11.1054 18.2929 11.2929C18.1054 11.4804 18 11.7348 18 12C18 12.2652 18.1054 12.5196 18.2929 12.7071C18.4804 12.8946 18.7348 13 19 13C19.2652 13 19.5196 12.8946 19.7071 12.7071Z"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></a></li>';
				?>
					<div class="gf-popover">
						<div class="gf-popover__content">
						<?php
						foreach ( $dynamic_menu_items as $item ) {
							$url   = empty( $item['url'] ) ? '' : $item['url'];
							$label = empty( $item['label'] ) ? '' : $item['label'];
							$icon  = empty( $item['icon'] ) ? '' : $item['icon'];
						?>
							<button class="gf-popover__button" data-url="<?php echo esc_url( $url ); ?>">
								<span class="gf-popover__button__icon"><?php echo wp_kses( $icon, array( 'i' => array( 'class' => true ) ) ); ?></span>
			...
			<div id="gf_toolbar_buttons_container">
				...
				if ( GFCommon::current_user_can_any( $preview_capabilities ) ) {
					$preview_text = esc_html__( 'Preview', 'gravityforms' );
					$preview_url  = trailingslashit( site_url() ) . '?gf_page=preview&id=' . $form_id;
					$preview_link = '<a target="_blank" class="preview-form" href="' . $preview_url . '">' . $preview_text . '</a>';
				...
				$save_button = '<button aria-disabled="false" aria-expanded="false" class="update-form" onclick="SaveForm();" onkeypress="SaveForm();" >' . esc_html__( 'Update', 'gravityforms' ) . '</button>';
				/**
				...
				*/
				...
				if ( GFCommon::current_user_can_any( 'gravityforms_delete_forms' ) ) {
					$trash_link = '<button  class="submitdelete" title="' . esc_html__( 'Move this form to the trash', 'gravityforms' ) . '" onclick="gf_vars.isFormTrash = true; jQuery(\'#form_trash\')[0].submit();" onkeypress="gf_vars.isFormTrash = true; jQuery(\'#form_trash\')[0].submit();" aria-label="' . esc_html__( 'Move to Trash', 'gravityforms' ) . '"><svg style="color:#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><rect x="0" fill="none" width="20" height="20"/><g><path d="M12 4h3c.6 0 1 .4 1 1v1H3V5c0-.6.5-1 1-1h3c.2-1.1 1.3-2 2.5-2s2.3.9 2.5 2zM8 4h3c-.2-.6-.9-1-1.5-1S8.2 3.4 8 4zM4 7h11l-.9 10.1c0 .5-.5.9-1 .9H5.9c-.5 0-.9-.4-1-.9L4 7z"/></g></svg></button>';
      ...
      <div id="gform_pagination" data-title="<?php esc_attr_e('Pagination Options', 'gravityforms');?>" data-description="<?php esc_attr_e('Manage pagination options', 'gravityforms');?>" class="selectable" style="display:<?php echo $has_pages ? 'block' : 'none' ?>;">
        <div class="settings_control_container">
          ...
          <a href="javascript:void(0);" class="form_edit_icon edit_icon_collapsed" title="<?php esc_attr_e( 'click to edit page options', 'gravityforms' ); ?>"><i class='fa fa-caret-down fa-lg'></i></a>
			...
			<div class="gform_wrapper gform_editor <?php echo GFCommon::is_legacy_markup_enabled( $form_id ) ? 'gform_legacy_markup' : ''; ?>">
				...
				<div id="no-fields" style="<?php echo empty( $form['fields'] ) ? '' : 'display:none;'; ?>"></div>
		...
		<div class="editor-sidebar">
			...
			<aside class="sidebar" role="region" >
				<ul class="sidebar__nav">
					<li class="sidebar__nav__item"><a href="#add_fields"><?php esc_html_e('Add Fields', 'gravityforms'); ?></a></li>
					<li class="sidebar__nav__item" id="settings_tab_item"><a href="#field_settings_container"><?php esc_html_e('Field Settings', 'gravityforms'); ?></a></li>
                    ...
                    <div class="panel-block panel-block-tabs "id="add_fields_menu" >
						...
						foreach ( $field_groups as $group ) {
							...
							?>
                                ...
                                <div class="panel-block-tabs__body panel-block-tabs__body--nopadding" id="add_<?php echo esc_attr( $group['name'] ) ?>">
                                    <div class="search-button">
                                        <input type="text" class="search-button__input" data-group="<?php echo esc_attr( $group['name'] ) ?>" placeholder="<?php echo esc_attr__('Search for a field', 'gravityforms')?>">
                                    </div>
				...
				<div class="sidebar__panel sidebar__panel--settings" id="field_settings_container">
					...
					<div class="panel-block panel-block-tabs panel-block--hidden field_settings">
                        ...
                        <ul id="general_tab" class="panel-block-tabs__body panel-block-tabs__body--settings">
                                ...
                                <li class="product_field_type_setting field_setting">
                                    ...
                                    <select id="product_field_type" onchange="if(jQuery(this).val() == '') return; StartChangeProductType(jQuery('#product_field_type').val());">
                                ...
                                <li class="shipping_field_type_setting field_setting">
                                    ...
                                    <select id="shipping_field_type" onchange="if(jQuery(this).val() == '') return; StartChangeShippingType(jQuery('#shipping_field_type').val())">
                                ...
                                <li class="option_field_type_setting field_setting">
                                    ...
                                    <select id="option_field_type" onchange="if(jQuery(this).val() == '') return;StartChangeInputType(jQuery('#option_field_type').val());">
                                        <option value="select"><?php esc_html_e( 'Drop Down', 'gravityforms' ); ?></option>
                                ...
                                <li class="donation_field_type_setting field_setting">
                                    ...
                                    <select id="donation_field_type" onchange="if(jQuery(this).val() == '') return;StartChangeDonationType(jQuery('#donation_field_type').val());">
                                        <option value="select"><?php esc_html_e( 'Drop Down', 'gravityforms' ); ?></option>
                                ...
                                <li class="quantity_field_type_setting field_setting">
                                    ...
                                    <select id="quantity_field_type" onchange="if(jQuery(this).val() == '') return; StartChangeInputType(jQuery('#quantity_field_type').val())">
                                ...
                                <li class="post_custom_field_type_setting field_setting">
                                    ...
                                    <select id="post_custom_field_type" onchange="if(jQuery(this).val() == '') return; StartChangePostCustomFieldType(jQuery('#post_custom_field_type').val());">
                                ...
                                <li class="post_tag_type_setting field_setting">
                                    ...
                                    <select id="post_tag_type" onchange="if(jQuery(this).val() == '') return; StartChangeInputType(jQuery('#post_tag_type').val());">
                                        <option value="text"><?php esc_html_e( 'Single line text', 'gravityforms' ); ?></option>
                                        <option value="select"><?php esc_html_e( 'Drop Down', 'gravityforms' ); ?></option>
                                        <option value="checkbox"><?php esc_html_e( 'Checkboxes', 'gravityforms' ); ?></option>
                                        <option value="radio"><?php esc_html_e( 'Radio Buttons', 'gravityforms' ); ?></option>
                                    ...
                                    <div id="gfield_bulk_add" style="display:none;">
                                        ...
                                        <div class="modal_footer">
                                            ...
                                            <div class="panel-custom" style="">
                                                <a href="javascript:void(0);" onclick="LoadCustomChoicesPanel(true, 0);" onkeypress="LoadCustomChoicesPanel(true, 0);" id="bulk_save_as"><?php esc_html_e( 'Save as new custom choice', 'gravityforms' ) ?>&nbsp;&rarr;</a>
                        ...
                        <ul id="appearance_tab" class="panel-block-tabs__body panel-block-tabs__body--settings">
                            ...
                            <li class="placeholder_textarea_setting field_setting">
                                ...
                                <textarea id="field_placeholder_textarea" class="field_place merge-tag-support mt-position-right mt-prepopulate"></textarea>
                                <span id="placeholder_warning" style="display:none"><?php _e( 'Placeholder text is not supported when using the Rich Text Editor.', 'gravityforms' ); ?></span>
                            </li>
                            <?php
                        ...
                        <ul id="advanced_tab" class="panel-block-tabs__body panel-block-tabs__body--settings">
                            ...
                            <li class="default_value_textarea_setting field_setting">
                                ...
                                <textarea id="field_default_value_textarea" class="field_default merge-tag-support mt-position-right mt-prepopulate"></textarea>
                            </li>
                            <?php
    ...
    <?php esc_html_e( 'To activate this option, please add a field to be used as the source.', 'gravityforms' ); ?>
                            ...
                            <li class="visibility_setting field_setting">
                                ...
                                <div>
                                    <?php foreach( GFCommon::get_visibility_options() as $visibility_option ):
                                        ...
                                        ?>
                                        <input type="radio" name="field_visibility" id="field_visibility_<?php echo $slug; ?>"  value="<?php echo $visibility_option['value']; ?>" onclick="return SetFieldVisibility( this.value );" onkeypress="return SetFieldVisibility( this.value );" /><label for="field_visibility_<?php echo $slug; ?>" class="inline"><?php echo esc_html( $visibility_option['label'] ); ?></label>
                                    <?php endforeach; ?>
						...
						?>
								...
								<ul id="<?php echo $tab_id; ?>_tab" class="panel-block-tabs__body panel-block-tabs__body--settings <?php echo implode( ' ', $tab_body_classes );?>">
									 ...
									 */
									gf_do_action( array( 'gform_field_settings_tab_content', $tab_id, $form_id ), $form );
									?>
								</ul>
							<?php
						}
	...
	public static function color_picker( $field_name, $callback ) {
		...
		<script type="text/javascript">
			jQuery( "#chooser_<?php echo esc_js( $field_name ); ?>" ).click( function ( e ) {
				let top = e.currentTarget.y + 176;
				iColorShow( 1190, top, '<?php echo esc_js( $field_name ); ?>', "<?php echo esc_js( $callback ); ?>" ) ;
			});
			jQuery("#chip_<?php echo esc_js( $field_name ); ?>").click(function (e) {
				let top = e.currentTarget.y + 180;
				iColorShow( 1190, top, '<?php echo esc_js( $field_name ); ?>', "<?php echo esc_js( $callback ); ?>" );
			});
		</script>
		<?php
