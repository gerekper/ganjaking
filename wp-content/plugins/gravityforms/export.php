...
class GFExport {
	...
	public static function import_form_page() {
        ...
        <div class="gform-settings__content">
            <form method="post" enctype="multipart/form-data" class="gform_settings_form" style="margin-top:10px;">
	...
	public static function export_form_page() {
        ...
        <div class="gform-settings__content">
            <form method="post" id="gform_export" class="gform_settings_form" style="margin-top:10px;">
