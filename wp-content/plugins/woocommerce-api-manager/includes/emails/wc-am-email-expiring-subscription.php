...
if ( class_exists( 'WC_Email' ) ) {
	class WC_AM_Email_Expiring_Subscription extends WC_Email {
		...
		function trigger( $api_resource_id ) {
			...
			if ( is_object( $this->api_resource ) && empty( $this->api_resource->sub_id ) ) {
				...
				throw new InvalidArgumentException( __( 'API Resource argument passed in is not an object.', 'woocommerce-api-manager' ) );
			}
...
return new WC_AM_Email_Expiring_Subscription();