 ...
 * @package     WooCommerce API Manager/Abstract Background Updater
 */

defined( 'ABSPATH' ) || exit;

if ( ! class_exists( 'WP_Async_Request', false ) ) {
	require_once( dirname( WC_AM_PLUGIN_FILE ) . '/libraries/wp-async-request.php' );
}

if ( ! class_exists( 'WP_Background_Process', false ) ) {
	require_once( dirname( WC_AM_PLUGIN_FILE ) . '/libraries/wp-background-process.php' );
}
