...
class WooCommerce_Product_Search_Filter_Stock_Widget extends WP_Widget {
	...
	public static function init() {
		...
		self::$the_name = __( 'Product Filter &ndash; Stock', 'woocommerce-product-search' );
	}
	...
	public function update( $new_instance, $old_instance ) {
		...
		$settings['has_in_stock_only'] = !empty( $new_instance['has_in_stock_only'] ) ? 'yes' : 'no';
	...
	public function form( $instance ) {
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			$this->get_field_id( 'has_in_stock_only' ),
			$this->get_field_name( 'has_in_stock_only' ),
