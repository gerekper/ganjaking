...
<div class="flexslider_event eosa_minicarousel <?php echo $skin ?>">
    ...
    <ul class="slides">
        ...
        <li>
            ...
            <div id="<?php echo $fullid ?>" class="eo_s4b_main <?php if ($item_array[18] == "yes") echo "cancelled_event"; ?>"  style="border-top: 1px solid #<?php echo $item_array[10]; ?>; border-bottom: 1px solid #<?php echo $item_array[10]; ?>">
