...
<div class="form-fields wcpv-term-additional-settings" style="display:none">
	...
	<div class="form-field term-admins">
		...
		<select id="wcpv-vendor-admins" style="width: 50%;" class="wc-customer-search" name="vendor_data[admins][]" multiple="multiple" data-placeholder="<?php esc_attr_e( 'Search for Users', 'woocommerce-product-vendors' ); ?>"></select>
