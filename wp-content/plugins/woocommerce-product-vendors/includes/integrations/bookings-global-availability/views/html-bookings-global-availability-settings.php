							...
							<table class="widefat">
								<thead>
									<tr>
										...
										<th></th>
										<th></th>
										<th><?php esc_html_e( 'Bookable', 'woocommerce-product-vendors' ); ?>&nbsp;<a class="tips" data-tip="<?php echo wc_sanitize_tooltip( __( 'If not bookable, users won\'t be able to choose this block for their booking.', 'woocommerce-product-vendors' ) ); ?>">[?]</a></th>
										<th><?php esc_html_e( 'Priority', 'woocommerce-product-vendors' ); ?>&nbsp;<a class="tips" data-tip="<?php echo wc_sanitize_tooltip( __( 'The lower the priority number, the earlier this rule gets applied. By default, global rules take priority over product rules which take priority over resource rules. By using priority numbers you can execute rules in different orders.', 'woocommerce-product-vendors' ) ); ?>">[?]</a></th>
								...
								<tfoot>
									<tr>
										<th colspan="6">
											<a href="#" class="button button-primary add_row" data-row="
											<?php
												$add_row = true;
												ob_start();
