...
echo sprintf( __( 'You have received a subscription renewal order from %s.', 'woocommerce-product-vendors' ),
		$billing_first_name . ' ' . $billing_last_name ) . "\n\n";

echo "=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n\n";

echo strtoupper( sprintf( __( 'Order number: %s', 'woocommerce-product-vendors' ),
