...
class PAFE_Form_Builder_Prev_Step extends \Elementor\Widget_Base {

	public function get_name() {
		return 'pafe-form-builder-prev-step';
	}

	public function get_title() {
		return __( 'Previous Step', 'pafe' );
	}

	public function get_icon() {
		return 'icon-w-prev-step';
	}
	...
	public function get_keywords() {
		return [ 'prev', 'previous', 'step', 'form' ];
	}
	...
	protected function render() {
		...
		?>	
			<div class='pafe-form-builder-prev-step' <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
