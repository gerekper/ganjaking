...
<div class="wccc-settings-custom">
    ...
    <p class="description"><?php printf(__('Enter the name and priority of an action where this content should be output.  See the <a href="%s">woocommerce hooks and filter reference</a> for a full list of all template actions and filters.', 'wc_conditional_content'), 'https://docs.woocommerce.com/document/introduction-to-hooks-actions-and-filters/'); ?></p>
    <br /><label for="wccc_settings_location_custom_accepted_args"><?php _e('Accepted Function Args', 'wc_conditional_content'); ?></label>
	...
	<p class="description"><?php _e('Optional. The number of arguments the function accepts. Default 0.', 'wc_conditional_content'); ?></p>
