 ...
 * @since 2.4.0
 */
class WC_Address_Validation_Loader {
	...
	const PLUGIN_NAME = 'WooCommerce Address Validation';


	/** @var \WC_Address_Validation_Loader single instance of this class */
	...
	public function init_plugin() {
		...
		if ( $this->plugins_compatible() ) {
			...
			require_once( plugin_dir_path( __FILE__ ) . 'class-wc-address-validation.php' );
	 ...
	 * @since 2.4.0
	 *
	 * @return \WC_Address_Validation_Loader
	 */
...
// fire it up!
WC_Address_Validation_Loader::instance();
