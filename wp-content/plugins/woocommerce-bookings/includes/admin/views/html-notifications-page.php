<?php
/**
 * Admin View: Page - Notifications
 *
 * @package WooCommerce Bookings/Admin/Views
 * @since 1.0.0
 */
			...
			<tbody>
				...
				<tr valign="top">
					...
					<td>
						...
						<p class="description"><?php esc_html_e( 'The following tags can be inserted in your message/subject and will be replaced dynamically', 'woocommerce-bookings' ); ?>: <code>{booking_id} {product_title} {order_date} {order_number} {customer_name} {customer_first_name} {customer_last_name}</code></p>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row">
					...
					<td>
						<label><input type="checkbox" name="notification_ics" id="notification_ics" />
						<?php
