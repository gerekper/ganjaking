...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1" bordercolor="#eee">
	<tbody>
		<tr>
			...
			<td style="text-align:left; border: 1px solid #eee;"><?php wc_get_template( 'order/booking-display.php', array( 'booking_ids' => [ $booking->get_id() ], 'only_title' => true ), 'woocommerce-bookings', WC_BOOKINGS_TEMPLATE_PATH ); ?></td>
		</tr>
		<tr>
