...
class WC_CP_Product {
	...
	public function get_image_size() {
		return apply_filters( 'woocommerce_composite_component_option_image_size', 'woocommerce_thumbnail', $this );
	}
	...
	public function get_selection_thumbnail_size() {
		return apply_filters( 'woocommerce_composited_product_thumbnail_size', 'woocommerce_thumbnail', $this );
	}
