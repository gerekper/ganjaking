  ...
  public function display_option_fields() {
    ...
    <div id="constantcontact_hidden_area" class="mepr-options-sub-pane">
      ...
      <div id="meprconstantcontact-api-key">
        ...
        <?php _e('You can get your API key at <a href="https://developer.constantcontact.com/v2-api-keys.html" target="_blank">https://developer.constantcontact.com/v2-api-keys.html</a>', 'memberpress-constantcontact'); ?>
        </span>
        </div>
      </div>
      <br/>
...
<!--        <div id="meprconstantcontact-double-optin">
  ...
  public function process_signup($user) {
    $mepr_options = MeprOptions::fetch();
    $enabled = (bool)get_post_meta((int)sanitize_text_field($_POST['mepr_product_id']), '_meprconstantcontact_list_override', true);
