                             ...
                             foreach ($mul_cats as $cat_key => $cat_val) {
                              ...
                              <?php
								...
								<tr>
									...
									<td>
										<input type="number" class="rtwwdpd_check_minvalue" value="<?php echo isset($rtwwdpd_prev_prod['rtwwdpd_min_cat']) ? esc_attr($rtwwdpd_prev_prod['rtwwdpd_min_cat']) : '' ; ?>" min="0" name="rtwwdpd_min_cat">
						...
						<div class="options_group rtwwdpd_active" id="rtwcat_rule_tab">
							...
							<table class="rtwwdpd_table_edit">
								...
								<tr>
									...
									<td>
										<input type="number" class="rtwwdpd_check_minvalue" value="" min="0" name="rtwwdpd_min_cat">
										<i class="rtwwdpd_description"><?php esc_html_e( 'Minimum value to check', 'rtwwdpd-woo-dynamic-pricing-discounts-with-ai' ); ?>
										</i>
									</td>
								</tr>
