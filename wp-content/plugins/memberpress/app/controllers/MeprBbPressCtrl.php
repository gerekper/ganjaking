...
class MeprBbPressCtrl extends MeprBaseCtrl {
  public function load_hooks() {
    ...
    add_action('dynamic_sidebar_before', 'MeprBbPressCtrl::in_sidebar', 11, 2);
    add_action('dynamic_sidebar_after', 'MeprBbPressCtrl::out_sidebar', 11, 2);
  ...
  public static function hide_forums($status, $forum_id) {
    ...
    if(isset($_REQUEST['mepr_bbpress_in_sidebar']) && $_REQUEST['mepr_bbpress_in_sidebar']) { return $status; }
