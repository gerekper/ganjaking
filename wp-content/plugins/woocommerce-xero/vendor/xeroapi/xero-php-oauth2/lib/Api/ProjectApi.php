...
class ProjectApi
{
    ...
    protected function createProjectRequest($xero_tenant_id, $project_create_or_update)
    {
        ...
        if (isset($_tempBody)) {
            ...
            if ($multipart) {
                ...
                // for HTTP post (form)
                $httpBody = \Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Psr7\build_query($formParams);
            }
        }
        ...
        $query = \Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Psr7\build_query($queryParams);
        return new Request(
            'POST',
     ...
     * @return \Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Promise\PromiseInterface
     */
    public function getTasksAsync($xero_tenant_id, $project_id, $page = null, $page_size = null, $task_ids = null)
    {
        return $this->getTasksAsyncWithHttpInfo($xero_tenant_id, $project_id, $page, $page_size, $task_ids)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  int $page Set to 1 by default. The requested number of the page in paged response - Must be a number greater than 0. (optional)
     * @param  int $page_size Optional, it is set to 50 by default. The number of items to return per page in a paged response - Must be a number between 1 and 500. (optional)
     * @param  string[] $states Comma-separated list of states to find. Will find all time entries that are in the status of whatever’s specified. (optional)
