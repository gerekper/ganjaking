...
<head>
	...
	$slider = $YWC_Product_Slider->get_productslider(); // phpcs:ignore WordPress.NamingConventions
...
<div id="ywcps_lightbox_content">
	...
	<p class="ywcps_z_index_content">
		<label for="ywcps_z_index"><?php esc_html_e( 'z-index', 'yith-woocommerce-product-slider-carousel' ); ?></label>
