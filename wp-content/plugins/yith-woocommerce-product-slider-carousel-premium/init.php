...
if ( ! defined( 'YWCPS_SECRET_KEY' ) ) {
	define( 'YWCPS_SECRET_KEY', '123456' );
}
...
/**
 * Yith_ywcps_premium_install_woocommerce_admin_notice
 *
 * @return void
 */
function yith_ywcps_premium_install_woocommerce_admin_notice() {
	?>
		<div class="error">
			<p><?php esc_html_e( 'YITH WooCommerce Product Slider Carousel Premium is enabled but not effective. It requires WooCommerce in order to work.', 'yith-woocommerce-product-slider-carousel' ); ?></p>
		</div>
	<?php
}
...
if ( ! function_exists( 'YITH_Product_Slider_Premium_Init' ) ) {
	 ...
	 * @since 1.0.3
	 */
	function YITH_Product_Slider_Premium_Init() { // phpcs:ignore WordPress.NamingConventions
		...
		$YWC_Product_Slider = YITH_WooCommerce_Product_Slider_Premium::get_instance(); // phpcs:ignore WordPress.NamingConventions
...
if ( ! function_exists( 'yith_product_slider_carousel_premium_install' ) ) {
	...
	/**
	 * Yith_product_slider_carousel_premium_install
	 *
	 * @return void
	 */
