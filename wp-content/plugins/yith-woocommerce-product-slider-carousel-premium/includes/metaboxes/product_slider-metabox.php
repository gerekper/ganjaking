		...
		'settings' => array(
			...
			'fields' => array_merge(
				...
				array(
					...
					'ywcps_title_content_setting' => array(
						'type' => 'title',
						'desc' => __( 'Content Settings', 'yith-woocommerce-product-slider-carousel' ),
					),
				...
				! defined( 'YITH_WCWL_PREMIUM' ) ? array() : array(
					'ywcps_show_wishlist' => array(
						'label' => __( 'Show Wishlist button', 'yith-woocommerce-product-slider-carousel' ),
						'desc'  => __( 'Show the wishlist button in the slider', 'yith-woocommerce-product-slider-carousel' ),
						'type'  => 'checkbox',
						'std'   => 0,
						'deps'  => array(
							'ids'    => '_ywcps_layout_type',
				...
				array(
					...
					'ywcps_title_slider_setting'   => array(
						'type' => 'title',
						'desc' => __( 'Slider Settings', 'yith-woocommerce-product-slider-carousel' ),
					),
