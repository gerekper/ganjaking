					...
					case 'getdirection':
						...
						$OT.="<div class='evo_metarow_getDr evorow evcal_evdata_row evcal_evrow_sm getdirections'>
							...
							<p class='evo_get_direction_content'>
								<input class='evoInput' type='text' name='saddr' placeholder='{$_lang_1}' value=''/>
								<button type='submit' class='evo_get_direction_button evcal_btn dfx fx_ai_c' title='{$_lang_2}'><i class='fa ".get_eventON_icon('evcal__fai_008a', 'fa-road',$evOPT )." marr5'></i> ". evo_lang('Get Directions') ."</button>
							</p></form>
						</div>";
