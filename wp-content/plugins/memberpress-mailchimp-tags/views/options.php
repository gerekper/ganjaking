...
<div id="mailchimptags_hidden_area" class="mepr-options-sub-pane">
  ...
  <div id="meprmailchimptags-list-id">
    <label>
      <span><?php _e('MailChimp Audience:', 'memberpress-mailchimp-tags'); ?></span>
    ...
    <div>
      <span class="description"><?php _e('This is the audience you want associated with your members.', 'memberpress-mailchimp-tags'); ?></span>
    </div>
  </div>
  <br/>
  ...
  <div id="meprmailchimptags-double-optin">
    ...
    <div>
      <span class="description"><?php _e('When enabled, the member must click a confirmation link in their email before they will be subscribed to your audience. (Recommended)', 'memberpress-mailchimp-tags'); ?></span>
    </div>
  </div>
  <br/>
  <div id="meprmailchimptags-optin">
    ...
    <div>
      <span class="description">
        <?php _e('If checked, an opt-in checkbox will appear on all of your membership registration forms. If the user does not opt-in, they will be added to your audience with the Global Merge Tag value of 0 instead of 1.', 'memberpress-mailchimp-tags'); ?>
      </span>
    </div>
  </div>
  <div id="meprmailchimptags-optin-text" class="mepr-hidden mepr-options-panel">
    ...
    <div>
      <span class="description">
        <?php _e('This is the text that will display on the signup form next to your audience opt-in checkbox.', 'memberpress-mailchimp-tags'); ?>
      </span>
    </div>
  </div>
</div>