...
$located = wc_locate_template( 'tm-element-quantity.php', THEMECOMPLETE_EPO_DISPLAY()->get_template_path(), apply_filters( 'wc_epo_template_path_element', THEMECOMPLETE_EPO_DISPLAY()->get_default_path(), null, null ) );
