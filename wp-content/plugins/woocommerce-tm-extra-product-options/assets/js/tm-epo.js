(function (window, document, $) {
    ...
    function get_element_from_field(element) {
        ...
        if (_class.length > 0) {
            ...
            if (_class === "cpf-type-product"){
                if ($element.is(".cpf-type-product-dropdown")){
    ...
    function epoEventHandlers(epoObject, cartContainer, alternativeCart) {
        ...
        if (_ && _.debounce){
            ...
            .keyup(_.debounce(function(){$(this).trigger("change.cpf");} , 10));
        }
        ...
        jDocument.ajaxSuccess(function (event, request, settings) {
            ...
            Object.keys(qv_container).forEach(function (key) {
                ...
                if (key !== "yith_quick_view_plugin" && container.length && (container.find(".product").length > 0 || noProductCheck )) {
                    ...
                    if (key === "fusion_quick_view_load" || key === "jet_popup_get_content" || key === "wp_food" || key === "woodmart_quick_shop" || key === "fwoodmart_quick_view" || key === "lightboxpro" || key === "jckqv_quick_view" || key === "yith_quick_view_plugin" || key === "theme_flatsome") {
