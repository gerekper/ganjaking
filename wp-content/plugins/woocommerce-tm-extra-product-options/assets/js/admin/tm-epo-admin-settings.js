(function (window, document, $) {
    ...
    function tm_license_check(action) {
        ...
        if (tm_epo_consent_for_transmit.length && tm_epo_consent_for_transmit.is(":checked") && ajaxCheck === 0) {
            ...
            $.post(TMEPOADMINSETTINGSJS.ajax_url, data, function (response) {
    ...
    function tm_css_styles_style(select) {
        $(select).closest("td").css("position", "relative").append("<label class=\"tm-epo-field-label\"><span class=\"tm-epo-style-wrapper\"><input type=\"checkbox\" checked><span class=\"tm-epo-style\"></span></span></label><label class=\"tm-epo-field-label\"><span class=\"tm-epo-style-wrapper\"><input type=\"radio\" checked><span class=\"tm-epo-style\"></span></span></label>");
    }
    ...
    $(document).ready(function () {
        ...
        if (tm_settings_wrap.length > 0) {
            ...
            $(".forminp .description").toArray().forEach(function (el, i) {
                var $el = $(el);
