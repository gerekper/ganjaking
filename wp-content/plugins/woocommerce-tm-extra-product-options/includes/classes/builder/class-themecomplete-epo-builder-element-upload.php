 ...
 * @version 6.0
 */
class THEMECOMPLETE_EPO_BUILDER_ELEMENT_UPLOAD extends THEMECOMPLETE_EPO_BUILDER_ELEMENT {
	...
	public function __construct( $name = '' ) {
		...
		$this->name             = esc_html__( 'Upload', 'woocommerce-tm-extra-product-options' );
		$this->description      = '';
		$this->width            = 'w100';
