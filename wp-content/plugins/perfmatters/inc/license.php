		...
		echo "<tbody>";
			...
			echo "<tr>";
				...
				echo "<td>";
					...
					echo "<input id='perfmatters_edd_license_key' name='perfmatters_edd_license_key' type='password' class='regular-text' value='" . (!empty($license) ? 'youreawizardharry' : '') . "' style='margin-right: 10px;' maxlength='50' />";
