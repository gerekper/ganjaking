...
<div id="yith_wcfm-header" class="left-logo">
	<div class="yith_wcfm-container">
		<div class="yith_wcfm-header-content">
			...
			<?php
			$blog_title = get_bloginfo( 'name' ); // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
			$blog_link  = get_bloginfo( 'url' );
			?>
			<div class="yith_wcfm-site-name">
				<a href="<?php echo esc_url( $blog_link ); ?>">
					<?php echo wp_kses_post( apply_filters( 'yith_wcfm_skin_1_header_blog_title', $blog_title ) ); ?>
				</a>
			</div>
