			...
			if ( true == $AwardPointsForRenewalOrder ) {
				...
				if ( 'yes' == get_option( 'rs_product_purchase_activated' ) ) {
					...
					if ( '3' == $RewardPointsBasedOn ) {
						$this->rs_insert_points_based_on_range_based_total( $enabledisablemaxpoints , 0 , $Productid , $Variationid , $itemquantity , $orderuserid , '' , '' , $order_id , $item , $reasonindetail , $payment_price ) ;
					}
				}
