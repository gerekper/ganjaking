	...
	class RSFunctionForPointURL {
		...
		public static function award_points_for_url_click() {
			...
			if ( ! in_array( $UserId , ( array ) $URLUsedBy ) ) {
				...
				<div class="sk_failure_msg_for_pointsurl"><?php echo wp_kses_post(get_option( 'failure_msg_for_accessed_url' , 'You cannot get coupon for this link because you have already claimed') ); ?></div>
				<?php
			}
		}
