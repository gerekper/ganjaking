...
jQuery( function ( $ ) {
    'use strict' ;
    var KeyupValidationinProductSettings = {
        init : function ( ) {
            this.toggle_export_user_avail_points_for_report_module() ;
            $( document ).on( 'change' , 'input[name=rs_export_user_report_option]:radio' , this.toggle_export_user_avail_points_for_report_module ) ; // Show or hide Settings for Report in CSV Tab - Start.
            ...
            if ( '2' === $( 'input[name=rs_export_user_report_option]:checked' ).val() ) {
                $( '#rs_export_users_report_list' ).closest( 'tr' ).show() ;
                $( '#rs_export_user_roles_report_list' ).closest( 'tr' ).hide() ;
            } else if ( '3' === $( 'input[name=rs_export_user_report_option]:checked' ).val() ) {
                $( '#rs_export_users_report_list' ).closest( 'tr' ).hide() ;
                $( '#rs_export_user_roles_report_list' ).closest( 'tr' ).show() ;
            } else {
                $( '#rs_export_users_report_list' ).closest( 'tr' ).hide() ;
                $( '#rs_export_user_roles_report_list' ).closest( 'tr' ).hide() ;
            }
        ...
        toggle_export_user_avail_points_for_report_module : function ( ) {
            if ( '2' === $( 'input[name=rs_export_user_report_option]:checked' ).val() ) {
                $( '#rs_export_users_report_list' ).closest( 'tr' ).show() ;
                $( '#rs_export_user_roles_report_list' ).closest( 'tr' ).hide() ;
            } else if ( '3' === $( 'input[name=rs_export_user_report_option]:checked' ).val() ) {
    ...
    KeyupValidationinProductSettings.init( ) ;
} ) ;