...
class WC_Stamps_Order {
	...
	public function __construct() {
		...
		$this->package_types = array(
			...
			'Flat Rate Box'             => __( 'USPS medium flat rate box. A special 11" x 8 1/2" x 5 1/2" or 14" x 3.5" x 12" USPS box that clearly indicates "Medium Flat Rate Box"', 'woocommerce-shipping-stamps' ),
