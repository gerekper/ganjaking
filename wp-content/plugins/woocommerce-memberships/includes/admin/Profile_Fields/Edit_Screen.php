...
class Edit_Screen {
	...
	public function render_data_meta_box() {
		...
		require_once( wc_memberships()->get_plugin_path() . '/includes/admin/Views/Meta_Boxes/Profile_Field/Data.php' );
	...
	public function render_publish_meta_box() {
		...
		require_once( wc_memberships()->get_plugin_path() . '/includes/admin/Views/Meta_Boxes/Profile_Field/Publish.php' );
