...
class My_Account {
	...
	public function __construct() {
		...
		$this->members_area        = wc_memberships()->load_class( '/includes/frontend/My_Account/Members_Area.php',        Members_Area::class );
		$this->profile_fields_area = wc_memberships()->load_class( '/includes/frontend/My_Account/Profile_Fields_Area.php', Profile_Fields_Area::class );
