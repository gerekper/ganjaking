...
return [
    ...
    // Deprecated Shoporder columns
    Column\Product\ShopOrder\AvgOrderInterval::class,
    Column\Product\ShopOrder\Customers::class,
    Column\Product\ShopOrder\OrderCount::class,
    Column\Product\ShopOrder\OrderTotal::class,
