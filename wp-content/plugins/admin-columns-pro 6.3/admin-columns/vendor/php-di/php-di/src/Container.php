...
use AC\Vendor\DI\Definition\FactoryDefinition;
use AC\Vendor\DI\Definition\Helper\DefinitionHelper;
use AC\Vendor\DI\Definition\InstanceDefinition;
use AC\Vendor\DI\Definition\ObjectDefinition;
use AC\Vendor\DI\Definition\Resolver\DefinitionResolver;
use AC\Vendor\DI\Definition\Resolver\ResolverDispatcher;
use AC\Vendor\DI\Definition\Source\DefinitionArray;
use AC\Vendor\DI\Definition\Source\MutableDefinitionSource;
use AC\Vendor\DI\Definition\Source\ReflectionBasedAutowiring;
use AC\Vendor\DI\Definition\Source\SourceChain;
use AC\Vendor\DI\Definition\ValueDefinition;
use AC\Vendor\DI\Invoker\DefinitionParameterResolver;
use AC\Vendor\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use AC\Vendor\Invoker\Invoker;
use AC\Vendor\Invoker\InvokerInterface;
use AC\Vendor\Invoker\ParameterResolver\AssociativeArrayResolver;
use AC\Vendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use AC\Vendor\Invoker\ParameterResolver\DefaultValueResolver;
use AC\Vendor\Invoker\ParameterResolver\NumericArrayResolver;
