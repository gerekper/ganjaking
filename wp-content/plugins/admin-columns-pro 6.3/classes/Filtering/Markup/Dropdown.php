...
class Dropdown extends Select
{
    ...
    public const OPTION_EMPTY = 'cpac_empty';
    public const OPTION_NON_EMPTY = 'cpac_nonempty';
    public const OPTION_FILTER = 'acp_filter';
    ...
    public function render(): string
    {
		...
		<label for=" <?= esc_attr($this->get_id()) ?>" class="screen-reader-text">
            <?= sprintf(__('Filter by %s', 'codepress-admin-columns'), $this->get_label()) ?>
		</label>
