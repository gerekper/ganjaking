...
require_once( wc_local_pickup_plus()->get_plugin_path() . '/includes/functions/wc-local-pickup-plus-pickup-locations-functions.php' );
require_once( wc_local_pickup_plus()->get_plugin_path() . '/includes/functions/wc-local-pickup-plus-product-functions.php' );
require_once( wc_local_pickup_plus()->get_plugin_path() . '/includes/functions/wc-local-pickup-plus-user-functions.php' );
