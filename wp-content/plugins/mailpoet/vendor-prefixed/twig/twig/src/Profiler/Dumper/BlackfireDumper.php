<?php
 namespace MailPoetVendor\Twig\Profiler\Dumper; if (!defined('ABSPATH')) exit; use MailPoetVendor\Twig\Profiler\Profile; final class BlackfireDumper { public function dump(Profile $profile) { $data = []; $this->dumpProfile('main()', $profile, $data); $this->dumpChildren('main()', $profile, $data); $start = \sprintf('%f', \microtime(\true)); $str = <<<EOF
