...
use MailPoetVendor\Egulias\EmailValidator\Result\Reason\DotAtEnd;
use MailPoetVendor\Egulias\EmailValidator\Result\Reason\DotAtStart;
...
use MailPoetVendor\Egulias\EmailValidator\Result\Reason\LabelTooLong;
use MailPoetVendor\Egulias\EmailValidator\Result\Reason\NoDomainPart;
use MailPoetVendor\Egulias\EmailValidator\Result\Reason\ConsecutiveAt;
use MailPoetVendor\Egulias\EmailValidator\Result\Reason\DomainTooLong;
use MailPoetVendor\Egulias\EmailValidator\Result\Reason\CharNotAllowed;
use MailPoetVendor\Egulias\EmailValidator\Result\Reason\DomainHyphened;
use MailPoetVendor\Egulias\EmailValidator\Result\Reason\ExpectingATEXT;
use MailPoetVendor\Egulias\EmailValidator\Parser\CommentStrategy\DomainComment;
use MailPoetVendor\Egulias\EmailValidator\Result\Reason\ExpectingDomainLiteralClose;
use MailPoetVendor\Egulias\EmailValidator\Parser\DomainLiteral as DomainLiteralParser;
