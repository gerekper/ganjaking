...
";
    ...
    public function block_translations($context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 28
        echo $this->extensions['MailPoet\Twig\I18n']->localize(["noMailChimpLists" => $this->extensions['MailPoet\Twig\I18n']->translate("No active lists found"), "serverError" => $this->extensions['MailPoet\Twig\I18n']->translate("Server error:"), "select" => $this->extensions['MailPoet\Twig\I18n']->translate("Select", "Form input type"), "wrongFileFormat" => $this->extensions['MailPoet\Twig\I18n']->translate("Only comma-separated (CSV) file formats are supported."), "maxPostSizeNotice" => \MailPoetVendor\twig_replace_filter($this->extensions['MailPoet\Twig\I18n']->translate("Your CSV is over %s and is too big to process. Please split the file into two or more sections."), ["%s" =>         // line 33
...
";
    ...
    {
        return array (  112 => 133,  110 => 33,  109 => 28,  105 => 27,  98 => 22,  94 => 21,  90 => 20,  85 => 18,  81 => 17,  77 => 16,  70 => 11,  68 => 10,  62 => 7,  58 => 6,  54 => 4,  50 => 3,  45 => 2,  43 => 1,  36 => 2,);
    }
