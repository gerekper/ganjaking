...
class Header
{
     ...
     */
    public function __construct($elements = array(), \SearchWP\Dependencies\Smalot\PdfParser\Document $document = null)
    {
    ...
    public function get($name)
    {
        ...
        return new \SearchWP\Dependencies\Smalot\PdfParser\Element\ElementMissing(null, null);
    }
    /**
    ...
    {
        if (($obj = $this->elements[$name]) instanceof \SearchWP\Dependencies\Smalot\PdfParser\Element\ElementXRef && !\is_null($this->document)) {
            /** @var ElementXRef $obj */
