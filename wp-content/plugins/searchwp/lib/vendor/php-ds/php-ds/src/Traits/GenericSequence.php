...
namespace SearchWP\Dependencies\Ds\Traits;

use SearchWP\Dependencies\Ds\Sequence;
...
trait GenericSequence
{
     ...
     * @inheritdoc
     */
    public function merge($values) : \SearchWP\Dependencies\Ds\Sequence
    {
        $copy = $this->copy();
        $copy->pushAll($values);
        return $copy;
     ...
     * @inheritDoc
     */
    public function filter(callable $callback = null) : \SearchWP\Dependencies\Ds\Sequence
    {
    ...
    {
        return \array_search($value, $this->array, \true);
    }
    /**
     * @inheritDoc
     */
     ...
     * @inheritDoc
     */
    public function map(callable $callback) : \SearchWP\Dependencies\Ds\Sequence
    {
     ...
     * @inheritDoc
     */
    public function reversed() : \SearchWP\Dependencies\Ds\Sequence
    {
     ...
     * @inheritDoc
     */
    public function slice(int $offset, int $length = null) : \SearchWP\Dependencies\Ds\Sequence
    {
        if (\func_num_args() === 1) {
            $length = \count($this);
        }
     ...
     * @inheritDoc
     */
    public function sorted(callable $comparator = null) : \SearchWP\Dependencies\Ds\Sequence
    {
        $copy = $this->copy();
