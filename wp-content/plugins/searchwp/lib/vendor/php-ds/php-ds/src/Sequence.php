 ...
 * @package Ds
 */
interface Sequence extends \SearchWP\Dependencies\Ds\Collection
{
    /**
     ...
     * @return Sequence
     */
    function filter(callable $callback = null) : \SearchWP\Dependencies\Ds\Sequence;
    /**
     ...
     * @return Sequence
     */
    function map(callable $callback) : \SearchWP\Dependencies\Ds\Sequence;
    /**
     ...
     * @return Sequence
     */
    function merge($values) : \SearchWP\Dependencies\Ds\Sequence;
    /**
     ...
     * @return Sequence
     */
    function slice(int $index, int $length = null) : \SearchWP\Dependencies\Ds\Sequence;
    /**
     ...
     * @return Sequence
     */
    function sorted(callable $comparator = null) : \SearchWP\Dependencies\Ds\Sequence;
    /**
