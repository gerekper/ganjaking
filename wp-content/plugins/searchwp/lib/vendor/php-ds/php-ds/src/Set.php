 ...
 * @package Ds
 */
final class Set implements \IteratorAggregate, \ArrayAccess, \SearchWP\Dependencies\Ds\Collection
{
    use Traits\GenericCollection;
    const MIN_CAPACITY = \SearchWP\Dependencies\Ds\Map::MIN_CAPACITY;
    /**
    ...
    {
        $this->table = new \SearchWP\Dependencies\Ds\Map();
        if (\func_num_args()) {
            $this->add(...$values);
        }
    }
     ...
     * @inheritDoc
     */
    public function copy() : \SearchWP\Dependencies\Ds\Collection
    {
     ...
     * @return Set
     */
    public function diff(\SearchWP\Dependencies\Ds\Set $set) : \SearchWP\Dependencies\Ds\Set
    {
     ...
     * @return Set
     */
    public function xor(\SearchWP\Dependencies\Ds\Set $set) : \SearchWP\Dependencies\Ds\Set
    {
     ...
     * @return Set
     */
    public function filter(callable $callback = null) : \SearchWP\Dependencies\Ds\Set
    {
     ...
     * @return Set
     */
    public function intersect(\SearchWP\Dependencies\Ds\Set $set) : \SearchWP\Dependencies\Ds\Set
    {
     ...
     * @return Set
     */
    public function reversed() : \SearchWP\Dependencies\Ds\Set
    {
        $reversed = $this->copy();
     ...
     * @return Set
     */
    public function slice(int $offset, int $length = null) : \SearchWP\Dependencies\Ds\Set
    {
        $sliced = new self();
     ...
     * @return Set
     */
    public function sorted(callable $comparator = null) : \SearchWP\Dependencies\Ds\Set
    {
        $sorted = $this->copy();
     ...
     * @return \Ds\Set
     */
    public function merge($values) : \SearchWP\Dependencies\Ds\Set
    {
        $merged = $this->copy();
        foreach ($values as $value) {
            $merged->add($value);
     ...
     * @return Set
     */
    public function union(\SearchWP\Dependencies\Ds\Set $set) : \SearchWP\Dependencies\Ds\Set
    {
        $union = new self();
        foreach ($this as $value) {
            $union->add($value);
