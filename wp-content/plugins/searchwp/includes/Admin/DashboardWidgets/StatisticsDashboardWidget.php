...
class StatisticsDashboardWidget {
	...
	public static function add() {
		wp_add_dashboard_widget(
			...
			sprintf( __( 'Search Statistics %d Day Overview', 'searchwp' ), self::$days ), // Translators: placeholder is a number of days.
			[ __CLASS__, 'view' ]
		);
	}
	...
	public static function view() {
		...
		<script>
			jQuery(document).ready(function($){
				$('#searchwp-admin-dashboard-widget-statistics').tabs();
		...
		<style>
			...
			.searchwp-admin-dashboard-widget-statistics .ui-tabs-nav {
				list-style: none;
				margin: 0;
				padding: 0 2em 0 0;
				position: relative;
			...
			.searchwp-admin-dashboard-widget-statistics .ui-tabs-nav:after {
				display: block;
				position: absolute;
				top: -4em;
			...
			.searchwp-admin-dashboard-widget-statistics .ui-state-default:not(.ui-tabs-active) a {
				color: inherit !important;
			}

			.searchwp-admin-dashboard-widget-statistics .ui-tabs-anchor {
				display: flex;
			}

			.searchwp-admin-dashboard-widget-statistics .ui-tabs-anchor span {
				display: block;
				line-height: 1.5;
			}

			.searchwp-admin-dashboard-widget-statistics .ui-tabs-anchor span.dashicons {
				line-height: 1;
				visibility: hidden;
			}

			.searchwp-admin-dashboard-widget-statistics .ui-tabs-active .ui-tabs-anchor span.dashicons {
				visibility: visible;
			}
