...
use WooCommercePDFInvoice\Css\Style;
use WooCommercePDFInvoice\Dompdf;
use WooCommercePDFInvoice\Exception;
use WooCommercePDFInvoice\Frame;
use WooCommercePDFInvoice\FrameDecorator\AbstractFrameDecorator;
use DOMXPath;
use WooCommercePDFInvoice\FrameDecorator\Page as PageFrameDecorator;
use WooCommercePDFInvoice\FrameReflower\Page as PageFrameReflower;
...
class Factory
{
    ...
    static function decorate_frame(Frame $frame, Dompdf $dompdf, Frame $root = null)
    {
        ...
        $decorator  = "WooCommercePDFInvoice\\FrameDecorator\\$decorator";
        $reflower   = "WooCommercePDFInvoice\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance($type)
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\WooCommercePDFInvoice\\Positioner\\'.$type;
