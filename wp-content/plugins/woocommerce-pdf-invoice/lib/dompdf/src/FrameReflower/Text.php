 ...
 */
namespace WooCommercePDFInvoice\FrameReflower;

use WooCommercePDFInvoice\FrameDecorator\Block as BlockFrameDecorator;
use WooCommercePDFInvoice\FrameDecorator\Text as TextFrameDecorator;
use WooCommercePDFInvoice\FontMetrics;
        ...
        if ($split !== false) {
            ...
            if ($split == 0 && !$frame->is_pre() && empty(trim($text))) {
                ...
                if (($sibling = $frame->get_prev_sibling()) !== null) {
                    if ($sibling instanceof \WooCommercePDFInvoice\FrameDecorator\Text && !$sibling->is_pre()) {
                        $st = $sibling->get_text();
            ...
            $is_inline_frame = ($parent instanceof \WooCommercePDFInvoice\FrameDecorator\Inline);
