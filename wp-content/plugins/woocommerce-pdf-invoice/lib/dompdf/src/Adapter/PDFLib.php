 ...
 *
 * WooCommercePDFInvoice\Adapter\PDFLib provides a simple, stateless interface to the one
 * provided by PDFLib.
 *
...
class PDFLib implements Canvas
{
     ...
     * @var array;
     */
    static public $PAPER_SIZES = array(); // Set to WooCommercePDFInvoice\Adapter\CPDF::$PAPER_SIZES below.
     ...
     * Class constructor
     *
     * @param mixed $paper The size of paper to use either a string (see {@link WooCommercePDFInvoice\Adapter\CPDF::$PAPER_SIZES}) or
