...
namespace WooCommercePDFInvoice\Adapter;

use WooCommercePDFInvoice\Canvas;
use WooCommercePDFInvoice\Dompdf;
use WooCommercePDFInvoice\Helpers;
use WooCommercePDFInvoice\Exception;
use WooCommercePDFInvoice\Image\Cache;
use WooCommercePDFInvoice\PhpEvaluator;
...
class CPDF implements Canvas
{
    ...
    public function select($x, $y, $w, $h, $font, $size, $color = [0, 0, 0], $opts = [])
    {
        ...
        $ft = \WooCommercePDFInvoice\Cpdf::ACROFORM_FIELD_CHOICE;
        $ff = \WooCommercePDFInvoice\Cpdf::ACROFORM_FIELD_CHOICE_COMBO;
    ...
    public function textarea($x, $y, $w, $h, $font, $size, $color = [0, 0, 0])
    {
        ...
        $ft = \WooCommercePDFInvoice\Cpdf::ACROFORM_FIELD_TEXT;
        $ff = \WooCommercePDFInvoice\Cpdf::ACROFORM_FIELD_TEXT_MULTILINE;
    ...
    public function input($x, $y, $w, $h, $type, $font, $size, $color = [0, 0, 0])
    {
        ...
        switch($type) {
            ...
            case 'password':
                $ft = \WooCommercePDFInvoice\Cpdf::ACROFORM_FIELD_TEXT;
                $ff = \WooCommercePDFInvoice\Cpdf::ACROFORM_FIELD_TEXT_PASSWORD;
                break;
            case 'submit':
                $ft = \WooCommercePDFInvoice\Cpdf::ACROFORM_FIELD_BUTTON;
                break;
        }
