...
printf( __( 'If you would like to remove your email address from the waitlist you can do so by clicking %shere%s.', 'woocommerce-waitlist' ), '<a href="' . esc_attr( $product_link ) . '">', '</a>' );
echo "\n\n";
