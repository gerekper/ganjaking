...
$background_color_left  = YITH_Popup()->get_meta( $theme . '_body_bg_color_left', $popup_id );
$background_color_right = YITH_Popup()->get_meta( $theme . '_body_bg_color_right', $popup_id );

$content_left_link_color       = YITH_Popup()->get_meta( $theme . '_content_left_link_color', $popup_id );
$content_left_link_color_hover = YITH_Popup()->get_meta( $theme . '_content_left_link_color_hover', $popup_id );
$content_left_text_color       = YITH_Popup()->get_meta( $theme . '_left_text_color', $popup_id );

$content_right_link_color       = YITH_Popup()->get_meta( $theme . '_content_right_link_color', $popup_id );
$content_right_link_color_hover = YITH_Popup()->get_meta( $theme . '_content_right_link_color_hover', $popup_id );
$content_right_text_color       = YITH_Popup()->get_meta( $theme . '_right_text_color', $popup_id );
...
<style>
	...
	.ypop-content{
		background-color: <?php echo esc_attr( $background_color_left ); ?>;
		display: inline-block;
	}

	.ypop-left, .ypop-checkzone{
		color: <?php echo esc_attr( $content_left_text_color ); ?>;
	}
	...
	.ypop-right{
		background-color: <?php echo esc_attr( $background_color_right ); ?>;
		color: <?php echo esc_attr( $content_right_text_color ); ?>;
	}

	.ypop-left a{
		color: <?php echo esc_attr( $content_left_link_color ); ?>;
	}

	.ypop-left a:hover{
		color: <?php echo esc_attr( $content_left_link_color_hover ); ?>;
	}

	.ypop-right a{
		color: <?php echo esc_attr( $content_right_link_color ); ?>;
	}

	.ypop-right a:hover{
		color: <?php echo esc_attr( $content_right_link_color_hover ); ?>;
	}
			...
			<div class="ypop-container-inner">
				...
				<div class="ypop-content-wrapper">
					<div class="ypop-content">
							...
							<div class="ypop-left">
								<div class="ypop-left-custom-content"><?php echo do_shortcode( $left_content ); ?></div>
