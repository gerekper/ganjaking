...
* Copyright: (C) 2013 - 2020 José Conti
*/
class WC_Gateway_Webservice_Redsys extends WC_Payment_Gateway {
	...
	*/
	public function __construct() {
		...
		$this->method_title         = __( 'Webservice Redsys PSD2 (by José Conti)', 'woocommerce-redsys' );
		$this->method_description   = __( 'Webservice Redsys PSD2 works addig a Credit Card Form at the Checkout.', 'woocommerce-redsys' );
	...
	*/
	function check_user_test_mode( $userid ) {
		...
		$selections = (array)$this->get_option( 'testforuserid' );
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', '/****************************/' );
			$this->log->add( 'webserviceredsys', '     Checking user test       ' );
			$this->log->add( 'webserviceredsys', '/****************************/' );
			$this->log->add( 'webserviceredsys', ' ' );
		}
		...
		if ( 'yes' === $usertest_active ) {
			...
			if ( ! empty( $selections ) ) {
				foreach ( $selections as $user_id ) {
					if ( 'yes' === $this->debug ) {
						$this->log->add( 'webserviceredsys', ' ' );
						$this->log->add( 'webserviceredsys', '/****************************/' );
						$this->log->add( 'webserviceredsys', '   Checking user ' . $userid    );
						$this->log->add( 'webserviceredsys', '/****************************/' );
						$this->log->add( 'webserviceredsys', ' ' );
						$this->log->add( 'webserviceredsys', ' ' );
						$this->log->add( 'webserviceredsys', '/****************************/' );
						$this->log->add( 'webserviceredsys', '  User in forach ' . $user_id   );
						$this->log->add( 'webserviceredsys', '/****************************/' );
						$this->log->add( 'webserviceredsys', ' ' );
					}
					if ( (string)$user_id === (string)$userid ) {
						if ( 'yes' === $this->debug ) {
							$this->log->add( 'webserviceredsys', ' ' );
							$this->log->add( 'webserviceredsys', '/****************************/' );
							$this->log->add( 'webserviceredsys', '   Checking user test TRUE    ' );
							$this->log->add( 'webserviceredsys', '/****************************/' );
							$this->log->add( 'webserviceredsys', ' ' );
							$this->log->add( 'webserviceredsys', ' ' );
							$this->log->add( 'webserviceredsys', '/********************************************/' );
							$this->log->add( 'webserviceredsys', '  User ' . $userid . ' is equal to ' . $user_id );
							$this->log->add( 'webserviceredsys', '/********************************************/' );
							$this->log->add( 'webserviceredsys', ' ' );
						}
						return true;
					...
					if ( 'yes' === $this->debug ) {
						$this->log->add( 'webserviceredsys', ' ' );
						$this->log->add( 'webserviceredsys', '/****************************/' );
						$this->log->add( 'webserviceredsys', '  Checking user test continue ' );
						$this->log->add( 'webserviceredsys', '/****************************/' );
						$this->log->add( 'webserviceredsys', ' ' );
					}
					continue;
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '/****************************/' );
					$this->log->add( 'webserviceredsys', '  Checking user test FALSE    ' );
					$this->log->add( 'webserviceredsys', '/****************************/' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
				return false;
			...
			if ( 'yes' === $this->debug ) {
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', '/****************************/' );
				$this->log->add( 'webserviceredsys', '     User test Disabled.      ' );
				$this->log->add( 'webserviceredsys', '/****************************/' );
				$this->log->add( 'webserviceredsys', ' ' );
			}
			return false;
		...
		if ( 'yes' === $this->testmode ) {
			if ( 'rd' === $type ) {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '/****************************/' );
					$this->log->add( 'webserviceredsys', '          URL Test RD         ' );
					$this->log->add( 'webserviceredsys', '/****************************/' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
				$url = $this->testurl;
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '/****************************/' );
					$this->log->add( 'webserviceredsys', '          URL Test WS         ' );
					$this->log->add( 'webserviceredsys', '/****************************/' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
				$url = $this->testurlws;
			...
			if ( $user_test ) {
				...
				if ( 'rd' === $type ) {
					if ( 'yes' === $this->debug ) {
						$this->log->add( 'webserviceredsys', ' ' );
						$this->log->add( 'webserviceredsys', '/****************************/' );
						$this->log->add( 'webserviceredsys', '          URL Live RD         ' );
						$this->log->add( 'webserviceredsys', '/****************************/' );
						$this->log->add( 'webserviceredsys', ' ' );
					}
					$url = $this->liveurl;
					...
					if ( 'yes' === $this->debug ) {
						$this->log->add( 'webserviceredsys', ' ' );
						$this->log->add( 'webserviceredsys', '/****************************/' );
						$this->log->add( 'webserviceredsys', '          URL Live WS         ' );
						$this->log->add( 'webserviceredsys', '/****************************/' );
						$this->log->add( 'webserviceredsys', ' ' );
					}
					$url = $this->liveurlws;
	...
	function get_redsys_sha256( $user_id ) {
		...
		if ( 'yes' === $this->testmode ) {
			if ( 'yes' === $this->debug ) {
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', '/****************************/' );
				$this->log->add( 'webserviceredsys', '         SHA256 Test.         ' );
				$this->log->add( 'webserviceredsys', '/****************************/' );
				$this->log->add( 'webserviceredsys', ' ' );
			}
			...
			if ( $user_test ) {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '/****************************/' );
					$this->log->add( 'webserviceredsys', '      USER SHA256 Test.       ' );
					$this->log->add( 'webserviceredsys', '/****************************/' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
				$customtestsha256 = utf8_decode( $this->customtestsha256 );
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '/****************************/' );
					$this->log->add( 'webserviceredsys', '     USER SHA256 NOT Test.    ' );
					$this->log->add( 'webserviceredsys', '/****************************/' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
	...
	*/
	function get_redsys_args( $order ) {
		...
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', 'Generating payment form for order ' . $order->get_order_number() . '. Sent data: ' . print_r( $redsys_args, true ) );
			$this->log->add( 'webserviceredsys', 'Helping to understand the encrypted code: ' );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_AMOUNT: ' . $order_total_sign );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_ORDER: ' . $transaction_id2 );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_MERCHANTCODE: ' . $this->customer );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_CURRENCY' . $currency_codes[ get_woocommerce_currency() ] );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_TRANSACTIONTYPE: ' . $transaction_type );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_TERMINAL: ' . $dsmerchantterminal );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_MERCHANTURL: ' . $final_notify_url );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_URLOK: ' . add_query_arg( 'utm_nooverride', '1', $this->get_return_url( $order ) ) );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_URLKO: ' . $returnfromredsys );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_CONSUMERLANGUAGE: ' . $gatewaylanguage );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_PRODUCTDESCRIPTION: ' . __( 'Order', 'woo-redsys-gateway-light' ) . ' ' . $order->get_order_number() );
			$this->log->add( 'webserviceredsys', 'DS_MERCHANT_PAYMETHODS: z' );
		}
	...
	*/
	function generate_redsys_form( $order_id ) {
		...
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', '/****************************/' );
			$this->log->add( 'webserviceredsys', '   Generating Redsys Form     ' );
			$this->log->add( 'webserviceredsys', '/****************************/' );
			$this->log->add( 'webserviceredsys', ' ' );
		}
	...
	*/
	function check_ipn_request_is_valid() {
		...
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', 'HTTP Notification received: ' . print_r( $_POST, true ) );
		}
		...
		if ( $usesecretsha256 ) {
			...
			if ( 'yes' === $this->debug ) {
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', 'Signature from Redsys: ' . $remote_sign );
				$this->log->add( 'webserviceredsys', 'Name transient remote: redsys_signature_' . sanitize_title( $order_id ) );
				$this->log->add( 'webserviceredsys', 'Secret SHA256 transcient: ' . $secretsha256 );
				$this->log->add( 'webserviceredsys', ' ' );
			}

			if ( 'yes' === $this->debug ) {
				$order_id = $miObj->getParameter( 'Ds_Order' );
				$this->log->add( 'webserviceredsys', 'Order ID: ' . $order_id );
			}
			...
			if ( empty( $secretsha256 ) &&  ! $secretsha256_meta ) {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', 'Using $usesecretsha256 Settings' );
					$this->log->add( 'webserviceredsys', 'Secret SHA256 Settings: ' . $usesecretsha256 );
					$this->log->add( 'webserviceredsys', ' ' );
				}
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', 'Using $secretsha256_meta Meta' );
					$this->log->add( 'webserviceredsys', 'Secret SHA256 Meta: ' . $secretsha256_meta );
					$this->log->add( 'webserviceredsys', ' ' );
				}
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', 'Using $secretsha256 Transcient' );
					$this->log->add( 'webserviceredsys', 'Secret SHA256 Transcient: ' . $secretsha256 );
					$this->log->add( 'webserviceredsys', ' ' );
				}
			...
			if ( $localsecret === $remote_sign ) {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', 'Received valid notification from Servired/RedSys' );
					$this->log->add( 'webserviceredsys', $data );
				}
				return true;
			} else {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', 'Received INVALID notification from Servired/RedSys' );
				}
			...
			if ( $_POST['Ds_MerchantCode'] === $this->customer ) {
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', 'Received INVALID notification from Servired/RedSys' );
					$this->log->add( 'webserviceredsys', '$remote_sign: ' . $remote_sign );
					$this->log->add( 'webserviceredsys', '$localsecret: ' . $localsecret );
				}
				return false;
			}
		}
	...
	*/
	function successful_request( $posted ) {
		...
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', '/****************************/' );
			$this->log->add( 'webserviceredsys', '      successful_request      ' );
			$this->log->add( 'webserviceredsys', '/****************************/' );
			$this->log->add( 'webserviceredsys', ' ' );
		}
		...
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', '$version: ' . $version );
			$this->log->add( 'webserviceredsys', '$data: ' . $data );
			$this->log->add( 'webserviceredsys', '$remote_sign: ' . $remote_sign );
			$this->log->add( 'webserviceredsys', ' ' );
		}
		...
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', 'SHA256 Settings: ' . $usesecretsha256 );
			$this->log->add( 'webserviceredsys', 'SHA256 Transcient: ' . $secretsha256 );
			$this->log->add( 'webserviceredsys', 'decodeMerchantParameters: ' . $decodedata );
			$this->log->add( 'webserviceredsys', 'createMerchantSignatureNotif: ' . $localsecret );
			$this->log->add( 'webserviceredsys', 'Ds_Amount: ' . $total );
			$this->log->add( 'webserviceredsys', 'Ds_Order: ' . $ordermi );
			$this->log->add( 'webserviceredsys', 'Ds_MerchantCode: ' . $dscode );
			$this->log->add( 'webserviceredsys', 'Ds_Currency: ' . $currency_code );
			$this->log->add( 'webserviceredsys', 'Ds_Response: ' . $response );
			$this->log->add( 'webserviceredsys', 'Ds_AuthorisationCode: ' . $id_trans );
			$this->log->add( 'webserviceredsys', 'Ds_Date: ' . $dsdate );
			$this->log->add( 'webserviceredsys', 'Ds_Hour: ' . $dshour );
			$this->log->add( 'webserviceredsys', 'Ds_Terminal: ' . $dstermnal );
			$this->log->add( 'webserviceredsys', 'Ds_MerchantData: ' . $dsmerchandata );
			$this->log->add( 'webserviceredsys', 'Ds_SecurePayment: ' . $dssucurepayment );
			$this->log->add( 'webserviceredsys', 'Ds_Card_Country: ' . $dscardcountry );
			$this->log->add( 'webserviceredsys', 'Ds_ConsumerLanguage: ' . $dsconsumercountry );
			$this->log->add( 'webserviceredsys', 'Ds_Card_Type: ' . $dscargtype );
			$this->log->add( 'webserviceredsys', 'Ds_TransactionType: ' . $dstransactiontype );
			$this->log->add( 'webserviceredsys', 'Ds_Merchant_Identifiers_Amount: ' . $response );
			$this->log->add( 'webserviceredsys', 'Ds_Card_Brand: ' . $dscardbrand );
			$this->log->add( 'webserviceredsys', 'Ds_MerchantData: ' . $dsmechandata );
			$this->log->add( 'webserviceredsys', 'Ds_ErrorCode: ' . $dserrorcode );
			$this->log->add( 'webserviceredsys', 'Ds_PayMethod: ' . $dpaymethod );
		}
		...
		if ( '3' === $dstransactiontype ) {
			if ( 900 === $response ) {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', 'Response 900 (refund)' );
				}
				set_transient( $order->get_id() . '_redsys_refund', 'yes' );

				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', 'update_post_meta to "refund yes"' );
				}
				$status = $order->get_status();
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', 'New Status in request: ' . $status );
				}
		...
		if ( $response <= 99 ) {
			...
			if ( $order_total_compare !== $total ) {
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', 'Payment error: Amounts do not match (order: ' . $order_total_compare . ' - received: ' . $total . ')' );
				}
			...
			if ( 'yes' === $this->debug ) {
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', '/****************************/' );
				$this->log->add( 'webserviceredsys', '      Saving Order Meta       ' );
				$this->log->add( 'webserviceredsys', '/****************************/' );
				$this->log->add( 'webserviceredsys', ' ' );
			}
			if ( ! empty( $order1 ) ) {
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', '_payment_order_number_redsys saved: ' . $order1 );
				}
			} else {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '_payment_order_number_redsys NOT SAVED!!!' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
			}
			if ( ! empty( $dsdate ) ) {
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', '_payment_date_redsys saved: ' . $dsdate );
				}
			} else {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '_payment_date_redsys NOT SAVED!!!' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
			}
			if ( ! empty( $dsdate ) ) {
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', '_payment_terminal_redsys saved: ' . $dstermnal );
				}
			} else {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '_payment_terminal_redsys NOT SAVED!!!' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
			}
			if ( ! empty( $dshour ) ) {
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', '_payment_hour_redsys saved: ' . $dshour );
				}
			} else {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '_payment_hour_redsys NOT SAVED!!!' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
			}
			if ( ! empty( $id_trans ) ) {
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', '_authorisation_code_redsys saved: ' . $authorisation_code );
				}
			} else {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '_authorisation_code_redsys NOT SAVED!!!' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
			}
			if ( ! empty( $currency_code ) ) {
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', '_corruncy_code_redsys saved: ' . $currency_code );
				}
			} else {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '_corruncy_code_redsys NOT SAVED!!!' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
			}
			if ( ! empty( $dscardcountry ) ) {
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', '_card_country_redsys saved: ' . $dscardcountry );
				}
			} else {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '_card_country_redsys NOT SAVED!!!' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
			}
			if ( ! empty( $dscargtype ) ) {
				...
				if ( 'yes' === $this->debug ) {
				 $this->log->add( 'webserviceredsys', '_card_type_redsys saved: ' . $dscargtype );
				}
			} else {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '_card_type_redsys NOT SAVED!!!' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
			}
			...
			if ( ! empty( $secretsha256 ) ) {
				...
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', '_redsys_secretsha256 saved: ' . $secretsha256 );
				}
			} else {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '_redsys_secretsha256 NOT SAVED!!!' );
					$this->log->add( 'webserviceredsys', ' ' );
				}
			}
			// Payment completed.
			...
			if ( 'yes' === $this->debug ) {
				$this->log->add( 'webserviceredsys', 'Payment complete.' );
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', '/******************************************/' );
				$this->log->add( 'webserviceredsys', '  The final has come, this story has ended  ' );
				$this->log->add( 'webserviceredsys', '/******************************************/' );
				$this->log->add( 'webserviceredsys', ' ' );
			}
		} else {
			...
			if ( 'yes' === $this->debug ) {
				if ( $ds_response_value ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', $ds_response_value );
				}
				if ( $ds_error_value ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', $ds_error_value );
				}
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', '/******************************************/' );
				$this->log->add( 'webserviceredsys', '  The final has come, this story has ended  ' );
	...
	*/
	function ask_for_refund( $order_id, $transaction_id, $amount ) {
		...
		if ( 'yes' === $this->debug ) {
			...
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', '/**************************/' );
			$this->log->add( 'webserviceredsys', __( 'Starting asking for Refund', 'woocommerce-redsys' ) );
			$this->log->add( 'webserviceredsys', '/**************************/' );
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', __( 'Terminal : ', 'woocommerce-redsys' ) . $terminal );
		}
		$transaction_type  = '3';
		...
		if ( $secretsha256_meta ) {
			...
			if ( 'yes' === $this->debug ) {
				$this->log->add( 'webserviceredsys', __( 'Using meta for SHA256', 'woocommerce-redsys' ) );
				$this->log->add( 'webserviceredsys', __( 'The SHA256 Meta is: ', 'woocommerce-redsys' ) . $secretsha256 );
				}
		} else {
			$secretsha256 = $secretsha256;
			if ( 'yes' === $this->debug ) {
				$this->log->add( 'webserviceredsys', __( 'Using settings for SHA256', 'woocommerce-redsys' ) );
				$this->log->add( 'webserviceredsys', __( 'The SHA256 settings is: ', 'woocommerce-redsys' ) . $secretsha256 );
			}
		}
		if ( 'yes' === $this->not_use_https ) {
			$final_notify_url = $this->notify_url_not_https;
		...
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', __( 'All data from meta', 'woocommerce-redsys' ) );
			$this->log->add( 'webserviceredsys', '**********************' );
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', __( 'If something is empty, the data was not saved', 'woocommerce-redsys' ) );
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', __( 'All data from meta', 'woocommerce-redsys' ) );
			$this->log->add( 'webserviceredsys', __( 'Authorization Code : ', 'woocommerce-redsys' ) . $autorization_code );
			$this->log->add( 'webserviceredsys', __( 'Authorization Date : ', 'woocommerce-redsys' ) . $autorization_date );
			$this->log->add( 'webserviceredsys', __( 'Currency Codey : ', 'woocommerce-redsys' ) . $currencycode );
			$this->log->add( 'webserviceredsys', __( 'Terminal : ', 'woocommerce-redsys' ) . $terminal );
			$this->log->add( 'webserviceredsys', __( 'SHA256 : ', 'woocommerce-redsys' ) . $secretsha256_meta );
		...
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', __( 'Data sent to Redsys for refund', 'woocommerce-redsys' ) );
			$this->log->add( 'webserviceredsys', '*********************************' );
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', __( 'URL to Redsys : ', 'woocommerce-redsys' ) . $redsys_adr );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_AMOUNT : ', 'woocommerce-redsys' ) . $amount );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_ORDER : ', 'woocommerce-redsys' ) . $transaction_id );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_MERCHANTCODE : ', 'woocommerce-redsys' ) . $this->customer );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_CURRENCY : ', 'woocommerce-redsys' ) . $currency );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_TRANSACTIONTYPE : ', 'woocommerce-redsys' ) . $transaction_type );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_TERMINAL : ', 'woocommerce-redsys' ) . $terminal );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_MERCHANTURL : ', 'woocommerce-redsys' ) . $final_notify_url );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_URLOK : ', 'woocommerce-redsys' ) . add_query_arg( 'utm_nooverride', '1', $this->get_return_url( $order ) ) );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_URLKO : ', 'woocommerce-redsys' ) . $order->get_cancel_order_url() );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_CONSUMERLANGUAGE : 001', 'woocommerce-redsys' ) );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_PRODUCTDESCRIPTION : ', 'woocommerce-redsys' ) . __( 'Order', 'woocommerce-redsys' ) . ' ' . $order->get_order_number() );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_MERCHANTNAME : ', 'woocommerce-redsys' ) . $this->commercename );
			$this->log->add( 'webserviceredsys', __( 'DS_MERCHANT_AUTHORISATIONCODE : ', 'woocommerce-redsys' ) . $autorization_code );
			$this->log->add( 'webserviceredsys', __( 'Ds_Merchant_TransactionDate : ', 'woocommerce-redsys' ) . $autorization_date );
			$this->log->add( 'webserviceredsys', __( 'ask_for_refund Asking por order #: ', 'woocommerce-redsys' ) . $order_id );
			$this->log->add( 'webserviceredsys', ' ' );
		}
		...
		if ( is_wp_error( $post_arg ) ) {
			if ( 'yes' === $this->debug ) {
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', __( 'There is an error', 'woocommerce-redsys' ) );
				$this->log->add( 'webserviceredsys', '*********************************' );
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', __( 'The error is : ', 'woocommerce-redsys' ) . $post_arg );
				}
			return $post_arg;
		}
		return true;
	...
	*/
	function check_redsys_refund( $order_id ) {
		...
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', __( 'Checking and waiting ping from Redsys', 'woocommerce-redsys' ) );
			$this->log->add( 'webserviceredsys', '*****************************************' );
			$this->log->add( 'webserviceredsys', ' ' );
			$this->log->add( 'webserviceredsys', __( 'Check order status #: ', 'woocommerce-redsys' ) . $order->get_id() );
			$this->log->add( 'webserviceredsys', __( 'Check order status with get_transient: ', 'woocommerce-redsys' ) . $order_refund );
		}
		if ( 'yes' === $order_refund ) {
			return true;
		} else {
	...
	*/
	public function process_refund( $order_id, $amount = null, $reason = '' ) {
		...
		if ( 'yes' === $this->debug ) {
			$this->log->add( 'webserviceredsys', __( '$order_id#: ', 'woocommerce-redsys' ) . $transaction_id );
		}
		if ( ! $amount ) {
			$order_total_sign = WCRed()->redsys_amount_format( $order->get_total() );
		} else {
		...
		if ( ! empty( $transaction_id ) ) {
			if ( 'yes' === $this->debug ) {
				$this->log->add( 'webserviceredsys', __( 'check_redsys_refund Asking for order #: ', 'woocommerce-redsys' ) . $order_id );
			}
			...
			if ( is_wp_error( $refund_asked ) ) {
				if ( 'yes' === $this->debug ) {
					$this->log->add( 'webserviceredsys', __( 'Refund Failed: ', 'woocommerce-redsys' ) . $refund_asked->get_error_message() );
				}
			...
			if ( 'yes' === $this->debug && $result ) {
				$this->log->add( 'webserviceredsys', __( 'check_redsys_refund = true ', 'woocommerce-redsys' ) . $result );
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', '/********************************/' );
				$this->log->add( 'webserviceredsys', '  Refund complete by Redsys   ' );
				$this->log->add( 'webserviceredsys', '/********************************/' );
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', '/******************************************/' );
			...
			if ( 'yes' === $this->debug && ! $result ) {
				$this->log->add( 'webserviceredsys', __( 'check_redsys_refund = false ', 'woocommerce-redsys' ) . $result );
			}
			if ( $result ) {
				...
				if ( 'yes' === $this->debug && $result ) {
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!' );
					$this->log->add( 'webserviceredsys', __( '!!!!Refund Failed, please try again!!!!', 'woocommerce-redsys' ) );
					$this->log->add( 'webserviceredsys', '!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!' );
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', ' ' );
					$this->log->add( 'webserviceredsys', '/******************************************/' );
			...
			if ( 'yes' === $this->debug && $result ) {
				$this->log->add( 'webserviceredsys', __( 'Refund Failed: No transaction ID', 'woocommerce-redsys' ) );
				$this->log->add( 'webserviceredsys', ' ' );
				$this->log->add( 'webserviceredsys', '/******************************************/' );
				$this->log->add( 'webserviceredsys', '  The final has come, this story has ended  ' );
				$this->log->add( 'webserviceredsys', '/******************************************/' );
...
* Copyright: (C) 2013 - 2020 José Conti
*/
function woocommerce_add_gateway_webserviceredsys_redsys( $methods ) {
		$methods[] = 'WC_Gateway_Webservice_Redsys';
		return $methods;
}
add_filter( 'woocommerce_payment_gateways', 'woocommerce_add_gateway_webserviceredsys_redsys' );
