	...
	class BetterDocs_Plugin_Usage_Tracker {
		...
		public function optin_notice() {
			...
			if ( $is_local ) {
				...
				if( $this->marketing != 1 ) {
					...
					$notice_text = __( 'Want to help make <strong>BetterDocs</strong> even more awesome? You can get a <strong>10% discount coupon</strong> for Premium extensions if you allow us to track the usage. <a class="betterdocs-insights-data-we-collect" href="#">What we collect.</a>', 'plugin-usage-tracker' );
				}
				...
				<div class="notice notice-info updated put-dismiss-notice">
					...
					<div class="betterdocs-insights-data" style="display: none;">
		            ...
		            <?php echo "<script type='text/javascript'>jQuery('.betterdocs-insights-data-we-collect').on('click', function(e) {
		                    e.preventDefault();
		                    jQuery('.betterdocs-insights-data').slideToggle('fast');
		                });
		                </script>";?>
				</div>
			<?php
		...
		public function goodbye_ajax() {
			...
			<style type="text/css">
				...
				.wpdev-put-goodbye-form-footer .betterdocs-put-submit-btn {
				...
				.wpdev-put-goodbye-form-footer .betterdocs-put-deactivate-btn {
					font-size: 13px;
					color: #a4afb7;
					background: none;
					float: right;
			...
			<script>
				jQuery(document).ready(function($){
					$("#wpdev-put-goodbye-link-<?php echo esc_attr( $this->plugin_name ); ?>").on("click",function(){
						...
						$("#wpdev-put-goodbye-form-<?php echo esc_attr( $this->plugin_name ); ?>").html( '<?php echo $html; ?>' + '<div class="wpdev-put-goodbye-form-footer"><div class="wpdev-put-goodbye-form-buttons"><a id="put-submit-form-<?php echo esc_attr( $this->plugin_name ); ?>" class="betterdocs-put-submit-btn" href="#"><?php _e( 'Submit and Deactivate', 'plugin-usage-tracker' ); ?></a>&nbsp;<a class="betterdocs-put-deactivate-btn" href="'+url+'"><?php _e( 'Just Deactivate', 'plugin-usage-tracker' ); ?></a></div></div>');
