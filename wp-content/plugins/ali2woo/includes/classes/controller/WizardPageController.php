...
class WizardPageController extends AbstractAdminPage {
    ...
    public function render($params = array()) {
        ...
        if (isset($_POST['wizard_form'])) {
            ...
            {
                set_setting('fulfillment_phone_code',  wp_unslash($_POST['a2w_fulfillment_phone_code']));
                set_setting('fulfillment_phone_number', wp_unslash($_POST['a2w_fulfillment_phone_number']));
