...
/**
 * Description of A2W_SearchStoreProductsPageController
 *
 * @author Ali2Woo Team
 *
 * @autoload: a2w_admin_init
 */
if (!class_exists('A2W_SearchStoreProductsPageController')) {

    class A2W_SearchStoreProductsPageController extends A2W_AbstractAdminPage
    {
        ...
        public function render($params = array())
        {
            ...
            if (!empty($_REQUEST['a2w_search'])) {
                ...
                $load_products_result = A2W_ResultBuilder::buildError(__('Please enter some store id and seller id!', 'ali2woo'));
            }
