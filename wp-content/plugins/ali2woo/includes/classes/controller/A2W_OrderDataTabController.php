 ...
 if (!class_exists('A2W_OrderDataTabController') ) {
    ...
    class A2W_OrderDataTabController {
        ...
        public function woocommerce_admin_order_data_after_order_details( $order ){ ?>
            ...
            <strong><?php _e('Item', 'ali2woo') ?>:</strong> <a href="<?php echo get_edit_post_link($item['product_id']); ?>"><?php echo $this->shorten_display_value($item->get_name()); ?></a><br/>
            <strong><?php _e('AliExpress order ID', 'ali2woo') ?>:</strong> <?php echo  $external_order_id; ?><br/>
            ...
            <?php foreach (  $order_items as $item_id => $item ) : ?>
            <div class="clear"></div>
            <h3><?php _e('Item', 'ali2woo') ?>: <span><a href="<?php echo get_edit_post_link($item['product_id']); ?>"><?php echo $this->shorten_display_value($item->get_name()); ?></a></span></h3>
