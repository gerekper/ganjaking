        ...
        function ajax_order_info() {
           ...
           // $order_tracking_codes = get_post_meta($order->get_id(), A2W_Constants::old_order_tracking_code());
            ...
            foreach ($items as $item) {
                ...
                $product_name = $a2w_order_item->getName();
                $product_id = $a2w_order_item->getProductID();
                ...
                if ($product_id > 0) {
                    ...
                    if($shipping_info){
                     ...
                     if ($external_order_id){
                         $tmp .= " | " .  __('AliExpress order ID', 'ali2woo') . ": <span class='seller_url_block'>" . $external_order_id . "</span>";
            ...
            switch ($name) {
                case 'tracking_code':
                    ...
                    foreach (  $order_items as $item ) {
                        ...
                        $tracking_number = $a2w_order_item->getFormatedTrackingCodes();
                ...
                case 'aliexpress_order':
                    ...
                    foreach (  $order_items as $item ) {
                        ...
                        $ali_order_id =  $a2w_order_item->getExternalOrderId();
