    ...
    class A2W_SynchProductController extends A2W_AbstractController
    {
        ...
        public function update_products_event()
        {
            ...
            try {
                ...
                $product_ids = $woocommerce_model->get_sorted_products_ids("_a2w_last_update", $update_per_schedule, array('value' => time() - $update_period_delay, 'compare' => '<'), a2w_get_setting('untrash_product'));
        ...
        public function email_alerts_event()
        {
            ...
            a2w_init_error_handler();
            try {
                $product_change_model = new A2W_ProductChange();
