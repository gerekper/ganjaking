    ...
    public function assets(): void
    {
        if (OrderUtil::custom_orders_table_usage_is_enabled()) {
            ...
            if ($currentPage === 'wc-orders' && $orderId !== false) {
                wp_enqueue_script('a2w-wc-order-edit-script', A2W()->plugin_url() . '/assets/js/wc_order_edit.js', [], A2W()->version);
                wp_enqueue_style('a2w-wc-order-edit-style', A2W()->plugin_url() . '/assets/css/wc_order_edit.css', [], A2W()->version);
            }
        } else {
