...
abstract class AbstractAdminPage extends AbstractController {
    ...
    public function admin_register_assets() {
        if ($this->is_current_page()) {
            ...
            $lang_data = array();
            wp_localize_script('a2w-admin-script', 'a2w_common_data', array('baseurl' => A2W()->plugin_url().'/','lang' => apply_filters('a2w_configure_lang_data', $lang_data), 'lang_cookies'=>AliexpressLocalizator::getInstance()->getLocaleCookies(false)));
