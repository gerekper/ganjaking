<?php
/**
 * Description of ShippingPageController
 *
 * @author MA_GROUP
 * 
...
class ShippingPageController extends AbstractAdminPage {
    ...
    public function edit_columns($column) {
        ...
        switch ($column) {
            ...
            case "service_name":
                ...
                break;
            case "use_price_rule":
                echo ShippingPriceFormula::allow_post_price_rule($post->ID) ? "yes" : "no";
                break;
            case "status":
    ...
    public function settings_metabox() {
        ...
        $use_price_rule_checked = ShippingPriceFormula::allow_post_price_rule($post->ID) ? "checked" : "";
        ?>
