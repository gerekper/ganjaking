<?php
/**
 * Description of ShippingPostType
 *
 * @author MA_GROUP
 */
...
class ShippingPostType {
      ...
      static public function get_item($shipping_name = false, $service_name = false){
          ...
          $use_price_rule = ShippingPriceFormula::allow_post_price_rule($post->ID);
      ...
      static public function add_item($shipping_name, $service_name){
          ...
          $shipping_name_f = PhraseFilter::apply_filter_to_text($shipping_name);
...
add_action('init', array('Ali2Woo\ShippingPostType', 'init'));
