...
class Json_Api_Configurator {
    ...
    function json_api_init() {
        ...
        if (!class_exists('Ali2Woo\JSON_API')) {
        ...
        $a2w_json_api = new JSON_API(empty($this->root_menu_slug)?'':$this->root_menu_slug);
    }
    ...
    function json_api_class_warning() {
        echo "<div id=\"json-api-warning\" class=\"updated fade\"><p>Oops, JSON_API class not found. If you've defined a A2W_JSON_API_DIR constant, double check that the path is correct.</p></div>";
    }
