...
class JSON_API
{
    ...
    function __construct($root_menu_slug)
    {
        ...
        if (!has_action('template_redirect', 'Ali2Woo\a2w_global_template_redirect')) {
            add_action('template_redirect', 'Ali2Woo\a2w_global_template_redirect');
        }
    ...
    function admin_options()
    {
        ...
        if (!empty($_REQUEST['_wpnonce']) && wp_verify_nonce($_REQUEST['_wpnonce'], "update-options")) {
            ...
            if (isset($_REQUEST['a2w_json_api_base'])) {
                set_setting('json_api_base', $_REQUEST['a2w_json_api_base']);
            }
        }
        ?>
        <div class="wrap">
            ...
            <form action="admin.php?page=a2w-json-api" method="post">
                ...
                <table class="form-table">
                    <tr valign="top">
                        ...
                        <td><code><?php bloginfo('url'); ?>/</code><input type="text" name="a2w_json_api_base"
    ...
    {
        return "Ali2Woo\JSON_API_{$controller}_Controller";
    }
