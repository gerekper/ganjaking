...
class A2W_JSON_API_Core_Controller {
    ...
    function add_product() {
        ...
        if (empty($_REQUEST['id'])) {
            ...
            if ((defined('A2W_ALLOW_PRODUCT_DUPLICATION') && A2W_ALLOW_PRODUCT_DUPLICATION) || !$imported) {
                    ...
                    */
                    ...
                    if (is_array($data)) {
                        foreach ($data as $code_value) {
                            ...
                            if (!empty ( $code_value )) add_post_meta($order_id, A2W_Constants::old_order_external_order_id(), $code_value);
                        }
