        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title='<?php esc_html_e('Need for everything.', 'ali2woo');?>'></div>
                </div>
                <div class="col-md-6">
            ...
            <div class="a2w_purchase_code_info" style="display:none">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="info-box" data-toggle="tooltip" title='<?php esc_html_e('CodeCanyon support', 'ali2woo');?>'></div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group input-block no-margin">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="info-box" data-toggle="tooltip" title='<?php esc_html_e('Information about the current package.', 'ali2woo');?>'></div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group input-block no-margin">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x("It's applied to Product title, description, attributes and reviews", 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x("Default currency that used on a product import", 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x("Default product type", 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php esc_html_e('Not import specifications', 'ali2woo');?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php esc_html_e('Not import description', 'ali2woo');?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php esc_html_e("Don't import images from the description", 'ali2woo');?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Use external image urls', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Use random stock value', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
                    ...
                    <div id="a2w_use_random_stock_block" class="form-group input-block no-margin" <?php if (!a2w_get_setting('use_random_stock')): ?>style="display: none;"<?php endif;?>>
                        <?php esc_html_e('From', 'ali2woo');?> <input type="text" style="max-width: 60px;" class="form-control" id="a2w_use_random_stock_min" name="a2w_use_random_stock_min" value="<?php echo esc_attr(a2w_get_setting('use_random_stock_min')); ?>">
                        <?php esc_html_e('To', 'ali2woo');?> <input type="text" style="max-width: 60px;" class="form-control" id="a2w_use_random_stock_max" name="a2w_use_random_stock_max" value="<?php echo esc_attr(a2w_get_setting('use_random_stock_max')); ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Products will be imported in the background mode, make sure you CRON is enabled.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Allow the import of an already imported product. This can be useful when you want to overload a product with the same product.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
                        <input type="checkbox" class="form-control" id="a2w_allow_product_duplication" name="a2w_allow_product_duplication" value="yes" <?php if (a2w_get_setting('allow_product_duplication')): ?>checked<?php endif;?>/>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Products may come with different text case of attributes and their values. ', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Remove Ship from attribute during product import.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
                        <input type="checkbox" class="form-control" id="a2w_remove_ship_from" name="a2w_remove_ship_from" value="yes" <?php if (a2w_get_setting('remove_ship_from')): ?>checked<?php endif;?>/>
                    </div>
                </div>
            </div>

            <div id="a2w_remove_ship_from_block" class="row" <?php if (!a2w_get_setting('remove_ship_from')): ?>style="display: none;"<?php endif;?>>
                <div class="col-md-4">
                    <label for="a2w_default_ship_from">
                        <strong><?php echo esc_html_x('Default "Ship From" country', 'Setting title', 'ali2woo'); ?></strong>
                    </label>
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Only product variations that contain Ship from selected country will be imported.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="input-block"><?php echo esc_html_x('Note! If the "Ship From" attribute does not contain the selected country, then China will be used as the "Ship from" country.', 'setting description', 'ali2woo'); ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x("Change order status when all order items have been delivered.", 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
              ...
              <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x("Change order status when all order items have been shipped.", 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x("Change order status when order is placed with the Chrome extension", 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
        ...
        <div class="panel-body _a2wfv">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Enable auto-update features', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php esc_html_e('Choose an action when one of your products is no longer available from Aliexpress. Applies to all existing products.', 'ali2woo');?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php esc_html_e('Choose an action when one of the product’s variants is no longer available from Aliexpress.', 'ali2woo');?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php esc_html_e('Choose an action when new of the product’s variants is an appearance on Aliexpress.', 'ali2woo');?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php esc_html_e('Choose an action when the price of your product changes.', 'ali2woo');?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php esc_html_e('Choose an action when the inventory level of a particular product changes.', 'ali2woo');?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Enable restore products from the trash during the sync process.', 'setting description', 'ali2woo'); ?>"></div>

                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
                        <?php $a2w_untrash_product = a2w_get_setting('untrash_product');?>
                        <input type="checkbox" class="form-control" id="a2w_untrash_product" name="a2w_untrash_product" value="yes" <?php if ($a2w_untrash_product): ?>checked<?php endif;?>/>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Enable email notifications about product changes (every 30 minutes). It watches for product price change, stock change, and monitors new product variant appearance. ', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('If possible, we will auto-select this shipping method during the checkout on AliExpress.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('This will be used instead of a customer phone number.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('A note to the supplier on the Aliexpress checkout page.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
                        <textarea placeholder="<?php esc_html_e('note for aliexpress order', 'ali2woo');?>" maxlength="1000" rows="5" class="form-control" id="a2w_fulfillment_custom_note" name="a2w_fulfillment_custom_note" cols="50"><?php echo esc_attr(a2w_get_setting('fulfillment_custom_note')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Enable the auto-transliteration for AliExpress order details.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Adds the Middle name field to WooCommerce checkout page and then uses it during an order-fulfillment process on AliExpress.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Allow the Chrome extension to pay automatically for each order during an order fulfillment process. Also please make sure that you`ve selected your credit card as the payment method on AlIExpress.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_x('Allow the Chrome extension to place each order to the Awaiting payment list on AlIExpress. It gives ability to pay for all orders at a time.', 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
