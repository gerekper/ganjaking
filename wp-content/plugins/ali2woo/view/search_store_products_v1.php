            ...
            <div class="search-panel-body">
                <div class="search-panel-simple">
                    ...
                    <div class="container-flex flex-wrap container-flex_fill container-flex_p20">
                        <div class="opt">
                            <input type="text" class="form-control" name="a2w_store_id" placeholder="<?php _e('Store ID', 'ali2woo');?>" value="<?php echo esc_attr(isset($filter['store_id']) ? $filter['store_id'] : ""); ?>">
                        </div>
                        <div class="opt">
                            <input type="text" class="form-control" name="a2w_seller_id" placeholder="<?php _e('Seller ID', 'ali2woo');?>" value="<?php echo esc_attr(isset($filter['seller_id']) ? $filter['seller_id'] : ""); ?>">
                        </div>
                    </div>
                    </div>
