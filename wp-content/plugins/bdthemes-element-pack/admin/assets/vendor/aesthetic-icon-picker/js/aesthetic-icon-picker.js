var AestheticIconPicker = function(option) {
	...
	var aestheticWrap = '<div class="aim-modal aim-open" id="aim-modal"><div class="aim-modal--content"><div class="bdt-modal-header"><div class="aim-modal--header-logo-area"><h2 class="bdt-modal-title">One Menu Icon Picker</h2></div><div class="aim-modal--header-close-btn"><i class="bdt-icon bdt-close" title="Close"bdt-close></i></div></div><div class="aim-modal--body"><div id="aim-modal--sidebar" class="aim-modal--sidebar"><div class="aim-modal--sidebar-tabs"></div></div><div id="aim-modal--icon-preview-wrap" class="aim-modal--icon-preview-wrap"><div class="aim-modal--icon-search"><input name="" value="" placeholder="Filter by name..."><i class="fas fa-search"></i></div><div class="aim-modal--icon-preview-inner"><div id="aim-modal--icon-preview"></div></div></div></div><div class="bdt-modal-footer bdt-text-right"><button class="aim-insert-icon-button">Insert</button></div></div></div>';
	...
	document.querySelector(defaultOpt.onClick).addEventListener('click', function (e) {
		...
		document.querySelectorAll('.aim-icon-item').forEach(function (item, key) {
			item.addEventListener('click', function (e) {
				...
				e.currentTarget.classList.add('aesthetic-selected');
			});
		});
		...
		aestheticDomEle.querySelector('.aim-insert-icon-button').addEventListener('click', function (e) {
			...
			if (null !== selected) {
				...
				var selectedAttr =  selected.getAttribute('data-library-id');

				// console.log(sellectedClass);

				document.querySelector('#icon_value').value = sellectedClass;
				document.querySelector('#icon_library').value = selectedAttr;

				var wrap = document.querySelector('.select-icon');
				// console.log(wrap);
				wrap.querySelector('i').classList.remove();
	...
	document.querySelector('.icon-none').addEventListener('click', function (e) {
		...
		document.querySelector('.select-icon i').classList.value = selected;
