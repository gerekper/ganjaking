	...
	?>
		<div <?php echo $this->get_render_attribute_string('webhook-form'); ?>>
			<div class="bdt-ep-webhook-form-wrapper">
				<form <?php echo $this->get_render_attribute_string('wb-form'); ?>>
					<input type="hidden" name="widget_id" value="<?php echo esc_attr($id); ?>" />
					<input type="hidden" name="success_text" value="<?php echo !empty($settings['success_text']) ? esc_html($settings['success_text']) : ''; ?>" />
					<?php
					$i = 1;
