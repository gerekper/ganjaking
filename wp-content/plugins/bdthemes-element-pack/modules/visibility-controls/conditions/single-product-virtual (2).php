<?php
	...
	class Single_Product_Virtual extends Condition {
		...
		public function get_title() {
			return esc_html__( 'Single Product Virtual', 'bdthemes-element-pack' );
		}
		...
		public function check( $relation, $val ) {
			...
			return $this->compare( $virtual, true, $relation );
		}
	}
