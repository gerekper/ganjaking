<?php
	...
	class Single_Product_Featured extends Condition {
		...
		public function get_name() {
			return 'single_product_featured';
		}
		...
		public function get_title() {
			return esc_html__( 'Single Product Featured', 'bdthemes-element-pack' );
		}
		...
		public function check( $relation, $val ) {
			...
			return $this->compare( $featured, true, $relation );
		}
	}
