<?php
	...
	class Single_Product_Onsale extends Condition {
		...
		public function get_title() {
			return esc_html__( 'Single Product Onsale', 'bdthemes-element-pack' );
		}
		...
		public function check( $relation, $val ) {
			...
			return $this->compare( $onsale, true, $relation );
		}
	}
