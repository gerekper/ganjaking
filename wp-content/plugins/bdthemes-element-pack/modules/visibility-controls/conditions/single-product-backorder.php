<?php
	...
	class Single_Product_Backorder extends Condition {
		...
		public function get_name() {
			return 'single_product_backorder';
		}
		...
		public function get_title() {
			return esc_html__( 'Single Product Backorder', 'bdthemes-element-pack' );
		}
		...
		public function check( $relation, $val ) {
			...
			return $this->compare( $backorder, true, $relation );
		}
	}
