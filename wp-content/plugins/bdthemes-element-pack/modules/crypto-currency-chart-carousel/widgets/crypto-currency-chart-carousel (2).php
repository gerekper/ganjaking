...
namespace ElementPack\Modules\CryptoCurrencyChartCarousel\Widgets;
...
class Crypto_Currency_Chart_Carousel extends Module_Base {
    ...
    public function get_name() {
        return 'bdt-crypto-currency-chart-carousel';
    }

    public function get_title() {
        return BDTEP . esc_html__('Crypto Currency Chart Carousel', 'bdthemes-element-pack');
    }

    public function get_icon() {
        return 'bdt-wi-crypto-currency-chart-carousel';
    }
    ...
    public function get_style_depends() {
		if ($this->ep_is_edit_mode()) {
			...
			return ['ep-font', 'ep-crypto-currency-chart-carousel'];
		}
	}
	...
	public function get_script_depends() {
		if ($this->ep_is_edit_mode()) {
			...
			return ['chart', 'ep-crypto-currency-chart-carousel'];
		}
	}
    ...
    protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-crypto-currency-chart-carousel-item',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-item:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-crypto-currency-chart-carousel-item:hover',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-crypto-currency-chart-carousel-img img',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-img img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-img img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-img img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-img img' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-title h4' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_currency_name' => 'yes'
				]
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-crypto-currency-chart-carousel-title h4',
				'condition' => [
					'show_currency_name' => 'yes'
				]
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-title h4 span' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_currency_short_name' => 'yes'
				]
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-crypto-currency-chart-carousel-title h4 span',
				'condition' => [
					'show_currency_short_name' => 'yes'
				]
			]
			...
			[
				...
				'conditions'   => [
					...
					'terms' => [
						...
						[
							'name'  => 'show_price_change_percentage',
							'value' => 'yes',
						],
					],
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-price-l' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-crypto-currency-chart-carousel-price-l',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'condition' => [
					'show_price_change_percentage' => 'yes'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-list-change' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_price_change_percentage' => 'yes'
				]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
					'{{WRAPPER}} .bdt-crypto-currency-chart-carousel-list-change' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'show_price_change_percentage' => 'yes'
				]
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-crypto-currency-chart-carousel-list-change',
				'condition' => [
					'show_price_change_percentage' => 'yes'
				]
			]
    ...
    protected function render() {
        ...
        $this->add_render_attribute('carousel', [
			'class'         => 'bdt-crypto-currency-chart-carousel',
        ...
        //Global Function
		$this->render_swiper_header_attribute('crypto-currency-chart-carousel');
