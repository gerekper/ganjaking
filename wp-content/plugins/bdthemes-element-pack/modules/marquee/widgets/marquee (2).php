...
class Marquee extends Module_Base {
    ...
    public function render_thumbnail($item) {
        ...
        if (!empty($link['url'])) {
            $link_start = '<a class="marquee-content marquee-image" href="' . esc_url($link['url']) . '"';
            $link_start .= $link['is_external'] ? ' target="_blank"' : '';
            $link_start .= $link['nofollow'] ? ' rel="nofollow"' : '';
            $link_start .= '>';
            $link_end = '</a>';
        }
        ...
        <?php if ($settings['marquee_type'] === 'text') : ?>
            ...
            ?>
                    ...
                    <div class="marquee-content marquee-text" <?php $this->print_render_attribute_string($marquee_bg_color); ?>>
                        ...
                        <?php
                        $link = $list['marquee_link'];
                        if (!empty($link['url'])) {
                            $link_attributes = 'class="marquee-title" href="' . esc_url($link['url']) . '"';
                            if ($list['marquee_link']['is_external']) {
                                $link_attributes .= ' target="_blank"';
                            }
                            if ($list['marquee_link']['nofollow']) {
