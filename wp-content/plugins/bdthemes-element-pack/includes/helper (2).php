...
function element_pack_instagram_card() {
	...
	if ( $access_token ) {
		...
		if ( false === $data ) {
			...
			// $url = 'https://graph.instagram.com/me?fields=id&access_token=' . $access_token; //3996706120418040
			$url = 'https://graph.instagram.com/v18.0/me/?fields=username,media_count&access_token=' . $access_token;
			...
			if ( 200 == $code && ! empty( $output ) ) {
				set_transient( 'ep_instagram_card_data', $output, HOUR_IN_SECONDS * 12 );
