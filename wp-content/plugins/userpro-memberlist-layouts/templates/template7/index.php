				...
				<!-- Member 1 -->
                            <div class="col-md-4">
                                <div class="member-div">
                                    ...
                                    <h2><a href="<?php echo $userpro->permalink($user_id); ?>" class="upmlsv-name <?php userpro_user_via_popup($args); ?> userpro-transition" data-up_username="<?php echo $userpro->id_to_member($user_id); ?>"><?php echo userpro_profile_data('display_name', $user_id); ?></a></h2>
                                    <p><a href="<?php echo $userpro->permalink($user_id); ?>" class="upmlsv-view userpro-flat-btn userpro-transition"><?php _e('View Profile','userpro'); ?></a></p>
