                    ...
                    <div class="member-div">
                        <figure class="upmln-figure">
                            ...
                            <div class="member-title">
                                <h2><a href="<?php echo $userpro->permalink($user_id); ?>" class="upmln-name <?php userpro_user_via_popup($args); ?> userpro-transition" data-up_username="<?php echo $userpro->id_to_member($user_id); ?>"><?php echo userpro_profile_data('display_name', $user_id); ?></a></h2>
<!--                                <p><a id= "upml-view" href="<?php echo $userpro->permalink($user_id); ?>" class="userpro-flat-btn userpro-transition"><?php _e('View Profile','userpro'); ?></a></p>-->
                            </div>
                            <figcaption>
                                <ul>
