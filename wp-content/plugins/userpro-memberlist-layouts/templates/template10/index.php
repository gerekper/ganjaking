                    ...
                    <div class="col-md-4">
                        <div class="member-div">
                            ...
                            <div class="member-title">
                                <h2><a href="<?php echo $userpro->permalink($user_id); ?>" class="upmlt-name<?php userpro_user_via_popup($args); ?> userpro-transition" data-up_username="<?php echo $userpro->id_to_member($user_id); ?>"><?php echo userpro_profile_data('display_name', $user_id); ?></a></h2>
                                <?php do_action('userpro_after_profile_img' , $user_id); ?>
                                <p><a href="<?php echo $userpro->permalink($user_id); ?>" class="upmlt-view userpro-flat-btn userpro-transition"><?php _e('View Profile','userpro'); ?></a></p>
                            </div>
