 ...
 * Settings_API class.
 */
abstract class Settings_API extends \WC_Settings_API {
	 ...
	 * @var string
	 */
	public $plugin_id = 'wc_currency_converter_';
	...
	public function get_option_key( $setting = '' ) {
		$option_key = rtrim( $this->plugin_id . $this->id, '_' );
	...
	public function get_form_fields() {
		 ...
		 *
		 * The dynamic portions of the hook refer to the plugin ID and the Settings API ID.
		 *
		 * @since 1.8.0
		 *
	...
	public function sanitized_fields( $settings ) {
		/**
		 * Sanitizes the Settings API form fields.
		 *
		 * The dynamic portions of the hook refer to the plugin ID and the Settings API ID.
		 *
		 * @since 1.8.0
		 ...
		 * @param array $settings The settings to sanitize.
		 */
		return apply_filters( $this->plugin_id . 'settings_api_sanitized_fields_' . $this->id, $settings );
	}
