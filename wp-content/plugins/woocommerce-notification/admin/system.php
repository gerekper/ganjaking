			...
			<tr>
				...
				<td>
					...
					if ( @fopen( VI_WNOTIFICATION_CACHE . 'test-log.log', 'a' ) ) {
						...
						echo sprintf( '<mark class="error">&#10005; ' . esc_html__( 'To allow logging, make %s writable or define a custom %s.', 'woocommerce-notification' ) . '</mark>', '<code>'.VI_WNOTIFICATION_CACHE.'</code>','<code>VI_WNOTIFICATION_CACHE</code>' );
					}
					?>
