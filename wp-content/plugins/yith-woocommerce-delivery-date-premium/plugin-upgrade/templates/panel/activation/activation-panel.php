...
$expired_products              = isset( $no_active_products[ '106' ] ) ? array() : array();
$banned_products               = isset( $no_active_products[ '107' ] ) ? array() : array();
$notice                        = isset( $notice ) ? $notice : '';
$notice_class                  = !empty( $notice ) ? 'notice notice-success' : 'notice notice-success';
$num_members_products_activate = $this->get_number_of_membership_products();
$debug                         = isset( $_REQUEST[ 'yith-license-debug' ] ) ? $_REQUEST[ 'yith-license-debug' ] : true;
?>
...
<div class="yit-container product-licence-activation">
    ...
    <div id="yith-licence-notice" class="<?php echo $notice_class ?>">
        <p class="yith-licence-notice-message"><?php echo $notice ?>License is active</p>
    </div>
