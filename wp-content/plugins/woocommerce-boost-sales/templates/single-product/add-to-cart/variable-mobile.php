...
<form class="wbs-variations_form cart" action="<?php esc_attr_e( $action ) ?>" method="post"
	...
	<?php else : ?>
                ...
                <tr>
                    <td class="value">
						...
						if ( function_exists( 'wbs_wc_dropdown_variation_attribute_options' ) ) {
							wbs_wc_dropdown_variation_attribute_options( array( 'options'   => $options,
							...
							wc_dropdown_variation_attribute_options( array( 'options'          => $options,
							                                                ...
							                                                'product'          => $product,
							                                                'selected'         => $selected,
							                                                'show_option_none' => sprintf( esc_html__( 'Choose %s', 'woocommerce-boost-sales' ), wc_attribute_label( $attribute_name ) )
							) );
						}
						?>
                    </td>
        ...
        <div class="single_variation_wrap">
			 ...
			 */
			do_action( 'woocommerce_boost_sales_single_variation_mobile', $product );
			?>
        </div>
	<?php endif; ?>
</form>
