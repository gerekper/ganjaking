	...
	class VillaTheme_Plugin_Updater extends Plugin_Upgrader {
		...
		public function upgrade_strings() {
			...
			$this->strings['no_package']            = sprintf(
				esc_html__( 'Please (re)activate your license in %sMaster Slider > setting page%s. Valid license is required in order to update this plugin.' ),
				'<a href="' . esc_url( admin_url( 'admin.php?page=' . $this->slug . '-setting' ) ) . '">', '</a>'
			);
			$this->strings['downloading_package']   = esc_html__( 'Downloading package ...' );
			$this->strings['download_item_package'] = esc_html__( 'Downloading package ...' );
		}
