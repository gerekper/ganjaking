 ...
 * @since 1.12.0
 */
class WC_Nested_Category_Layout_Loader {
	...
	const PLUGIN_NAME = 'WooCommerce Nested Category Layout';


	/** @var \WC_Nested_Category_Layout_Loader single instance of this class */
	 ...
	 * @since 1.12.0
	 *
	 * @return \WC_Nested_Category_Layout_Loader
	 */
...
// fire it up!
WC_Nested_Category_Layout_Loader::instance();
