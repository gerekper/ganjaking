...
class WC_Nested_Category_Layout extends Framework\SV_WC_Plugin
{
    ...
    {
        wc_set_loop_prop('total', 0); // onlyy if filter added
    ...
    public function handle_third_party_plugins_compatibility($wp_query)
    {
        ...
        if (! $wp_query->is_tax('product_cat') && WC_Query::get_layered_nav_chosen_attributes()) {
            $this->disable_nested_categories();
        }
    }
    ...
    /**
     * Wether is product filters are active.
     *
     * @since 1.18.1
     * @return bool
     */
    public function is_woo_product_filter_active()
    {
