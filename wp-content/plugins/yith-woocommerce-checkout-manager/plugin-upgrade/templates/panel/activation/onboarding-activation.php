...
<div id="wpwrap">
	<div id="content">
		...
		<a href="<?php echo esc_url( $return_url ); ?>" class="small-link" tabindex="-1"><?php esc_html_e( 'Return to the dashboard and activate the plugin later', 'yith-plugin-upgrade-fw' ); ?></a>
