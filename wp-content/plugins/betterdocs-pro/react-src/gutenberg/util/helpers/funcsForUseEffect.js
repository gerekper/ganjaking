...
export const giveClassForResOptionChange = (domObj, resOption) => {
  ...
  const regexPattern = /eb\-responsive\-preview\-option\-(Tablet|Mobile|Desktop)/g;
...
export const mimmikCssForPreviewBtnClick = ({ domObj, select }) => {
  ...
  const wpResBtnsWrapAll = domObj.querySelectorAll(".popover-slot");

  // console.log("+++++++mimmikCssForPreviewBtnClick", { wpResBtnsWrapAll });

  // if (wpResBtnsWrapAll.length > 0) {
  for (const wpResBtnsWrap of wpResBtnsWrapAll) {
    wpResBtnsWrap.addEventListener("click", (e) => {
      // console.log("////////////clicked: mimmikCssForPreviewBtnClick", {
      //   wpResBtnsWrapAll,
      // });
...
export const mimmikCssOnPreviewBtnClickWhileBlockSelected = ({
  ...
  // console.log("+++++++mimmikCssOnPreviewBtnClickWhileBlockSelected", {
  //   wpResBtnsWrapAll,
  // });

  const handleCLick = (e) => {
    // console.log(
    //   "////////////clicked: mimmikCssOnPreviewBtnClickWhileBlockSelected",
    //   {
    //     wpResBtnsWrapAll,
    //   }
    // );
