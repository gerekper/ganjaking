      ...
      <span className="profile-wrapper">
        ...
        >
          ...
          <span className="selected-profile-icon">
            {(profile.icon || " ").replace(/^fa[bsr] fa-/i, "")}
            {
              // (profile.icon || " ").replace(/^fa[\w] fa-/i, "")
            }
          </span>
        </span>
        <DragHandle />
        ...
        profile.isExpanded && (
          <div className="link-form-wrapper">
            ...
            <ColorControl
              ...
              onChange={(bgColor) => onBgColorChange(bgColor, position)}
            />

            <label className="iconLbl" for={`iconId-${profile.icon}`}>
              URL (use <i>https://</i> at the beginning)
            </label>
            ...
            <form
              ...
              onSubmit={(e) => {
                e.preventDefault();
                // onSubmit(profile.icon);
              }}
            >
              <input
                type="text"
                className="social-link-input"
                id={`iconId-${profile.icon}`}
