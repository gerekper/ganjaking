...
export default function BorderShadowControl({
  ...
  return (
    <>
            ...
            <>
              ...
              {borderStyle !== "none" && (
                <>
                  <ColorControl
                    defaultColor={
                      (objAttributes[`${controlName}borderColor`] || {}).default
                    }
            ...
            <>
              ...
              {HborderStyle !== "none" && (
                <>
                  <ColorControl
                    defaultColor={
                      (objAttributes[`${controlName}HborderColor`] || {})
                        .default
                    }
                    label={__("Border Color", "essential-blocks")}
                    color={HborderColor}
                  ...
                  <RangeControl
                    label={__("Border Transition", "essential-blocks")}
              ...
              <RangeControl
                label={__("Border Radius Transition", "essential-blocks")}
      ...
      {noShadow !== true && (
        <>
          <BaseControl label={__("Box Shadow", "essential-blocks")} className="eb-typography-base">
            <Dropdown
                  ...
                  >
                    ...
                    {(shadowType === "normal" || noShdowHover) && (
                      <>
                        <ColorControl
                          defaultColor={
                            (objAttributes[`${controlName}shadowColor`] || {})
                              .default
                          }
                        ...
                        >
                          <RangeControl
                            label={__("Shadow Blur", "essential-blocks")}
                            value={blur}
                            onChange={(blur) =>
                              setAttributes({
                                [`${controlName}blur`]: blur,
                        ...
                        >
                          <RangeControl
                            label={__("Shadow Spread", "essential-blocks")}
                            value={spread}
                            onChange={(spread) =>
                              setAttributes({
                                [`${controlName}spread`]: spread,
                    ...
                    {shadowType === "hover" && !noShdowHover && (
                      <>
                        <ColorControl
                          defaultColor={
                            (
                              objAttributes[`${controlName}hoverShadowColor`] ||
                              {}
                            ).default
                          }
                          label={__("Hover Shadow Color", "essential-blocks")}
                        ...
                        <RangeControl
                          label={__("Shadow Transition", "essential-blocks")}
