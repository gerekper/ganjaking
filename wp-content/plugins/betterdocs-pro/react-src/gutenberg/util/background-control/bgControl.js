    ...
    <>
      ...
      {bg_hoverType === "normal" && (
        <>
          <BaseControl label={__("Background Type", "essential-blocks")}>
            <ButtonGroup>
              {[
                { label: __("Classic", "essential-blocks"), value: "classic" },
          ...
          {backgroundType === "classic" && (
            <>
              ...
              {noMainBgi === false && (
                <>
                  <BaseControl label={__("Background Image", "essential-blocks")}></BaseControl>
      ...
      {bg_hoverType === "hover" && (
        <>
          ...
          {!noTransition && (
            <RangeControl
              label={__("Background Transition", "essential-blocks")}
              value={bg_transition}
              min={0}
              max={5}
              step={0.1}
