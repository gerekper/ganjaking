...
export default function overlayControl({
  ...
  return (
    <>
      <BaseControl label={__("Background Overlay", "essential-blocks")}></BaseControl>
      <BaseControl>
        <ButtonGroup>
          {[
        ...
        <>
          ...
          {overlayType === "classic" && (
            <>
              ...
              {noOverlayBgi === false && (
                <>
                  <BaseControl label={__("Overlay Image", "essential-blocks")}></BaseControl>
                          ...
                          >
                            <SelectControl
                              ...
                              options={[
                                ...
                                {
                                  label: __("Center Center", "essential-blocks"),
                                  value: "center center",
                                },
                                {
                                  label: __("Center Left", "essential-blocks"),
                                  value: "center left",
                                },
                                {
                                  label: __("Center Right", "essential-blocks"),
                                  value: "center right",
                                },
                                {
                                ...
                                {
                                  label: __("Bottom Center", "essential-blocks"),
                                  value: "bottom center",
                                },
                                {
                                  label: __("Bottom Left", "essential-blocks"),
                                  value: "bottom left",
                                },
                                {
                                  label: __("Bottom Right", "essential-blocks"),
                                  value: "bottom right",
                                },
                          ...
                          >
                            <SelectControl
                              ...
                              options={[
                                { label: __("Default", "essential-blocks"), value: "" },
                                {
                                  label: __("No-repeat", "essential-blocks"),
                                  value: "no-repeat",
                                },
          ...
          <SelectControl
            ...
            value={ovl_blendMode}
            options={[
              { label: __("Normal", "essential-blocks"), value: "" },
              { label: __("Multiply", "essential-blocks"), value: "multiply" },
              { label: __("Screen", "essential-blocks"), value: "screen" },
              { label: __("Overlay", "essential-blocks"), value: "overlay" },
              { label: __("Darken", "essential-blocks"), value: "darken" },
              { label: __("Lighten", "essential-blocks"), value: "lighten" },
              { label: __("Color Dodge", "essential-blocks"), value: "color-dodge" },
              { label: __("Saturation", "essential-blocks"), value: "saturation" },
              { label: __("Color", "essential-blocks"), value: "color" },
              { label: __("Luminosity", "essential-blocks"), value: "luminosity" },
            ]}
        ...
        <>
          ...
          {hov_ovl_allowFilters && (
            <>
              ...
              {!noTransition && (
                <RangeControl
                  label={__("Css Filters Transition", "essential-blocks")}
