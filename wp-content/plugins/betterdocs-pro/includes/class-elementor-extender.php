...
class Betterdocs_Elmenetor_Extender
{
    ...
    public static function sidebar_display( $sidebar, $settings )
    {
        ...
        if ($settings['betterdocs_sidebar_layout'] == 'layout-1') {
            if ($multiple_kb == 1) {
                $shortcode = do_shortcode('[betterdocs_category_grid disable_customizer_style="true" sidebar_list="true" posts_per_grid="-1" multiple_knowledge_base="true" title_tag="'.$settings['category_title_tag'].'"]');
            } else {
            ...
            if ($multiple_kb == 1) {
                $shortcode = do_shortcode('[betterdocs_category_list posts_per_grid="-1" multiple_knowledge_base="true" title_tag="'.$settings['category_title_tag'].'"]');
            } else {
                $shortcode = do_shortcode('[betterdocs_category_list posts_per_grid="-1" title_tag="'.$settings['category_title_tag'].'"]');
            }
            ...
            if ($multiple_kb == 1) {
                $shortcode = do_shortcode('[betterdocs_category_grid disable_customizer_style="true" post_counter=0 sidebar_list="true" posts_per_grid="-1"  multiple_knowledge_base="true" title_tag="'.$settings['category_title_tag'].'"]');
            } else {
                $shortcode = do_shortcode('[betterdocs_category_grid disable_customizer_style="true" post_counter=0 sidebar_list="true" posts_per_grid="-1" title_tag="'.$settings['category_title_tag'].'"]');
            }
