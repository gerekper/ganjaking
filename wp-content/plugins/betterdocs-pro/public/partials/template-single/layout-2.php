...
<div class="betterdocs-single-wraper betterdocs-single-bg full-wrapper betterdocs-single-layout2">
	...
	<div class="<?php echo implode(' ', $wraper_class); ?>">
						...
						<div class="feedback-update-form">
							...
							<div class="feedback-form">
								<a class="feedback-form-link" href="#betterdocs-form-modal" name="betterdocs-form-modal">
									...
									<?php esc_html_e('Still stuck? How can we help?','betterdocs-pro') ?></a>
								<div id="betterdocs-form-modal" class="betterdocs-modalwindow">
									<div class="modal-inner">
										<div class="modal-content">
											...
											<h2><?php esc_html_e('How can we help?','betterdocs-pro') ?></h2>
		...
		<aside id="betterdocs-sidebar-right"  class="betterdocs-full-sidebar-right right-sidebar-toc-wrap">
			...
			<div data-simplebar class="layout2-toc-container right-sidebar-toc-container"></div><!-- #sticky toc -->
