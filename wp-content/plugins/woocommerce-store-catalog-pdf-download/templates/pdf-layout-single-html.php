...
?>
	...
	<div class="single">
		...
		?>
			...
			<h2><a href="<?php echo get_permalink( $product->get_id() ); ?>"><?php echo apply_filters( 'wc_store_catalog_pdf_download_show_product_title', $product->get_name(), $product ); ?></a></h2><br /><br />
