...
if ( ! class_exists( 'YITH_ARS_New_Request_User_Email' ) ) {
    ...
    class YITH_ARS_New_Request_User_Email extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title          = esc_html_x( 'YITH Advanced Refund System: New request - email for user', 'Email descriptive title',
            ...
            $this->heading        = esc_html__( 'Request succesfully submitted', 'yith-advanced-refund-system-for-woocommerce' );
            $this->subject        = esc_html__( 'Request succesfully submitted', 'yith-advanced-refund-system-for-woocommerce' );
            $this->email_body     = esc_html__( 'Hi {customer_name}! Your request {request_number} for order {order_number} has been successfully submitted. You will receive a reply soon.', 'yith-advanced-refund-system-for-woocommerce' );
        ...
        public function trigger( $request_id ) {
            ...
            $this->email_body = $this->get_option( 'email_body', esc_html__( 'Hi {customer_name}! Your request {request_number} for order {order_number}
