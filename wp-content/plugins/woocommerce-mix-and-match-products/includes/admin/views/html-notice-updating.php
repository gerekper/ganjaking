...
<div id="wc-mnm-message" class="wc-mnm-message notice info updated">
	...
	<p class="submit">
		<a href="<?php echo esc_url( add_query_arg( array( 'page' => 'wc-status', 'tab' => 'action-scheduler', 'status' => 'pending', 's' => 'wc_mnm_run_update' ), admin_url( 'admin.php' ) ) ); ?>" class="button-secondary">
