 ...
 */
namespace DynamicOOOS\Dompdf\FrameDecorator;

use DynamicOOOS\Dompdf\Cellmap;
use DOMNode;
...
{
    public static $VALID_CHILDREN = array("table-row-group", "table-row", "table-header-group", "table-footer-group", "table-column", "table-column-group", "table-caption", "table-cell");
    public static $ROW_GROUPS = array('table-row-group', 'table-header-group', 'table-footer-group');
    /**
        ...
        while ($iter) {
            ...
            if ($anon_row) {
                ...
                if ($display === "table-cell") {
                    ...
                    $table_row->append_child($child, \true);
                    // Add the tr to the tbody
                    $table_row_group->append_child($table_row, \true);
                    $anon_row = \true;
                    continue;
                }
