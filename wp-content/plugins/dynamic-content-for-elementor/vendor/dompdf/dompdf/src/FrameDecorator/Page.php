...
use DynamicOOOS\Dompdf\Renderer;
/**
    ...
    protected function _page_break_allowed(Frame $frame)
    {
        ...
        if (\in_array($display, $block_types)) {
            ...
            if (!$prev && $parent) {
                ...
                return $frame->get_style()->length_in_pt($frame->get_style()->margin_top) != 0 || $parent->get_style()->length_in_pt($parent->get_style()->padding_top) != 0;
            }
