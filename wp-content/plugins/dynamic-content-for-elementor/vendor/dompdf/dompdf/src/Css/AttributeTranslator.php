 ...
 */
namespace DynamicOOOS\Dompdf\Css;
...
class AttributeTranslator
{
    ...
    private static $__ATTRIBUTE_LOOKUP = array(
        //'caption' => array ( 'align' => '', ),
        'img' => array('align' => array('bottom' => 'vertical-align: baseline;', 'middle' => 'vertical-align: middle;', 'top' => 'vertical-align: top;', 'left' => 'float: left;', 'right' => 'float: right;'), 'border' => 'border: %0.2Fpx solid;', 'height' => 'height: %spx;', 'hspace' => 'padding-left: %1$0.2Fpx; padding-right: %1$0.2Fpx;', 'vspace' => 'padding-top: %1$0.2Fpx; padding-bottom: %1$0.2Fpx;', 'width' => 'width: %spx;'),
        'table' => array(
            'align' => array('left' => 'margin-left: 0; margin-right: auto;', 'center' => 'margin-left: auto; margin-right: auto;', 'right' => 'margin-left: auto; margin-right: 0;'),
            ...
            'frame' => array('void' => 'border-style: none;', 'above' => 'border-top-style: solid;', 'below' => 'border-bottom-style: solid;', 'hsides' => 'border-left-style: solid; border-right-style: solid;', 'vsides' => 'border-top-style: solid; border-bottom-style: solid;', 'lhs' => 'border-left-style: solid;', 'rhs' => 'border-right-style: solid;', 'box' => 'border-style: solid;', 'border' => 'border-style: solid;'),
        ...
        'div' => array('align' => 'text-align: %s;'),
        'h1' => array('align' => 'text-align: %s;'),
        'h2' => array('align' => 'text-align: %s;'),
        'h3' => array('align' => 'text-align: %s;'),
        'h4' => array('align' => 'text-align: %s;'),
        'h5' => array('align' => 'text-align: %s;'),
        'h6' => array('align' => 'text-align: %s;'),
        //TODO: translate more form element attributes
        'input' => array('size' => '!set_input_width'),
        'p' => array('align' => 'text-align: %s;'),
        //    'col' => array(
        //      'align'  => '',
        //      'valign' => '',
        //    ),
        ...
        //      'valign' => '',
        //    ),
        'tbody' => array('align' => '!set_table_row_align', 'valign' => '!set_table_row_valign'),
        'td' => array('align' => 'text-align: %s;', 'bgcolor' => '!set_background_color', 'height' => 'height: %s;', 'nowrap' => 'white-space: nowrap;', 'valign' => 'vertical-align: %s;', 'width' => 'width: %s;'),
        'tfoot' => array('align' => '!set_table_row_align', 'valign' => '!set_table_row_valign'),
        'th' => array('align' => 'text-align: %s;', 'bgcolor' => '!set_background_color', 'height' => 'height: %s;', 'nowrap' => 'white-space: nowrap;', 'valign' => 'vertical-align: %s;', 'width' => 'width: %s;'),
        'thead' => array('align' => '!set_table_row_align', 'valign' => '!set_table_row_valign'),
        'tr' => array('align' => '!set_table_row_align', 'bgcolor' => '!set_table_row_bgcolor', 'valign' => '!set_table_row_valign'),
        'body' => array('background' => 'background-image: url(%s);', 'bgcolor' => '!set_background_color', 'link' => '!set_body_link', 'text' => '!set_color'),
        'br' => array('clear' => 'clear: %s;'),
        'basefont' => array('color' => '!set_color', 'face' => 'font-family: %s;', 'size' => '!set_basefont_size'),
        'font' => array('color' => '!set_color', 'face' => 'font-family: %s;', 'size' => '!set_font_size'),
        'dir' => array('compact' => 'margin: 0.5em 0;'),
        'dl' => array('compact' => 'margin: 0.5em 0;'),
        'menu' => array('compact' => 'margin: 0.5em 0;'),
        'ol' => array('compact' => 'margin: 0.5em 0;', 'start' => 'counter-reset: -dompdf-default-counter %d;', 'type' => 'list-style-type: %s;'),
        'ul' => array('compact' => 'margin: 0.5em 0;', 'type' => 'list-style-type: %s;'),
        'li' => array('type' => 'list-style-type: %s;', 'value' => 'counter-reset: -dompdf-default-counter %d;'),
        'pre' => array('width' => 'width: %s;'),
    );
