 ...
 */
namespace DynamicOOOS\Dompdf\FrameReflower;

use DynamicOOOS\Dompdf\Frame;
use DynamicOOOS\Dompdf\FrameDecorator\Block as BlockFrameDecorator;
use DynamicOOOS\Dompdf\FrameDecorator\TableCell as TableCellFrameDecorator;
use DynamicOOOS\Dompdf\FrameDecorator\Text as TextFrameDecorator;
...
class Block extends AbstractFrameReflower
{
    ...
    protected function _calculate_restricted_height()
    {
        ...
        if ($frame->is_absolute()) {
            ...
            $dims = array($top !== "auto" ? $top : 0, $style->margin_top !== "auto" ? $style->margin_top : 0, $style->padding_top, $style->border_top_width, $height !== "auto" ? $height : 0, $style->border_bottom_width, $style->padding_bottom, $style->margin_bottom !== "auto" ? $style->margin_bottom : 0, $bottom !== "auto" ? $bottom : 0);
    ...
    function reflow(BlockFrameDecorator $block = null)
    {
        ...
        if ($needs_reposition) {
            ...
            $this->_frame->move($new_x - $x, $new_y - $y, \true);
        }
