 ...
 */
namespace DynamicOOOS\FontLib\TrueType;

use DynamicOOOS\FontLib\AdobeFontMetrics;
use DynamicOOOS\FontLib\Font;
use DynamicOOOS\FontLib\BinaryStream;
use DynamicOOOS\FontLib\Table\Table;
use DynamicOOOS\FontLib\Table\DirectoryEntry;
use DynamicOOOS\FontLib\Table\Type\glyf;
use DynamicOOOS\FontLib\Table\Type\name;
use DynamicOOOS\FontLib\Table\Type\nameRecord;
/**
 * TrueType font file.
 *
...
class File extends BinaryStream
{
    ...
    protected function readTable($tag)
    {
        ...
        if (!self::$raw) {
            ...
            $class = "DynamicOOOS\\FontLib\\Table\\Table";
        }
        /** @var Table $table */
