...
use DynamicOOOS\PHPHtmlParser\Exceptions\Tag\AttributeNotFoundException;
use DynamicOOOS\PHPHtmlParser\Finder;
use DynamicOOOS\PHPHtmlParser\Selector\Selector;
...
abstract class AbstractNode
{
     ...
     * on the tag of this node.
     */
    public function setAttribute(string $key, ?string $value, bool $doubleQuote = \true) : AbstractNode
    {
     ...
     */
    public abstract function innerHtml() : string;
    /**
     * Gets the html of this node, including it's own
     * tag.
     */
    public abstract function outerHtml() : string;
    /**
     ...
     */
    protected abstract function clear() : void;
}
