 ...
 */
namespace DynamicOOOS\Symfony\Component\CssSelector\Tests;
...
class CssSelectorConverterTest extends TestCase
{
    ...
    {
        $this->expectException('DynamicOOOS\\Symfony\\Component\\CssSelector\\Exception\\ParseException');
