 ...
 */
namespace DynamicOOOS\Symfony\Component\CssSelector\Tests\XPath;
...
use DynamicOOOS\Symfony\Component\CssSelector\XPath\Extension\HtmlExtension;
use DynamicOOOS\Symfony\Component\CssSelector\XPath\Translator;
use DynamicOOOS\Symfony\Component\CssSelector\XPath\XPathExpr;
class TranslatorTest extends TestCase
{
    ...
    {
        $this->expectException('DynamicOOOS\\Symfony\\Component\\CssSelector\\Exception\\ExpressionErrorException');
        $translator = new Translator();
        $translator->registerExtension(new HtmlExtension($translator));
