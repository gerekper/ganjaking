...
{
    return \GuzzleHttp\Psr7\Message::toString($message);
}
/**
...
{
    return \GuzzleHttp\Psr7\Utils::uriFor($uri);
}
/**
...
{
    return \GuzzleHttp\Psr7\Header::parse($header);
}
/**
...
{
    return \GuzzleHttp\Psr7\Header::normalize($header);
}
/**
...
{
    return \GuzzleHttp\Psr7\Utils::modifyRequest($request, $changes);
}
/**
...
{
    return \GuzzleHttp\Psr7\Utils::tryFopen($filename, $mode);
}
/**
...
{
    return \GuzzleHttp\Psr7\Utils::copyToString($stream, $maxLen);
}
/**
...
{
    return \GuzzleHttp\Psr7\Utils::copyToStream($source, $dest, $maxLen);
}
/**
...
{
    return \GuzzleHttp\Psr7\Utils::hash($stream, $algo, $rawOutput);
}
/**
...
{
    return \GuzzleHttp\Psr7\Utils::readLine($stream, $maxLength);
}
/**
...
{
    return \GuzzleHttp\Psr7\Message::parseRequest($message);
}
/**
...
{
    return \GuzzleHttp\Psr7\Query::parse($str, $urlEncoding);
}
/**
...
{
    return \GuzzleHttp\Psr7\Query::build($params, $encoding);
}
/**
...
{
    return \GuzzleHttp\Psr7\MimeType::fromExtension($extension);
}
/**
...
{
    return \GuzzleHttp\Psr7\Message::parseMessage($message);
}
/**
...
{
    return \GuzzleHttp\Psr7\Message::parseRequestUri($path, $headers);
}
/**
...
{
    return \GuzzleHttp\Psr7\Message::bodySummary($message, $truncateAt);
}
/**
...
{
    return \GuzzleHttp\Psr7\Utils::caselessRemove($keys, $data);
}
