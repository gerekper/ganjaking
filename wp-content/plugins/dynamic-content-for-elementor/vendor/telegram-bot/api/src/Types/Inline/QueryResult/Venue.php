...
class Venue extends AbstractInlineQueryResult
{
     ...
     * @var array
     */
    protected static $map = ['type' => \true, 'id' => \true, 'latitude' => \true, 'longitude' => \true, 'title' => \true, 'address' => \true, 'foursquare_id' => \true, 'thumbnail_url' => \true, 'thumbnail_width' => \true, 'thumbnail_height' => \true, 'reply_markup' => InlineKeyboardMarkup::class, 'input_message_content' => InputMessageContent::class];
    /**
     * {@inheritdoc}
     *
     * @var string
     ...
     */
    public function __construct($id, $latitude, $longitude, $title, $address, $thumbnailUrl = null, $thumbnailWidth = null, $thumbnailHeight = null, $foursquareId = null, $inputMessageContent = null, $inlineKeyboardMarkup = null)
    {
