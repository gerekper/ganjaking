                ...
                if (apply_filters('dce_tokens_filters_whitelist_force_disable', \false)) {
                    ...
                    if (!self::is_filter_safe($afilter)) {
                        ...
                        if (\Elementor\Plugin::$instance->editor->is_edit_mode() || current_user_can('administrator')) {
                            $fmt = esc_html__('Filter %1$s is not whitelisted, please add it to the %2$swhitelist%3$s, you can find it in WP Dashboard > Dynamic Content for Elementor > Settings > Tokens', 'dynamic-content-for-elementor');
