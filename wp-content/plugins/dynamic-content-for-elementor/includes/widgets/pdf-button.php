...
class PdfButton extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function safe_register_controls()
    {
        ...
        $this->add_control('dce_pdf_button_template', ['label' => __('Template', 'dynamic-content-for-elementor'), 'type' => 'ooo_query', 'placeholder' => __('Template Name', 'dynamic-content-for-elementor'), 'label_block' => \true, 'query_type' => 'posts', 'object_type' => 'elementor_library', 'description' => __('Use an Elementor Template as body for this PDF.', 'dynamic-content-for-elementor'), 'condition' => ['dce_pdf_button_body' => 'template', 'dce_pdf_button_converter!' => 'html']]);
        ...
        $this->add_control('js_scale', ['label' => __('PDF Resolution Scaling (higher means better quality)', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::NUMBER, 'min' => 1, 'max' => 3, 'step' => 0.1, 'default' => 1.5, 'label_block' => \true, 'condition' => ['dce_pdf_button_converter' => ['js']]]);
    ...
    public static function polish_settings($settings)
    {
        ...
        $tr = ['dce_pdf_button_size_js' => 'page_size', 'dce_pdf_button_body' => 'source_type', 'dce_pdf_button_template' => 'template_id', 'dce_pdf_button_container' => 'selector', 'dce_pdf_button_title' => 'title', 'dce_pdf_button_converter' => 'converter', 'dce_pdf_button_orientation' => 'orientation', 'dce_pdf_button_margins_js' => 'margins', 'dce_pdf_button_preview' => 'preview', 'js_scale' => 'scale'];
        $new = [];
