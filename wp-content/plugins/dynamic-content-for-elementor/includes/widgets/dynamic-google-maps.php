...
class DynamicGoogleMaps extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function safe_register_controls()
    {
        ...
        $this->add_control('infoWindow_click_outside', ['label' => esc_html__('Close InfoWindow on mouse click', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'frontend_available' => \true, 'condition' => ['enable_infoWindow' => 'yes']]);
