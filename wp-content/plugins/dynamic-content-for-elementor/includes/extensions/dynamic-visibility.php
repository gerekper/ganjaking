...
class DynamicVisibility extends \DynamicContentForElementor\Extensions\ExtensionPrototype
{
    ...
    private function add_controls($element, $section)
    {
        ...
        if ($section == 'datetime') {
            $element->add_control('dce_visibility_datetime_important_note', ['type' => Controls_Manager::RAW_HTML, 'raw' => __('The time will be interpreted in the Time Zone as configured in the WordPress settings.', 'dynamic-content-for-elementor'), 'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning']);
