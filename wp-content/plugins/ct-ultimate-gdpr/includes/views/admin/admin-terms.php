...
/**
 * The template for displaying terms controller view in wp-admin
 *
...
<div class="ct-ultimate-gdpr-wrap">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        <a href="<?php echo admin_url( 'admin.php?page=ct-ultimate-gdpr-policy' ); ?>" class="nav-tab">
	...
	<form method="post" action="options.php">
		...
		settings_fields( CT_Ultimate_GDPR_Controller_Terms::ID );
		do_settings_sections( CT_Ultimate_GDPR_Controller_Terms::ID );
