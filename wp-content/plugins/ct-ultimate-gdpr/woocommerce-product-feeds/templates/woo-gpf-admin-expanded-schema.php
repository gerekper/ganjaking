...
<p>
	...
	?></label>
    <?php echo __( '<br><strong>Note:</strong> Before enabling this option, please see <a href="https://woocommerce.com/document/google-product-feed-expanded-structured-data/" target="_blank" rel="nofollow noopener">this article</a> about the status of the feature, and the potential consequences of using this pre-release feature.', 'woocommere_gpf' ); // WPCS: XSS OK ?>
</p>
