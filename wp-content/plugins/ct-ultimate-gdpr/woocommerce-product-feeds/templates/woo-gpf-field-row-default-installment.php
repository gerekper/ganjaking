	<label for="_woocommerce_gpf_data[{key}][0][months]"><?php _e( 'Number of monthly instalments:', 'woocommerce_gpf' ); ?></label><br>
...
<p>
	<label for="_woocommerce_gpf_data[{key}][0][amount]"><?php _e( 'Amount of each payment, including 3-digit currency code, e.g. "50 USD":', 'woocommerce_gpf' ); ?></label><br>
