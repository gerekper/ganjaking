<?php
/**
 * weLaunch Descriptor Fields Class
 *
 * @class weLaunch_Descriptor_Fields
 * @version 4.0.0
 ...
 */
class weLaunch_Descriptor_Fields implements ArrayAccess {
	...
	/**
	 * weLaunch_Descriptor_Fields constructor.
	 *
	...
	public function __construct( $name, $title, $type, $description = '', $default = null ) {
		if ( ! weLaunch_Descriptor_Types::is_valid_type( $type ) ) {
