<?php
/**
 * weLaunch Network Class
 *
 * @class weLaunch_Network
 * @version 4.0.0
...
if ( ! class_exists( 'weLaunch_Network', false ) ) {

	/**
	 * Class weLaunch_Network
	 */
	class weLaunch_Network extends weLaunch_Class {

		/**
		 * weLaunch_Network constructor.
		 *
		...
		public function __construct( $parent ) {
			...
			if ( 'network' === $parent->args['database'] && $parent->args['network_admin'] ) {
				add_action(
					'network_admin_edit_welaunch_' . $parent->args['opt_name'],
					array(
						$this,
						'save_network_page',
					),
		...
		public function network_admin_bar( $wp_admin_bar ) {
			...
			$args = array(
				...
				'meta'   => array( 'class' => 'welaunch-network-admin' ),
			);
