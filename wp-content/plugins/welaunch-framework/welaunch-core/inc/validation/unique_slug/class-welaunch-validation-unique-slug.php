...
if ( ! class_exists( 'weLaunch_Validation_Unique_Slug', false ) ) {

	/**
	 * Class weLaunch_Validation_Unique_Slug
	 */
	class weLaunch_Validation_Unique_Slug extends weLaunch_Validate {
		...
		public function validate() {
			...
			$this->field['msg']              = ( isset( $this->field['msg'] ) ) ? $this->field['msg'] : esc_html__( 'That URL slug is in use, please choose another.', 'welaunch-framework' );
