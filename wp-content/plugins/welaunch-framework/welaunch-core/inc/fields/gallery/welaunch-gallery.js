...
(function( $ ) {
	...
	welaunch.field_objects.gallery = welaunch.field_objects.gallery || {};

	welaunch.field_objects.gallery.init = function( selector ) {
		selector = $.welaunch.getSelector( selector, 'gallery' );
								...
								function( selection ) {
									...
									ids = selection.models.map(
										function( e ) {
											...
											preview_html = '<a class="of-uploaded-image" href="' + preview_img + '"><img class="welaunch-option-image" src="' + preview_img + '" alt="" /></a>';
									...
									welaunch_change( current_gallery.find( '.gallery_values' ) );
