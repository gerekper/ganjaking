...
// Don't duplicate me!
if ( ! class_exists( 'weLaunch_Link_Color', false ) ) {

	/**
	 * Main weLaunch_link_color class
	 *
	 * @since       1.0.0
	 */
	class weLaunch_Link_Color extends weLaunch_Field {
		...
		public function render() {
			if ( true === $this->field['regular'] && false !== $this->field['default']['regular'] ) {
				...
				echo '<strong>' . esc_html__( 'Regular', 'welaunch-framework' ) . '</strong>&nbsp;';
				echo '<input ';
				...
				echo 'class="color-picker welaunch-color welaunch-color-regular welaunch-color-init ' . esc_attr( $this->field['class'] ) . '"';
				echo 'type="text"';
			...
			if ( true === $this->field['hover'] && false !== $this->field['default']['hover'] ) {
				echo '<span class="linkColor">';
				echo '<strong>' . esc_html__( 'Hover', 'welaunch-framework' ) . '</strong>&nbsp;';
				echo '<input ';
				...
				echo 'class="color-picker welaunch-color welaunch-color-hover welaunch-color-init ' . esc_attr( $this->field['class'] ) . '"';
				echo 'type="text"';
			...
			if ( true === $this->field['visited'] && false !== $this->field['default']['visited'] ) {
				echo '<span class="linkColor">';
				echo '<strong>' . esc_html__( 'Visited', 'welaunch-framework' ) . '</strong>&nbsp;';
				echo '<input ';
				...
				echo 'class="color-picker welaunch-color welaunch-color-visited welaunch-color-init ' . esc_attr( $this->field['class'] ) . '"';
				echo 'type="text"';
			...
			if ( true === $this->field['active'] && false !== $this->field['default']['active'] ) {
				echo '<span class="linkColor">';
				echo '<strong>' . esc_html__( 'Active', 'welaunch-framework' ) . '</strong>&nbsp;';
				echo '<input ';
				...
				echo 'class="color-picker welaunch-color welaunch-color-active welaunch-color-init ' . esc_attr( $this->field['class'] ) . '"';
				echo 'type="text"';
			...
			if ( true === $this->field['focus'] && false !== $this->field['default']['focus'] ) {
				echo '<span class="linkColor">';
				echo '<strong>' . esc_html__( 'Focus', 'welaunch-framework' ) . '</strong>&nbsp;';
				echo '<input ';
				...
				echo 'class="color-picker welaunch-color welaunch-color-focus welaunch-color-init ' . esc_attr( $this->field['class'] ) . '"';
				echo 'type="text"';
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				'welaunch-field-link-color-js',
				weLaunch_Core::$url . 'inc/fields/link_color/welaunch-link-color' . weLaunch_Functions::is_min() . '.js',
				$dep_array,
				$this->timestamp,
				true
			);
			...
			if ( $this->parent->args['dev_mode'] ) {
				...
				wp_enqueue_style(
					'welaunch-field-link_color-js',
					weLaunch_Core::$url . 'inc/fields/link_color/welaunch-link-color.css',
					array(),
					$this->timestamp,
					'all'
				);
...
class_alias( 'weLaunch_Link_Color', 'weLaunchFramework_Link_Color' );
