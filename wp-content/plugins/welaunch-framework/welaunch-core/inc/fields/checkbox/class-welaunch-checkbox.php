...
// Don't duplicate me!
if ( ! class_exists( 'weLaunch_Checkbox', false ) ) {

	/**
	 * Main weLaunch_checkbox class
	 *
	 * @since       1.0.0
	 */
	class weLaunch_Checkbox extends weLaunch_Field {
		...
		public function enqueue() {
			if ( $this->parent->args['dev_mode'] ) {
				wp_enqueue_style(
					'welaunch-field-checkbox-css',
					weLaunch_Core::$url . 'inc/fields/checkbox/welaunch-checkbox.css',
					array(),
					$this->timestamp,
					'all'
				);
			...
			wp_enqueue_script(
				'welaunch-field-checkbox-js',
				weLaunch_Core::$url . 'inc/fields/checkbox/welaunch-checkbox' . weLaunch_Functions::is_min() . '.js',
...
class_alias( 'weLaunch_Checkbox', 'weLaunchFramework_Checkbox' );
