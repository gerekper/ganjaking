...
( function( $ ) {
$.welaunch_welcome = $.welaunch_welcome || {};

	$( document ).ready(
		function() {
			$.welaunch_welcome.initQtip();

			if ( $( document.getElementById( 'support_div' ) ).is( ':visible' ) ) {
				$.welaunch_welcome.initSupportPage();
			}

			$.welaunch_welcome.supportHash();
		}
	);

	$.welaunch_welcome.supportHash = function() {
		$( '#support_hash' ).focus(
			function() {
				var $this = $( this );
				$this.select();
		...
		$( '.welaunch_support_hash' ).click(
			function( e ) {
				...
				$nonce = $( '#welaunch_support_nonce' ).val();
				...
				$.ajax(
					{
						...
						success: function( response ) {
							if ( 'success' === response.status ) {
								$( '#support_hash' ).val( 'https://support.welaunch.io/?id=' + response.identifier );
	...
	$.welaunch_welcome.initSupportPage = function() {
	...
	$.welaunch_welcome.initQtip = function() {
