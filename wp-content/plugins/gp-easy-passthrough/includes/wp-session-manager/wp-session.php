...
if ( ! defined( 'WP_CLI' ) || false === WP_CLI ) {
	add_action( 'plugins_loaded', '\GP_Easy_Passthrough\wp_session_start' );
}
...
if ( ! defined( 'WP_CLI' ) || false === WP_CLI ) {
	add_action( 'shutdown', '\GP_Easy_Passthrough\wp_session_write_close' );
}
...
add_action( 'wp_session_garbage_collection', '\GP_Easy_Passthrough\wp_session_cleanup' );
...
add_action( 'wp', '\GP_Easy_Passthrough\wp_session_register_garbage_collection' );
