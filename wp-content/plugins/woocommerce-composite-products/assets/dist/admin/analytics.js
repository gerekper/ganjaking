...
var external_wp_date_ = __webpack_require__(16);
...
class revenue_CompositesReportTable extends external_wp_element_["Component"] {
  constructor() {
    super();
...
const config_charts = Object(external_wp_hooks_["applyFilters"])(COMPOSITES_REPORT_CHARTS_FILTER, [{
  key: 'items_sold',
  label: Object(external_wp_i18n_["__"])('Composite Products Sold', 'woocommerce-composite-products'),
  order: 'desc',
  orderby: 'items_sold',
...
class report_Report extends external_wp_element_["Component"] {
  getChartMeta() {
    ...
    const label = Object(external_wp_i18n_["__"])('%d composite products', 'woocommerce-composite-products');
...
Object(external_wp_hooks_["addFilter"])('woocommerce_admin_reports_list', 'woocommerce-composite-products', reports => {
  return [...reports, {
    report: 'composites',
