...
class CompositesReportTable extends external_wp_element_namespaceObject.Component {
  constructor() {
    super();
  ...
  getHeadersContent() {
    return [{
      label: (0,external_wp_i18n_namespaceObject.__)('Composite Title', 'woocommerce-composite-products'),
      key: 'product_name',
      required: true,
      isLeftAligned: true,
      isSortable: true
    }, {
      label: (0,external_wp_i18n_namespaceObject.__)('SKU', 'woocommerce-composite-products'),
      key: 'sku',
      hiddenByDefault: true,
      isSortable: true
    }, {
      label: (0,external_wp_i18n_namespaceObject.__)('Composite Products Sold', 'woocommerce-composite-products'),
      key: 'items_sold',
      required: true,
      defaultSort: true,
      isSortable: true,
      ...
      label: (0,external_wp_i18n_namespaceObject.__)('Products Sold in Components', 'woocommerce-composite-products'),
      ...
      label: (0,external_wp_i18n_namespaceObject.__)('Net Sales', 'woocommerce-composite-products'),
      screenReaderLabel: (0,external_wp_i18n_namespaceObject.__)('Net Sales', 'woocommerce-composite-products'),
      key: 'net_revenue',
      required: true,
      isSortable: true,
      isNumeric: true
    }, {
      label: (0,external_wp_i18n_namespaceObject.__)('Orders', 'woocommerce-composite-products'),
      key: 'orders_count',
      isSortable: true,
      isNumeric: true
    }].filter(Boolean);
  ...
  getRowsContent(data = []) {
    ...
    return (0,external_lodash_namespaceObject.map)(data, row => {
      const {
        ...
        composited_items_sold: compositedItemsSold,
      ...
      return [{
        ...
        display: (0,external_wc_number_namespaceObject.formatValue)(currency, 'number', compositedItemsSold),
  ...
  getSummary(totals) {
    const {
      ...
      composited_items_sold: compositedItemsSold = 0,
    ...
    const currency = getCurrencyConfig();
    return [{
      label: (0,external_wp_i18n_namespaceObject._n)('composite', 'composites', productsCount, 'woocommerce-composite-products'),
      value: (0,external_wc_number_namespaceObject.formatValue)(currency, 'number', productsCount)
    }, {
      label: (0,external_wp_i18n_namespaceObject._n)('sale', 'sales', itemsSold, 'woocommerce-composite-products'),
      value: (0,external_wc_number_namespaceObject.formatValue)(currency, 'number', itemsSold)
    }, {
      label: (0,external_wp_i18n_namespaceObject._n)('product sold in components', 'products sold in components', compositedItemsSold, 'woocommerce-composite-products'),
      value: (0,external_wc_number_namespaceObject.formatValue)(currency, 'number', compositedItemsSold)
    }, {
      label: (0,external_wp_i18n_namespaceObject.__)('net sales', 'woocommerce-composite-products'),
      value: formatAmount(netRevenue)
    }, {
      label: (0,external_wp_i18n_namespaceObject._n)('order', 'orders', ordersCount, 'woocommerce-composite-products'),
  ...
  render() {
    ...
    return (0,external_React_namespaceObject.createElement)(report_table, {
      ...
      title: (0,external_wp_i18n_namespaceObject.__)('Composite Products', 'woocommerce-composite-products'),
      columnPrefsKey: "composites_report_columns",
      filters: filters
    });
  }
}
CompositesReportTable.contextType = CurrencyContext;
/* harmony default export */ var revenue = (CompositesReportTable);
...
const COMPOSITES_REPORT_CHARTS_FILTER = 'woocommerce_admin_composites_report_charts';
...
const charts = (0,external_wp_hooks_namespaceObject.applyFilters)(COMPOSITES_REPORT_CHARTS_FILTER, [{
  key: 'items_sold',
  label: (0,external_wp_i18n_namespaceObject.__)('Composite Products Sold', 'woocommerce-composite-products'),
  order: 'desc',
  orderby: 'items_sold',
...
const filters = [{
  label: (0,external_wp_i18n_namespaceObject.__)('Show', 'woocommerce-composite-products'),
  staticParams: ['section', 'paged', 'per_page'],
  param: 'filter',
  showFilters: () => true,
  filters: [{
    label: (0,external_wp_i18n_namespaceObject.__)('All Composite Products', 'woocommerce-composite-products'),
    value: 'all'
  }, {
    label: (0,external_wp_i18n_namespaceObject.__)('Single Composite Product', 'woocommerce-composite-products'),
    ...
    subFilters: [{
      ...
      settings: {
        ...
        labels: {
          placeholder: (0,external_wp_i18n_namespaceObject.__)('Type to search for a composite', 'woocommerce-composite-products'),
          button: (0,external_wp_i18n_namespaceObject.__)('Single Composite', 'woocommerce-composite-products')
        }
      }
    }]
  }]
...
class Report extends external_wp_element_namespaceObject.Component {
  getChartMeta() {
    ...
    const label = (0,external_wp_i18n_namespaceObject.__)('%d composite products', 'woocommerce-composite-products');
    return {
      itemsLabel: label,
      mode
    };
 ...
 */
(0,external_wp_hooks_namespaceObject.addFilter)('woocommerce_admin_reports_list', 'woocommerce-composite-products', reports => {
  return [...reports, {
    report: 'composites',
    title: (0,external_wp_i18n_namespaceObject._x)('Composite Products', 'analytics report table', 'woocommerce-composite-products'),
    component: report,
    navArgs: {
