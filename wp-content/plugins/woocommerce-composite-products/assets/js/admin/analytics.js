...
var external_wp_compose_ = __webpack_require__(18);
...
var external_wc_number_ = __webpack_require__(13);
...
var external_wc_currency_ = __webpack_require__(23);
...
var external_wc_wcSettings_ = __webpack_require__(19);
...
var external_wp_date_ = __webpack_require__(24);
...
var revenue_CompositesReportTable = /*#__PURE__*/function (_Component) {
  inherits_default()(CompositesReportTable, _Component);

  var _super = revenue_createSuper(CompositesReportTable);

  function CompositesReportTable() {
    var _this;

    classCallCheck_default()(this, CompositesReportTable);
  ...
  createClass_default()(CompositesReportTable, [{
    key: "getHeadersContent",
    value: function getHeadersContent() {
      return [{
        label: Object(external_wp_i18n_["__"])('Composite Title', 'woocommerce-composite-products'),
        key: 'product_name',
        required: true,
        isLeftAligned: true,
        isSortable: true
      }, {
        label: Object(external_wp_i18n_["__"])('SKU', 'woocommerce-composite-products'),
        key: 'sku',
        hiddenByDefault: true,
        isSortable: true
      }, {
        label: Object(external_wp_i18n_["__"])('Composite Products Sold', 'woocommerce-composite-products'),
        key: 'items_sold',
        required: true,
        defaultSort: true,
        isSortable: true,
        ...
        label: Object(external_wp_i18n_["__"])('Products Sold in Components', 'woocommerce-composite-products'),
        key: 'composited_items_sold',
        required: true,
        defaultSort: true,
        isSortable: true,
        isNumeric: true
      }, {
        label: Object(external_wp_i18n_["__"])('Net Sales', 'woocommerce-composite-products'),
        screenReaderLabel: Object(external_wp_i18n_["__"])('Net Sales', 'woocommerce-composite-products'),
        key: 'net_revenue',
        required: true,
        isSortable: true,
        isNumeric: true
      }, {
        label: Object(external_wp_i18n_["__"])('Orders', 'woocommerce-composite-products'),
        key: 'orders_count',
        isSortable: true,
        isNumeric: true
      }].filter(Boolean);
    ...
    value: function getRowsContent() {
      ...
      return Object(external_lodash_["map"])(data, function (row) {
        var productId = row.product_id,
            ...
            compositedItemsSold = row.composited_items_sold,
        ...
        return [{
          ...
          display: Object(external_wc_number_["formatValue"])(currency, 'number', compositedItemsSold),
          value: compositedItemsSold
        }, {
    ...
    value: function getSummary(totals) {
      var _totals$products_coun = totals.products_count,
          ...
          _totals$composited_it = totals.composited_items_sold,
          compositedItemsSold = _totals$composited_it === void 0 ? 0 : _totals$composited_it,
      ...
      var currency = getCurrencyConfig();
      return [{
        label: Object(external_wp_i18n_["_n"])('composite', 'composites', productsCount, 'woocommerce-composite-products'),
        value: Object(external_wc_number_["formatValue"])(currency, 'number', productsCount)
      }, {
        label: Object(external_wp_i18n_["_n"])('sale', 'sales', itemsSold, 'woocommerce-composite-products'),
        value: Object(external_wc_number_["formatValue"])(currency, 'number', itemsSold)
      }, {
        label: Object(external_wp_i18n_["_n"])('product sold in components', 'products sold in components', compositedItemsSold, 'woocommerce-composite-products'),
        value: Object(external_wc_number_["formatValue"])(currency, 'number', compositedItemsSold)
      }, {
        label: Object(external_wp_i18n_["__"])('net sales', 'woocommerce-composite-products'),
        value: formatAmount(netRevenue)
      }, {
        label: Object(external_wp_i18n_["_n"])('order', 'orders', ordersCount, 'woocommerce-composite-products'),
    ...
    value: function render() {
      ...
      return Object(external_wp_element_["createElement"])(report_table, {
        ...
        summaryFields: ['products_count', 'items_sold', 'composited_items_sold', 'net_revenue', 'orders_count'],
        itemIdField: "product_id",
        isRequesting: isRequesting,
        query: query,
        compareBy: hideCompare ? undefined : 'composites',
        tableQuery: {
        ...
        title: Object(external_wp_i18n_["__"])('Composite Products', 'woocommerce-composite-products'),
        columnPrefsKey: "composites_report_columns",
        filters: filters
      });
    }
  }]);

  return CompositesReportTable;
}(external_wp_element_["Component"]);

revenue_CompositesReportTable.contextType = CurrencyContext;
/* harmony default export */ var revenue = (revenue_CompositesReportTable);
...
var COMPOSITES_REPORT_CHARTS_FILTER = 'woocommerce_admin_composites_report_charts';
...
var config_charts = Object(external_wp_hooks_["applyFilters"])(COMPOSITES_REPORT_CHARTS_FILTER, [{
  key: 'items_sold',
  label: Object(external_wp_i18n_["__"])('Composite Products Sold', 'woocommerce-composite-products'),
  order: 'desc',
  orderby: 'items_sold',
...
var config_filters = [{
  label: Object(external_wp_i18n_["__"])('Show', 'woocommerce-composite-products'),
  ...
  filters: [{
    label: Object(external_wp_i18n_["__"])('All Composite Products', 'woocommerce-composite-products'),
    value: 'all'
  }, {
    label: Object(external_wp_i18n_["__"])('Single Composite Product', 'woocommerce-composite-products'),
    value: 'select_composite',
    subFilters: [{
      component: 'Search',
      value: 'single_product',
      path: ['select_composite'],
      settings: {
        type: 'products',
        param: 'products',
        getLabels: getProductLabels,
        labels: {
          placeholder: Object(external_wp_i18n_["__"])('Type to search for a composite', 'woocommerce-composite-products'),
          button: Object(external_wp_i18n_["__"])('Single Composite', 'woocommerce-composite-products')
        }
      }
    }]
  }]
...
var report_Report = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(Report, [{
    ...
    value: function getChartMeta() {
      ...
      /* translators: Number of Composites */

      var label = Object(external_wp_i18n_["__"])('%d composite products', 'woocommerce-composite-products');
...
Object(external_wp_hooks_["addFilter"])('woocommerce_admin_reports_list', 'woocommerce-composite-products', function (reports) {
  return [].concat(toConsumableArray_default()(reports), [{
    report: 'composites',
    title: Object(external_wp_i18n_["_x"])('Composite Products', 'analytics report table', 'woocommerce-composite-products'),
