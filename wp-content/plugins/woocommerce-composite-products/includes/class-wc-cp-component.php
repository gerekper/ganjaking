...
class WC_CP_Component implements ArrayAccess {
	...
	public function disable_addons() {
		...
		if ( defined( 'WC_PRODUCT_ADDONS_VERSION' ) && version_compare( WC_PRODUCT_ADDONS_VERSION, WC_CP()->compatibility->get_required_module_version( 'pao' ) ) >= 0 ) {
			$disable = apply_filters( 'woocommerce_composite_component_disable_addons', isset( $data[ 'disable_addons' ] ) && 'yes' === $data[ 'disable_addons' ], $data, $this->get_id(), $this->get_composite() );
		}
	...
	*/
	...
	public function get_image_size() {
		return apply_filters( 'woocommerce_composite_component_image_size', 'woocommerce_thumbnail', $this );
	}
