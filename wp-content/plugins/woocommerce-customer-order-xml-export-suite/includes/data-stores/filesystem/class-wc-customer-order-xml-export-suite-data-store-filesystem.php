...
/**
 * Customer/Order XML Export Suite Filesystem Data Store
 *
 * Persists exports to the filesystem.
 *
 * @since 2.4.0
 */
class WC_Customer_Order_XML_Export_Suite_Data_Store_Filesystem extends WC_Customer_Order_XML_Export_Suite_Data_Store {
