...
class TagAddedTrigger implements Trigger {
  public const KEY = 'mailpoet:subscriber-tag-added';
  ...
  public function getKey(): string {
    return 'mailpoet:subscriber-tag-added';
  }
  ...
  public function registerHooks(): void {
    $this->wp->addAction('mailpoet_subscriber_tag_added', [$this, 'handleTagAdded']);
  }

  public function handleTagAdded(SubscriberTagEntity $entity) {
    $tag = $entity->getTag();
