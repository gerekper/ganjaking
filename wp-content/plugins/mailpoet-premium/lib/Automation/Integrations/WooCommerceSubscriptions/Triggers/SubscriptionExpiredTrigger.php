...
class SubscriptionExpiredTrigger implements Trigger {

  const KEY = 'woocommerce-subscriptions:subscription-expired';
  ...
  public function getName(): string {
    ...
    return __('Woo Subscription expired', 'mailpoet-premium');
  }
