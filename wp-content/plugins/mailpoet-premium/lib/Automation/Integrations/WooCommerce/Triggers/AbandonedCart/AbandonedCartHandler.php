...
namespace MailPoet\Premium\Automation\Integrations\WooCommerce\Triggers\AbandonedCart;
...
class AbandonedCartHandler {
  ...
  public function reschedule(SubscriberEntity $subscriber) {
  ...
  public function cancel(SubscriberEntity $subscriber) {
