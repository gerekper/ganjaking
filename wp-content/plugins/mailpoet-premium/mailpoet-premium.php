...
function mailpoet_premium_php_version_notice() {
  $notice = str_replace(
    ...
    __('MailPoet Premium requires PHP version 7.3.0 or newer (version 8.1 recommended). Please read our [link]instructions[/link] on how to resolve this issue.', 'mailpoet-premium')
  );
