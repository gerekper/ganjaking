...
/**
 * Multi Checkbox Add-On Class
 *
 * @since 2.0.0
 */
class Multi_Checkbox extends Add_On_With_Options {


	/** @var string the add-on type */
	protected $add_on_type = 'multicheckbox';
	...
	public function __construct( $data = 0 ) {
		...
		$this->add_on_type_name = _x( 'Multi-checkbox', 'Add-on type', 'woocommerce-checkout-add-ons' );
	}
	 ...
	 *
	 * Removes 'sortable' since multi-checkboxes can't be sorted.
	 *
	 * @since 2.0.0
	 *
	 * @return string[]
