...
class WC_CSV_Import_Suite_Order_Import extends \WC_CSV_Import_Suite_Importer {
	...
	private function get_parser() {
		...
		if ( ! isset( $this->parser ) ) {
			$this->parser = wc_csv_import_suite()->load_class( '/src/class-wc-csv-import-suite-order-parser.php', 'WC_CSV_Import_Suite_Order_Parser' );
		}
	...
	private function get_processor() {
		...
		if ( ! isset( $this->processor ) ) {
			$this->processor = wc_csv_import_suite()->load_class( '/src/class-wc-csv-import-suite-order-processor.php', 'WC_CSV_Import_Suite_Order_Processor' );
		}
