...
class WC_CSV_Import_Suite_Importers {
	...
	public function get_importer( $type ) {
		...
		if ( ! isset( $this->importers[ $type ] ) ) {
			...
			require_once( wc_csv_import_suite()->get_plugin_path() . '/src/class-wc-csv-import-suite-import-exception.php' );
			require_once( wc_csv_import_suite()->get_plugin_path() . '/src/class-wc-csv-import-suite-parser.php' );
			require_once( wc_csv_import_suite()->get_plugin_path() . '/src/class-wc-csv-import-suite-importer.php' );
			...
			switch ( $type ) {
				...
				case 'woocommerce_customer_csv':
					...
					require_once( wc_csv_import_suite()->get_plugin_path() . '/src/class-wc-csv-import-suite-customer-import.php' );
				...
				case 'woocommerce_coupon_csv':
					...
					require_once( wc_csv_import_suite()->get_plugin_path() . '/src/class-wc-csv-import-suite-coupon-import.php' );
				...
				case 'woocommerce_order_csv':
					...
					require_once( wc_csv_import_suite()->get_plugin_path() . '/src/class-wc-csv-import-suite-order-import.php' );
