...
"object" == typeof navigator &&
	(function (e, t) {
					...
					[
						...
						},
						{
							...
							value: function (t) {
								...
								return (
									0 >
									(i = (100 / r.width) * (n.clientX - r.left))
										? (i = 0)
										: 100 < i && (i = 100),
									50 > i
										? (i -= (100 - 2 * i) * c)
		...
		const We = {
			...
			timeUpdate(e) {
				const t =
					!H(this.elements.display.duration) &&
			...
			updateSetting(e, t, i) {
				...
				if (
					(H(a) || (a = s && s.querySelector('[role="menu"]')), !H(a))
				)
					return;
			...
			setSpeedMenu() {
				...
				const i =
					!W(this.options.speed) && this.options.speed.length > 1;
			...
			create(e) {
				...
				return (
					Ce(
						D(this.config.controls) ? this.config.controls : []
					).forEach((l) => {
						if (
							("restart" === l &&
							...
							"play" === l &&
								c.appendChild(i.call(this, "play", h)),
							"fast-forward" === l &&
							...
							const t = Z("div", {
								...
								i = Z(
									"div",
									ne(this.config.selectors.progress)
								);
							if (
								(i.appendChild(
									n.call(this, "seek", {
					...
					this.isHTML5 &&
						l.call(this, Le.getQualityOptions.call(this)),
					o.call(this),
					c
				);
			},
		...
		class Tt {
			constructor(t, i) {
				if (
					...
					e(this, "pause", () =>
						this.playing && j(this.media.pause)
							? this.media.pause()
							: null
					),
					e(this, "togglePlay", (e) =>
