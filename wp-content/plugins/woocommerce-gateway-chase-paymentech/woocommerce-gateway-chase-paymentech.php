...
class WC_Chase_Paymentech_Loader {
	...
	const FRAMEWORK_VERSION = '5.11.7';

	/** the plugin name, for displaying notices */
	const PLUGIN_NAME = 'WooCommerce Chase Paymentech Gateway';


	/** @var \WC_Chase_Paymentech_Loader single instance of this class */
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot clone instances of %s.', get_class( $this ) ), '1.12.0' );
	}
	...
	public function __wakeup() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot unserialize instances of %s.', get_class( $this ) ), '1.12.0' );
	}
	...
	public function init_plugin() {
		...
		require_once( plugin_dir_path( __FILE__ ) . 'class-wc-chase-paymentech.php' );
	...
	/**
	 * Displays any admin notices added with \WC_Chase_Paymentech_Loader::add_admin_notice()
	 *
	 * @since 1.12.0
	 */
	...
	/**
	 * Gets the main \WC_Chase_Paymentech_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 1.12.0
	 *
	 * @return \WC_Chase_Paymentech_Loader
	 */
...
// fire it up!
WC_Chase_Paymentech_Loader::instance();
