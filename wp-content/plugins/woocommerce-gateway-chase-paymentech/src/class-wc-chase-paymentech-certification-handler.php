...
class WC_Chase_Paymentech_Certification_Handler {
	...
	public function display_test_results( $template_name, $template_path, $located, $args ) {
		...
		$test_details = (array) WC()->session->get( 'wc_chase_paymentech_certification_test_details', $this->get_gateway()->get_order_meta( $order, 'wc_chase_paymentech_certification_test_details' ) );
		...
		// if the transaction was tokenized
