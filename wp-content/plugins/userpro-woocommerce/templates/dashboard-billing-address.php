<div class="profileDashboard dashboardRight" id = "upw-billing-address">
<div class="userpro-section userpro-column userpro-collapsible-1 userpro-collapsed-0" >
	<div class="upw-orders-tab-text">
		<?php _e( $upw_default_options->userpro_woocommerce_get_option( 'upw_billing_address_tab_text' ), 'userpro-woocommerce');?>
	</div>
</div>
<?php
