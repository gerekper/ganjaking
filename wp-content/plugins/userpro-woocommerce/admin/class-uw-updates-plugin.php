...
if( !class_exists('WPUpdatesPluginUpdater_1458') ) {
    class WPUpdatesPluginUpdater_1458 {
    	...
    	function check_for_update( $transient ) {
			...
			if( !$userpro->verify_purchase( $upw_default_options->userpro_woocommerce_get_option('upw_purchases_code'), '13z89fdcmr2ia646kphzg3bbz0jdpdja', 'DeluxeThemes', '5958681' ) ){
