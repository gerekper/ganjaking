...
class Registry
{
     ...
     */
    public static function addLogger(\SearchWP\Dependencies\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \SearchWP\Dependencies\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \SearchWP\Dependencies\Monolog\Logger
    {
