 ...
 * @package Ds
 */
final class Map implements \IteratorAggregate, \ArrayAccess, \SearchWP\Dependencies\Ds\Collection
{
     ...
     */
    public function first() : \SearchWP\Dependencies\Ds\Pair
    {
        if ($this->isEmpty()) {
     ...
     * @throws UnderflowException
     */
    public function last() : \SearchWP\Dependencies\Ds\Pair
    {
        if ($this->isEmpty()) {
            throw new \UnderflowException();
        }
     ...
     */
    public function skip(int $position) : \SearchWP\Dependencies\Ds\Pair
    {
     ...
     * @return Map
     */
    public function merge($values) : \SearchWP\Dependencies\Ds\Map
    {
     ...
     */
    public function intersect(\SearchWP\Dependencies\Ds\Map $map) : \SearchWP\Dependencies\Ds\Map
    {
     ...
     */
    public function diff(\SearchWP\Dependencies\Ds\Map $map) : \SearchWP\Dependencies\Ds\Map
    {
        return $this->filter(function ($key) use($map) {
            return !$map->hasKey($key);
        });
    ...
    {
        if (\is_object($a) && $a instanceof \SearchWP\Dependencies\Ds\Hashable) {
     ...
     * @return Map
     */
    public function filter(callable $callback = null) : \SearchWP\Dependencies\Ds\Map
    {
        $filtered = new self();
     ...
     * @return Set
     */
    public function keys() : \SearchWP\Dependencies\Ds\Set
    {
        $key = function ($pair) {
            return $pair->key;
        };
        return new \SearchWP\Dependencies\Ds\Set(\array_map($key, $this->pairs));
    }
    /**
     ...
     * @return Map
     */
    public function map(callable $callback) : \SearchWP\Dependencies\Ds\Map
    {
     ...
     * @return Sequence
     */
    public function pairs() : \SearchWP\Dependencies\Ds\Sequence
    {
        $copy = function ($pair) {
            return $pair->copy();
        };
        return new \SearchWP\Dependencies\Ds\Vector(\array_map($copy, $this->pairs));
    }
    /**
    ...
    public function put($key, $value)
    {
        ...
        if ($pair) {
            ...
            $this->checkCapacity();
            $this->pairs[] = new \SearchWP\Dependencies\Ds\Pair($key, $value);
        }
    }
    /**
     ...
     * @return Map
     */
    public function reversed() : \SearchWP\Dependencies\Ds\Map
    {
        $reversed = new self();
     ...
     * @return Map
     */
    public function slice(int $offset, int $length = null) : \SearchWP\Dependencies\Ds\Map
    {
        $map = new self();
        if (\func_num_args() === 1) {
     ...
     * @return Map
     */
    public function sorted(callable $comparator = null) : \SearchWP\Dependencies\Ds\Map
    {
        $copy = $this->copy();
     ...
     * @return Map
     */
    public function ksorted(callable $comparator = null) : \SearchWP\Dependencies\Ds\Map
    {
        $copy = $this->copy();
     ...
     * @return Sequence
     */
    public function values() : \SearchWP\Dependencies\Ds\Sequence
    {
        $value = function ($pair) {
            return $pair->value;
        };
        return new \SearchWP\Dependencies\Ds\Vector(\array_map($value, $this->pairs));
    }
    /**
     ...
     */
    public function union(\SearchWP\Dependencies\Ds\Map $map) : \SearchWP\Dependencies\Ds\Map
    {
     ...
     */
    public function xor(\SearchWP\Dependencies\Ds\Map $map) : \SearchWP\Dependencies\Ds\Map
    {
