 ...
 * @package Ds
 */
final class PriorityQueue implements \IteratorAggregate, \SearchWP\Dependencies\Ds\Collection
{
    ...
    {
        $copy = new \SearchWP\Dependencies\Ds\PriorityQueue();
        $copy->heap = $this->heap;
     ...
     */
    private function setRoot(\SearchWP\Dependencies\Ds\PriorityNode $node)
    {
        $this->heap[0] = $node;
        $this->siftDown(0);
    }
     ...
     * @return PriorityNode
     */
    private function getRoot() : \SearchWP\Dependencies\Ds\PriorityNode
    {
        return $this->heap[0];
    }
    /**
    ...
    public function push($value, int $priority)
    {
        ...
        $this->heap[] = new \SearchWP\Dependencies\Ds\PriorityNode($value, $priority, $this->stamp++);
