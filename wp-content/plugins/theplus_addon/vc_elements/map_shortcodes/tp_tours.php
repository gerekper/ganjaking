		...
		function tp_tours_shortcode($atts,$content = null){
			...
			$atts = vc_map_get_attributes( 'tp_tours', $atts );
				...
				if(!empty($select_deac_bg_option) && $select_deac_bg_option=='gradient'){
					$deac_gradient_color = pt_plus_gradient_color($act_gradient_color1,$act_gradient_color2,$act_gradient_style);
				}
				$deac_bgcolor='';				
				...
				if(!empty($active_border_display) && $active_border_display=='on' && !empty($tour_act_border_color) ) {
					$tour_act_border_color =$tour_act_border_color;
				}else{
				...
				if(!empty($deactive_border_display) && $deactive_border_display=='on' && !empty($tour_deac_border_color) ) {
					$tour_deac_border_color = $tour_deac_border_color;
				}else{
				...
				$css_rule='';
				$css_rule .= '<style >';
					$css_rule .= '.'.esc_attr($uid).'.pt_plus_tabs_block .vc_tta-tab .vc_tta-title-text{font-size: '.esc_js($tour_title_size).';'.esc_js($title_style).'}.'.esc_attr($uid).'.pt_plus_tabs_block .vc_tta .vc_tta-icon{font-size: '.esc_js($tour_icon_size).' !important;}.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-1 .vc_tta-tab.vc_active,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-2 .vc_tta-tab.vc_active,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-3 .vc_tta-tab.vc_active,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-4 .vc_tta-tab.vc_active,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-tab.vc_active, .'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-1 .vc_tta-tab:hover,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-2 .vc_tta-tab:hover,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-3 .vc_tta-tab:hover,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-4 .vc_tta-tab:hover,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-tab:hover{'.esc_js($act_bgcolor).'}.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-1 .vc_tta-tab,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-2 .vc_tta-tab ,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-3 .vc_tta-tab ,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-4 .vc_tta-tab ,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-tab {'.esc_js($deac_bgcolor).'}.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-1 .vc_tta-tab.vc_active a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-2 .vc_tta-tab.vc_active a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-3 .vc_tta-tab.vc_active a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-4 .vc_tta-tab.vc_active a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-tab.vc_active a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-1 .vc_tta-tab:hover a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-2 .vc_tta-tab:hover a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-3 .vc_tta-tab:hover a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-4 .vc_tta-tab:hover a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-tab:hover a{color: '.esc_js($tour_act_title_color).' !important;} .'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-2 .vc_tta-tab.vc_active a:after{border-bottom-color: '.esc_js($tour_side_border_color).' !important;}.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-tab.vc_active a:after,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-panels-container{border-color: '.esc_js($tour_side_border_color).' !important;}.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-1 .vc_tta-tab a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-2 .vc_tta-tab a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-3 .vc_tta-tab a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-4 .vc_tta-tab a,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-tab a{color: '.esc_js($tour_deac_title_color).' !important;}';
		if($tour_act_border_color!='transparent'){
			$css_rule .= '.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-1 .vc_tta-tab.vc_active {border-left: 1px solid '.esc_js($tour_act_border_color).' !important;}.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-1 .vc_tta-tab:hover {border-left: 1px solid '.esc_js($tour_act_border_color).' !important;}.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-3 .vc_tta-tab.vc_active,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-tab.vc_active{border: 1px solid '.esc_js($tour_act_border_color).' !important;}.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-3 .vc_tta-tab:hover ,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-tab:hover {border: 1px solid '.esc_js($tour_act_border_color).' !important;}';
		}
		if($tour_deac_border_color!='transparent'){
			$css_rule .= '.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-1 .vc_tta-tab {border-left: 1px solid '.esc_js($tour_deac_border_color).' !important;}.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-3 .vc_tta-tab,.'.esc_attr($uid).'.pt_plus_tabs_block .tour-style-5 .vc_tta-tab{border: 1px solid '.esc_js($tour_deac_border_color).' !important;}';
		}
				$css_rule .= '</style>';
					...
					'params' => array(
						array(
							...
							'value' => array(
								...
								'style-4' => 'tour-style-4',
								'style-5' => 'tour-style-5'
							),
