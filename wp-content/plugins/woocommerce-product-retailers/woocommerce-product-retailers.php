 ...
 * Documentation URI: https://docs.woocommerce.com/document/woocommerce-product-retailers/
 ...
 * @since 1.11.0
 */
class WC_Product_Retailers_Loader {
	...
	/** @var \WC_Product_Retailers_Loader single instance of this class */
	...
	public function init_plugin() {
		...
		if ( $this->plugins_compatible() ) {
			...
			require_once( plugin_dir_path( __FILE__ ) . 'class-wc-product-retailers.php' );
	 ...
	 * @since 1.11.0
	 *
	 * @return \WC_Product_Retailers_Loader
	 */
...
// fire it up!
WC_Product_Retailers_Loader::instance();
