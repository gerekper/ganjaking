<?php
    ...
    $framework::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'enableCaptchaBestWebSoft',
                'type'     => 'checkbox',
                'title'    => __('Enable Captcha by BestWebSoft', 'wordpress-gdpr'),
                'subtitle'    => __('Install & Setup the <a href="https://wordpress.org/plugins/captcha-bws/" target="_blank">Captcha by BestWebSoft</a>. Then check this option.', 'wordpress-gdpr'),
                'default'  => '0',
                'required' => array('enable','equals','1'),
            ),
            array(
    ...
    $framework::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'popupTextPreferences',
                'type'     => 'text',
                'title'    => __('Popup My Preferences Button', 'wordpress-gdpr'),
                'subtitle' => __('Leave Empty if not needed', 'wordpress-gdpr'),
                'default'  => __('My Preferences', 'wordpress-gdpr'),
                'required' => array('popupEnable','equals','1'),
            ),
            array(
                'id'       => 'popupTextDecline',
                ...
                'subtitle' => __('Leave Empty if not needed', 'wordpress-gdpr'),
                'default'  => __('', 'wordpress-gdpr'),
                'required' => array('popupEnable','equals','1'),
            ),
            array(
                'id'       => 'popupTextPrivacyCenter',
                'type'     => 'text',
                'title'    => __('Popup Privacy Center Link Text', 'wordpress-gdpr'),
                'subtitle' => __('Leave Empty if not needed', 'wordpress-gdpr'),
            ...
            array(
                ...
                'type'     => 'text',
                'title'    => __('Popup Privacy Settings Link Text', 'wordpress-gdpr'),
                'subtitle' => __('Leave Empty if not needed', 'wordpress-gdpr'),
                'default'  => __('', 'wordpress-gdpr'),
                'required' => array('popupEnable','equals','1'),
            ),
            array(
                ...
                'type'     => 'text',
                'title'    => __('Popup Cookie Policy Link Text', 'wordpress-gdpr'),
                'subtitle' => __('Leave Empty if not needed', 'wordpress-gdpr'),
            ...
            array(
                'id'     =>'popupPreferencesColor',
                'type' => 'color',
                'title' => __('Preferences Button Text Color', 'wordpress-gdpr'), 
                'validate' => 'color',
                'default' => '#FFFFFF',
                'required' => array('popupEnable','equals','1'),
            ),
            array(
                'id'     =>'popupPreferencesBackgroundColor',
                'type' => 'color',
                'title' => __('Preferences Button Background Color', 'wordpress-gdpr'), 
                'validate' => 'color',
                'default' => '#777777',
                'required' => array('popupEnable','equals','1'),
            ),
    ...
    $framework::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'subtitle'    => __('Depreacted. Does not support PHP8. Install & Setup the <a href="https://wordpress.org/plugins/invisible-recaptcha/" target="_blank">invisible recaptcha plugin from here</a>. Then check this option.', 'wordpress-gdpr'),
                'default'  => '0',
                'required' => array('enable','equals','1'),
            ),
            array(
