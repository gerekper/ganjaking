...
class WordPress_GDPR_Term_Order extends WordPress_GDPR
{
    ...
    public function init()
    {
        ...
        if( (!isset($_GET['taxonomy']) || $_GET['taxonomy'] !== "gdpr_service_categories") &&
            (!isset($_POST['tax']) || $_POST['tax'] !== "gdpr_service_categories")) {
            return false;
        }
    ...
    public function get_terms_orderby( $orderby = 'name', $args = array(), $taxonomies = array() ) {
        ...
        if(!isset($taxonomies[0]) || $taxonomies[0] !== "gdpr_service_categories") {
            return $orderby;
        }
