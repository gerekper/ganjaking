	...
	<table>
		<tr class="ywpi-invoice-number">
			<td class="ywpi-invoice-number-title" colspan="2" >
				<?php echo apply_filters('ywpi_invoice_number_label', esc_html__( "INVOICE NUMBER", 'yith-woocommerce-pdf-invoice' ),$document); ?>
			</td>
		</tr>
		...
		<tr class="ywpi-invoice-date">
			<td class="left-content">
				<?php esc_html_e( "Invoice date", 'yith-woocommerce-pdf-invoice' ); ?>
			</td>
			<td class="right-content">
