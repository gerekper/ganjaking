...
<DatiGenerali>
	...
	<DatiOrdineAcquisto>
		<IdDocumento><?php echo wp_kses_post( apply_filters( 'ywpi_electronic_invoice_field_value', get_post_meta( $document->order->get_id(), '_ywpi_invoice_number', true ), 'IdDocumento', $document ) ); ?></IdDocumento>
	...
	<?php if ( YITH_Electronic_Invoice()->include_tracking_info == 'yes' ) : //phpcs:ignore ?>
		<DatiTrasporto>
