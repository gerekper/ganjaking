...
$general_options = array(
	'electronic-invoice' => array(
		...
		'receiver-mandatory-company-message' => array(
			...
			'default'   => 'Inserisci l\'intestazione della tua azienda',
		),
		...
		'general-description'                => array(
			'type'      => 'yith-field',
			'yith-type' => 'html',
			'html'      => __( 'We recommend to carefully verify the data provided is correct, to generate the invoice. The plugin\'s authors refuse any responsibility for possible mistakes or shortcomings when generating invoices.', 'yith-woocommerce-pdf-invoice' ),
		),
		array(
			'type' => 'sectionend',
		),
