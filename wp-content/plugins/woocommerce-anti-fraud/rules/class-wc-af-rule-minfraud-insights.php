...
class WC_AF_Rule_MinFraud_Insights extends WC_AF_Rule {
	...
	public function __construct() {
		...
		parent::__construct( 'minfraud', 'Score returned by Minfraud Insights exceeds the allowed value.', $this->rule_weight );
	}
	...
	public function call_maxmind_api_on_order_place( $order) {
		...
		CURLOPT_URL => 'https://minfraud.maxmind.com/minfraud/v2.0/insights',
