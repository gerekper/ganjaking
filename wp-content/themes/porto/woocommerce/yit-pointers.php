...
if ( ! class_exists( 'YIT_Pointers' ) ) {
	...
	class YIT_Pointers {
		...
		protected $_default_position = array(
			'edge'  => 'left',
			'align' => 'center',
		);
		...
		public function __construct() {
			...
			$this->_default_pointer['plugins'] = array(
				...
				'options'   => array(
					'content' => sprintf(
						'<h3> %s </h3> <p> %s </p> <p> %s <a href="http://yithemes.com/product-category/plugins/" target="_blank">Yithemes.com</a> %s
								  <a href="https://profiles.wordpress.org/yithemes/" target="_blank">Wordpress.org</a></p>',
						__( 'Plugins Activated', 'porto' ),
						__(
