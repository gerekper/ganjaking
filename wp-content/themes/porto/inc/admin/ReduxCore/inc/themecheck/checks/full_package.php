...
class Redux_Full_Package implements themecheck {
	...
	function check( $php_files, $css_files, $other_files ) {
		...
		if ( $redux ) {
			...
			$blacklist = array(
				'.tx'                    => __( 'Redux localization utilities', 'porto' ),
				'bin'                    => __( 'Redux Resting Diles', 'porto' ),
				'codestyles'             => __( 'Redux Code Styles', 'porto' ),
				'tests'                  => __( 'Redux Unit Testing', 'porto' ),
				'class.redux-plugin.php' => __( 'Redux Plugin File', 'porto' ),
				'bootstrap_tests.php'    => __( 'Redux Boostrap Tests', 'porto' ),
				'.travis.yml'            => __( 'CI Testing FIle', 'porto' ),
				'phpunit.xml'            => __( 'PHP Unit Testing', 'porto' ),
			);
